...
-- 正在导出表  cms.ay_company 的数据：1 rows
DELETE FROM `ay_company`;
...
-- 正在导出表  cms.ay_config 的数据：42 rows
...
-- 正在导出表  cms.ay_content 的数据：17 rows
...
-- 正在导出表  cms.ay_content_ext 的数据：5 rows
...
-- 正在导出表  cms.ay_content_sort 的数据：11 rows
DELETE FROM `ay_content_sort`;
...
-- 导出  表 cms.ay_diy_telephone 结构
CREATE TABLE IF NOT EXISTS `ay_diy_telephone` (
...
-- 正在导出表  cms.ay_extfield 的数据：3 rows
DELETE FROM `ay_extfield`;
...
-- 正在导出表  cms.ay_form_field 的数据：4 rows
DELETE FROM `ay_form_field`;
...
-- 正在导出表  cms.ay_label 的数据：1 rows
DELETE FROM `ay_label`;
...
-- 正在导出表  cms.ay_member 的数据：0 rows
DELETE FROM `ay_member`;
/*!40000 ALTER TABLE `ay_member` DISABLE KEYS */;
/*!40000 ALTER TABLE `ay_member` ENABLE KEYS */;

-- 导出  表 cms.ay_member_comment 结构
...
-- 正在导出表  cms.ay_member_field 的数据：3 rows
DELETE FROM `ay_member_field`;
...
-- 正在导出表  cms.ay_member_group 的数据：3 rows
DELETE FROM `ay_member_group`;
...
-- 正在导出表  cms.ay_menu_action 的数据：78 rows
DELETE FROM `ay_menu_action`;
...
-- 正在导出表  cms.ay_message 的数据：1 rows
DELETE FROM `ay_message`;
...
-- 正在导出表  cms.ay_model 的数据：5 rows
DELETE FROM `ay_model`;
...
-- 正在导出表  cms.ay_role_area 的数据：2 rows
DELETE FROM `ay_role_area`;
...
-- 正在导出表  cms.ay_role_level 的数据：110 rows
DELETE FROM `ay_role_level`;
...
INSERT INTO `ay_site` (`id`, `acode`, `title`, `subtitle`, `domain`, `logo`, `keywords`, `description`, `icp`, `theme`, `statistical`, `copyright`) VALUES
	(1, 'cn', 'awd-', '攻防对抗', '', '/static/images/logo.png', 'cms,免费cms,开源cms,企业cms,建站cms', '是一套全新内核且永久开源免费的PHP企业网站开发建设管理系统，是一套高效、简洁、 强悍的可免费商用的PHP CMS源码，能够满足各类企业网站开发建设的需要。系统采用简单到想哭的模板标签，只要懂HTML就可快速开发企业网站。官方提供了大量网站模板免费下载和使用，将致力于为广大开发者和企业提供最佳的网站开发建设解决方案。', '湘ICP备88888888号', 'default', '', 'Copyright © 2018-2020 All Rights Reserved.');
/*!40000 ALTER TABLE `ay_site` ENABLE KEYS */;

-- 导出  表 cms.ay_slide 结构
...
-- 正在导出表  cms.ay_slide 的数据：2 rows
DELETE FROM `ay_slide`;
...
-- 正在导出表  cms.ay_syslog 的数据：7 rows
DELETE FROM `ay_syslog`;
...
INSERT INTO `ay_syslog` (`id`, `level`, `event`, `user_ip`, `user_os`, `user_bs`, `create_user`, `create_time`) VALUES
	(1, 'info', '登录成功!', '466089918', 'Mac', 'Chrome', 'admin', '2022-02-19 12:15:12'),
	(2, 'info', '用户资料成功！', '466089918', 'Mac', 'Chrome', 'admin', '2022-02-19 12:15:18'),
	(3, 'info', '登录成功!', '466089918', 'Mac', 'Chrome', 'admin', '2022-02-19 12:15:28'),
	(4, 'info', '修改站点信息成功！', '466089918', 'Mac', 'Chrome', 'admin', '2022-02-19 12:17:50'),
	(5, 'info', '修改站点信息成功！', '466089918', 'Mac', 'Chrome', 'admin', '2022-02-19 12:18:06'),
	(6, 'info', '修改站点信息成功！', '466089918', 'Mac', 'Chrome', 'admin', '2022-02-19 12:18:37'),
	(7, 'info', '新增用户10002成功！', '466089918', 'Mac', 'Chrome', 'admin', '2022-02-19 12:19:25');
...
INSERT INTO `ay_user` (`id`, `ucode`, `username`, `realname`, `password`, `status`, `login_count`, `last_login_ip`, `create_user`, `update_user`, `create_time`, `update_time`) VALUES
	(1, '10001', 'admin', '超级管理员', 'c3284d0f94606de1fd2af172aba15bf3', '1', 2, '466089918', 'admin', 'admin', '2017-05-08 18:50:30', '2022-02-19 12:15:28'),
	(2, '10002', 'bugku', '1', 'c3284d0f94606de1fd2af172aba15bf3', '1', 0, '0', 'admin', 'admin', '2022-02-19 12:19:25', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `ay_user` ENABLE KEYS */;

-- 导出  表 cms.ay_user_role 结构
CREATE TABLE IF NOT EXISTS `ay_user_role` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '编号',
  `ucode` varchar(20) NOT NULL COMMENT '用户编码',
  `rcode` varchar(20) NOT NULL COMMENT '角色编码',
  PRIMARY KEY (`id`),
...
-- 正在导出表  cms.ay_user_role 的数据：2 rows
DELETE FROM `ay_user_role`;
