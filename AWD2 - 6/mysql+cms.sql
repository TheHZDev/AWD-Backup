...
-- 导出  表 cms.wt_ad 结构
CREATE TABLE IF NOT EXISTS `wt_ad` (
...
-- 正在导出表  cms.wt_ad 的数据：0 rows
DELETE FROM `wt_ad`;
/*!40000 ALTER TABLE `wt_ad` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_ad` ENABLE KEYS */;

-- 导出  表 cms.wt_asset 结构
CREATE TABLE IF NOT EXISTS `wt_asset` (
...
-- 正在导出表  cms.wt_asset 的数据：0 rows
DELETE FROM `wt_asset`;
/*!40000 ALTER TABLE `wt_asset` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_asset` ENABLE KEYS */;

-- 导出  表 cms.wt_auth_access 结构
CREATE TABLE IF NOT EXISTS `wt_auth_access` (
...
-- 正在导出表  cms.wt_auth_access 的数据：0 rows
DELETE FROM `wt_auth_access`;
/*!40000 ALTER TABLE `wt_auth_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_auth_access` ENABLE KEYS */;

-- 导出  表 cms.wt_auth_rule 结构
CREATE TABLE IF NOT EXISTS `wt_auth_rule` (
...
-- 正在导出表  cms.wt_auth_rule 的数据：0 rows
DELETE FROM `wt_auth_rule`;
/*!40000 ALTER TABLE `wt_auth_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_auth_rule` ENABLE KEYS */;

-- 导出  表 cms.wt_comments 结构
...
-- 正在导出表  cms.wt_comments 的数据：0 rows
DELETE FROM `wt_comments`;
/*!40000 ALTER TABLE `wt_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_comments` ENABLE KEYS */;

-- 导出  表 cms.wt_common_action_log 结构
CREATE TABLE IF NOT EXISTS `wt_common_action_log` (
...
-- 正在导出表  cms.wt_common_action_log 的数据：0 rows
DELETE FROM `wt_common_action_log`;
/*!40000 ALTER TABLE `wt_common_action_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_common_action_log` ENABLE KEYS */;

-- 导出  表 cms.wt_guestbook 结构
CREATE TABLE IF NOT EXISTS `wt_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.wt_guestbook 的数据：0 rows
DELETE FROM `wt_guestbook`;
/*!40000 ALTER TABLE `wt_guestbook` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_guestbook` ENABLE KEYS */;

-- 导出  表 cms.wt_links 结构
CREATE TABLE IF NOT EXISTS `wt_links` (
...
-- 正在导出表  cms.wt_links 的数据：3 rows
DELETE FROM `wt_links`;
/*!40000 ALTER TABLE `wt_links` DISABLE KEYS */;
INSERT INTO `wt_links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
	(8, 'https://www.thinkcmf.com/', 'thinkcmf', 'admin/20170907/59b11eb6dd126.png', '_blank', 'thinkcmf', 1, 0, NULL, 1),
	(9, 'http://www.thinkphp.cn/', 'thinkphp', 'admin/20170907/59b11eb6dd126.png', '_blank', 'http://www.thinkphp.cn/', 1, 0, NULL, 0),
	(10, 'http://php.net/', 'php', 'admin/20170907/59b11eb6dd126.png', '_blank', 'http://php.net/', 1, 0, NULL, 0);
/*!40000 ALTER TABLE `wt_links` ENABLE KEYS */;

-- 导出  表 cms.wt_menu 结构
CREATE TABLE IF NOT EXISTS `wt_menu` (
...
-- 正在导出表  cms.wt_menu 的数据：169 rows
DELETE FROM `wt_menu`;
/*!40000 ALTER TABLE `wt_menu` DISABLE KEYS */;
INSERT INTO `wt_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
/*!40000 ALTER TABLE `wt_menu` ENABLE KEYS */;

-- 导出  表 cms.wt_nav 结构
CREATE TABLE IF NOT EXISTS `wt_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.wt_nav 的数据：19 rows
DELETE FROM `wt_nav`;
/*!40000 ALTER TABLE `wt_nav` DISABLE KEYS */;
INSERT INTO `wt_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
	(71, 3, 0, '主页', '', 'home', '', 1, 0, '0-72'),
	(72, 3, 0, '新闻消息', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"1";}}', '', 1, 1, '0-71'),
	(73, 3, 0, '通知公告', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"2";}}', '', 1, 2, '0-73'),
	(74, 3, 0, '最新动态', '', 'a:2:{s:6:"action";s:17:"Portal/List/index";s:5:"param";a:1:{s:2:"id";s:1:"3";}}', '', 1, 3, '0-74'),
	(75, 3, 0, '主页菜单4', '', 'home', '', 1, 4, '0-75'),
	(76, 3, 0, '主页菜单5', '', 'home', '', 1, 5, '0-76'),
	(77, 3, 0, '主页菜单6', '', 'home', '', 1, 6, '0-77'),
	(78, 3, 0, '主页菜单7', '', 'home', '', 1, 7, '0-78'),
	(79, 3, 72, 'submenu1_1', '', 'home', '', 1, 0, '0-71-79'),
	(80, 3, 73, 'submenu2_1', '', 'home', '', 1, 0, '0-73-80'),
	(81, 3, 74, 'submenu3_1', '', 'home', '', 1, 0, '0-74-81'),
	(82, 3, 75, 'submenu4_1', '', 'home', '', 1, 0, '0-75-82'),
	(83, 3, 78, 'submenu7_1', '', 'home', '', 1, 0, '0-78-83'),
	(84, 3, 77, 'submenu6_1', '', 'home', '', 1, 0, '0-77-84'),
	(85, 3, 76, 'submenu5_1', '', 'home', '', 1, 0, '0-76-85'),
	(86, 3, 0, '主页菜单8', '', 'home', '', 1, 8, '0-86'),
	(88, 3, 86, 'submenu8_1', '', 'home', '', 1, 0, '0-86-88'),
	(90, 3, 72, 'submenu1_2', '', 'home', '', 1, 1, '0-71-90'),
	(91, 3, 72, 'submenu1_3', '', 'home', '', 1, 2, '0-71-91');
/*!40000 ALTER TABLE `wt_nav` ENABLE KEYS */;

-- 导出  表 cms.wt_nav_cat 结构
CREATE TABLE IF NOT EXISTS `wt_nav_cat` (
...
-- 正在导出表  cms.wt_nav_cat 的数据：1 rows
DELETE FROM `wt_nav_cat`;
/*!40000 ALTER TABLE `wt_nav_cat` DISABLE KEYS */;
INSERT INTO `wt_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
	(3, '主菜单', 1, '');
/*!40000 ALTER TABLE `wt_nav_cat` ENABLE KEYS */;

-- 导出  表 cms.wt_oauth_user 结构
CREATE TABLE IF NOT EXISTS `wt_oauth_user` (
...
-- 正在导出表  cms.wt_oauth_user 的数据：0 rows
DELETE FROM `wt_oauth_user`;
/*!40000 ALTER TABLE `wt_oauth_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_oauth_user` ENABLE KEYS */;

-- 导出  表 cms.wt_options 结构
CREATE TABLE IF NOT EXISTS `wt_options` (
...
-- 正在导出表  cms.wt_options 的数据：3 rows
DELETE FROM `wt_options`;
/*!40000 ALTER TABLE `wt_options` DISABLE KEYS */;
INSERT INTO `wt_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
	(10, 'site_options', '{"site_name":"TAOSIR","site_admin_url_password":"","site_tpl":"default","site_adminstyle":"flat","site_icp":"","site_admin_email":"","site_tongji":"","site_copyright":"","site_seo_title":"\\u4e3b\\u9875","site_seo_keywords":"","site_seo_description":"","urlmode":"0","html_suffix":"","comment_time_interval":"60"}', 1),
	(11, 'cmf_settings', '{"banned_usernames":""}', 1),
	(12, 'cdn_settings', '{"cdn_static_root":""}', 1);
/*!40000 ALTER TABLE `wt_options` ENABLE KEYS */;

-- 导出  表 cms.wt_plugins 结构
CREATE TABLE IF NOT EXISTS `wt_plugins` (
...
-- 正在导出表  cms.wt_plugins 的数据：0 rows
DELETE FROM `wt_plugins`;
/*!40000 ALTER TABLE `wt_plugins` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_plugins` ENABLE KEYS */;

-- 导出  表 cms.wt_posts 结构
CREATE TABLE IF NOT EXISTS `wt_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.wt_posts 的数据：5 rows
DELETE FROM `wt_posts`;
/*!40000 ALTER TABLE `wt_posts` DISABLE KEYS */;
INSERT INTO `wt_posts` (`id`, `post_author`, `post_keywords`, `post_source`, `post_date`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `post_modified`, `post_content_filtered`, `post_parent`, `post_type`, `post_mime_type`, `comment_count`, `smeta`, `post_hits`, `post_like`, `istop`, `recommended`) VALUES
	(185, 1, 'news', '', '2017-09-07 18:17:01', '<p>news_title_1</p>', 'news_title_1', 'news_title_1', 1, 1, '2017-09-07 18:17:40', NULL, 0, 1, '', 0, '{"thumb":"","template":"article"}', 0, 0, 0, 0),
	(186, 1, 'notice', '', '2017-09-07 18:17:43', '<p>Notice_title_1!</p>', 'Notice_title_1', 'Notice_title_1', 1, 1, '2017-09-07 18:18:06', NULL, 0, 1, '', 0, '{"thumb":"","template":"article"}', 0, 0, 0, 0),
	(187, 1, 'trend', '', '2017-09-07 18:18:08', '<p>Trends_title_1!</p>', 'Trends_title_1', 'Trends_title_1', 1, 1, '2017-09-07 18:18:57', NULL, 0, 1, '', 0, '{"thumb":"","template":"article"}', 0, 0, 0, 0),
	(188, 1, 'news', '', '2017-09-07 18:19:05', '<p>news_title_2</p>', 'news_title_2', 'news_title_2', 1, 1, '2017-09-07 18:19:23', NULL, 0, 1, '', 0, '{"thumb":"","template":"article"}', 0, 0, 0, 0),
	(189, 1, 'notice', '', '2017-09-07 18:19:26', '<p>Notice_title_2</p>', 'Notice_title_2', 'Notice_title_2', 1, 1, '2017-09-07 18:19:49', NULL, 0, 1, '', 0, '{"thumb":"","template":"article"}', 12, 0, 0, 0);
/*!40000 ALTER TABLE `wt_posts` ENABLE KEYS */;

-- 导出  表 cms.wt_role 结构
CREATE TABLE IF NOT EXISTS `wt_role` (
...
-- 正在导出表  cms.wt_role 的数据：0 rows
DELETE FROM `wt_role`;
/*!40000 ALTER TABLE `wt_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_role` ENABLE KEYS */;

-- 导出  表 cms.wt_role_user 结构
CREATE TABLE IF NOT EXISTS `wt_role_user` (
...
-- 正在导出表  cms.wt_role_user 的数据：0 rows
DELETE FROM `wt_role_user`;
/*!40000 ALTER TABLE `wt_role_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_role_user` ENABLE KEYS */;

-- 导出  表 cms.wt_route 结构
CREATE TABLE IF NOT EXISTS `wt_route` (
...
-- 正在导出表  cms.wt_route 的数据：0 rows
DELETE FROM `wt_route`;
/*!40000 ALTER TABLE `wt_route` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_route` ENABLE KEYS */;

-- 导出  表 cms.wt_slide 结构
CREATE TABLE IF NOT EXISTS `wt_slide` (
...
-- 正在导出表  cms.wt_slide 的数据：0 rows
DELETE FROM `wt_slide`;
/*!40000 ALTER TABLE `wt_slide` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_slide` ENABLE KEYS */;

-- 导出  表 cms.wt_slide_cat 结构
CREATE TABLE IF NOT EXISTS `wt_slide_cat` (
...
-- 正在导出表  cms.wt_slide_cat 的数据：0 rows
DELETE FROM `wt_slide_cat`;
/*!40000 ALTER TABLE `wt_slide_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_slide_cat` ENABLE KEYS */;

-- 导出  表 cms.wt_terms 结构
CREATE TABLE IF NOT EXISTS `wt_terms` (
...
-- 正在导出表  cms.wt_terms 的数据：3 rows
DELETE FROM `wt_terms`;
/*!40000 ALTER TABLE `wt_terms` DISABLE KEYS */;
INSERT INTO `wt_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
	(1, '新闻消息', '', 'article', '实验室新闻', 0, 0, '0-123', '', '', '', 'list', 'article', 0, 1),
	(2, '通知公告', '', 'article', '实验室通知', 0, 0, '0-124', '', '', '', 'list', 'article', 0, 1),
	(3, '公司动态', '', 'article', '公司动态', 0, 0, '0-3', '', '', '', 'list', 'article', 0, 1);
/*!40000 ALTER TABLE `wt_terms` ENABLE KEYS */;

-- 导出  表 cms.wt_term_relationships 结构
CREATE TABLE IF NOT EXISTS `wt_term_relationships` (
...
-- 正在导出表  cms.wt_term_relationships 的数据：5 rows
DELETE FROM `wt_term_relationships`;
/*!40000 ALTER TABLE `wt_term_relationships` DISABLE KEYS */;
INSERT INTO `wt_term_relationships` (`tid`, `object_id`, `term_id`, `listorder`, `status`) VALUES
	(137, 185, 1, 0, 1),
	(138, 186, 2, 0, 1),
	(139, 187, 3, 0, 1),
	(140, 188, 1, 0, 1),
	(141, 189, 2, 0, 1);
/*!40000 ALTER TABLE `wt_term_relationships` ENABLE KEYS */;

-- 导出  表 cms.wt_users 结构
...
-- 正在导出表  cms.wt_users 的数据：1 rows
DELETE FROM `wt_users`;
/*!40000 ALTER TABLE `wt_users` DISABLE KEYS */;
INSERT INTO `wt_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
	(1, 'admin', '###1b09e9a9262680ba9582a035c32c5667', 'admin', '365224772@qq.com', '', 'avatar/admin_headicon.png', 0, '2017-01-01', '', '127.0.0.1', '2017-09-07 17:49:26', '2017-05-11 09:43:49', '6818d5f626a1e499782cab7aed3911a8', 1, 0, 1, 0, '');
/*!40000 ALTER TABLE `wt_users` ENABLE KEYS */;

-- 导出  表 cms.wt_user_favorites 结构
CREATE TABLE IF NOT EXISTS `wt_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.wt_user_favorites 的数据：0 rows
DELETE FROM `wt_user_favorites`;
/*!40000 ALTER TABLE `wt_user_favorites` DISABLE KEYS */;
/*!40000 ALTER TABLE `wt_user_favorites` ENABLE KEYS */;
...
INSERT INTO `proxies_priv` (`Host`, `User`, `Proxied_host`, `Proxied_user`, `With_grant`, `Grantor`, `Timestamp`) VALUES
	('localhost', 'root', '', '', 1, '', '2021-10-10 11:55:05'),
	('pvp-624-team-1', 'root', '', '', 1, '', '2021-10-10 11:55:05');
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `Create_tablespace_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`, `plugin`, `authentication_string`) VALUES
	...
	('pvp-624-team-1', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', ''),
	...
	('localhost', 'cms', '*8755E8C7C1BC5B89031222F1E80009BACE2AE7EB', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', NULL);
