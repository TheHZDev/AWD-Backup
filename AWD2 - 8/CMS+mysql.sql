...
-- 正在导出表  cms.dsw_apps 的数据：2 rows
DELETE FROM `dsw_apps`;
/*!40000 ALTER TABLE `dsw_apps` DISABLE KEYS */;
INSERT INTO `dsw_apps` (`appname`, `applabel`, `appfile`, `appimg`, `isview`, `author`, `iscore`, `appversion`, `appsetting`, `description`, `ismenu`, `addtime`, `endtime`) VALUES
	('errorpage', '错误页面处理', '', 'icon.png', 0, '牛哥', 0, '1.2', '', '错误页面处理，将预览者预览到的错误也写入数据库，管理员可以访问已经存在的错误页面,并可以将错误的301页面跳转到新页面', 1, 0, 0),
	('admin', '超级CMS系统后台', '', 'icon.png', 0, '牛哥', 0, '1.69', '', '超级CMS系统后台', 1, 0, 0);
/*!40000 ALTER TABLE `dsw_apps` ENABLE KEYS */;

-- 导出  表 cms.dsw_apps_upgrade 结构
CREATE TABLE IF NOT EXISTS `dsw_apps_upgrade` (
  `appname` varchar(30) NOT NULL COMMENT '模块名称',
  `appversion` varchar(10) NOT NULL COMMENT '版本',
  `description` varchar(255) NOT NULL COMMENT '描述',
  `addtime` int(10) NOT NULL DEFAULT '0' COMMENT '安装时间',
  PRIMARY KEY (`appname`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模块升级记录';

-- 正在导出表  cms.dsw_apps_upgrade 的数据：0 rows
DELETE FROM `dsw_apps_upgrade`;
/*!40000 ALTER TABLE `dsw_apps_upgrade` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_apps_upgrade` ENABLE KEYS */;

-- 导出  表 cms.dsw_article 结构
CREATE TABLE IF NOT EXISTS `dsw_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inrow` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `addtime` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `adduser` int(11) NOT NULL DEFAULT '0' COMMENT '创建者',
  `endtime` int(11) NOT NULL DEFAULT '0' COMMENT '更新时间',
  `enduser` int(11) NOT NULL DEFAULT '0' COMMENT '更新用户',
  ...
  `view` int(11) NOT NULL DEFAULT '0' COMMENT '阅读次数',
  `zan` int(11) DEFAULT '0' COMMENT '点赞量',
  `zan_uid` text COMMENT '点赞的用户ID',
  `fixedtime` int(11) NOT NULL DEFAULT '0' COMMENT '定时发送',
  `attribute` varchar(255) NOT NULL COMMENT '文章属性',
  `isview` int(1) NOT NULL DEFAULT '0' COMMENT '是否显示',
  `price` int(11) NOT NULL DEFAULT '0' COMMENT '价格',
  `other_a` varchar(255) NOT NULL COMMENT '其他A',
  `other_b` varchar(255) NOT NULL COMMENT '其他B',
  `other_c` varchar(255) NOT NULL COMMENT '其他C',
  `other_d` varchar(255) NOT NULL COMMENT '其他D',
  `other_e` varchar(255) NOT NULL COMMENT '其他E',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='文章';

-- 正在导出表  cms.dsw_article 的数据：1 rows
DELETE FROM `dsw_article`;
/*!40000 ALTER TABLE `dsw_article` DISABLE KEYS */;
INSERT INTO `dsw_article` (`id`, `inrow`, `addtime`, `adduser`, `endtime`, `enduser`, `cat_id`, `title`, `seo_title`, `seo_description`, `seo_keywords`, `seo_tags`, `seo_relation`, `content`, `img`, `out_from`, `out_url`, `view`, `zan`, `zan_uid`, `fixedtime`, `attribute`, `isview`, `price`, `other_a`, `other_b`, `other_c`, `other_d`, `other_e`) VALUES
	(1, 0, 1634979380, 1, 1634979388, 1, 0, '11111', '', '', '', '', '', '<p>test</p>', '', '', '', 0, 0, NULL, 0, '', 0, 0, '', '', '', '', '');
/*!40000 ALTER TABLE `dsw_article` ENABLE KEYS */;

-- 导出  表 cms.dsw_article_attribute 结构
CREATE TABLE IF NOT EXISTS `dsw_article_attribute` (
...
-- 正在导出表  cms.dsw_article_attribute 的数据：0 rows
DELETE FROM `dsw_article_attribute`;
/*!40000 ALTER TABLE `dsw_article_attribute` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_article_attribute` ENABLE KEYS */;

-- 导出  表 cms.dsw_category 结构
CREATE TABLE IF NOT EXISTS `dsw_category` (
  ...
  `seo_keywords` varchar(255) NOT NULL COMMENT 'SEO关键词',
  `seo_description` varchar(255) NOT NULL COMMENT 'SEO描述',
  `cat_view` int(11) NOT NULL DEFAULT '0' COMMENT '浏览次数',
  `cat_content` text NOT NULL COMMENT '栏目详细内容',
  `cat_pagenum` int(10) NOT NULL DEFAULT '0' COMMENT '分页记录数',
  `ismenu` int(11) NOT NULL DEFAULT '0' COMMENT '是否在菜单显示1为显示，0为不显示',
  `isview` int(1) NOT NULL DEFAULT '0' COMMENT '是否显示',
  `isindex` int(1) NOT NULL DEFAULT '0' COMMENT '在首页显示',
  `isoutlink` int(1) NOT NULL DEFAULT '0' COMMENT '是否为外部链接',
  `rank` int(3) NOT NULL DEFAULT '0' COMMENT '等级,层级',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='栏目分类';

-- 正在导出表  cms.dsw_category 的数据：0 rows
DELETE FROM `dsw_category`;
/*!40000 ALTER TABLE `dsw_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_category` ENABLE KEYS */;

-- 导出  表 cms.dsw_errorpage 结构
CREATE TABLE IF NOT EXISTS `dsw_errorpage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `adduser` int(11) NOT NULL COMMENT '如果是登陆用户记录用户信息',
  `addtime` int(10) NOT NULL COMMENT '错误页面发生时间',
  `errorpage` varchar(255) NOT NULL COMMENT '错误页面',
  `ip` varchar(100) NOT NULL COMMENT 'IP地址',
  `is_ok` int(1) NOT NULL COMMENT '是否已处理',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='错误页面记录表';

-- 正在导出表  cms.dsw_errorpage 的数据：~0 rows (大约)
DELETE FROM `dsw_errorpage`;
/*!40000 ALTER TABLE `dsw_errorpage` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_errorpage` ENABLE KEYS */;

-- 导出  表 cms.dsw_errorpage_301 结构
CREATE TABLE IF NOT EXISTS `dsw_errorpage_301` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `adduser` int(11) NOT NULL COMMENT '如果是登陆用户记录用户信息',
  `addtime` int(10) NOT NULL COMMENT '错误页面发生时间',
  `errorpage` varchar(255) NOT NULL COMMENT '错误页面',
  `newpage` varchar(255) NOT NULL COMMENT '新的地址',
  `ip` varchar(100) NOT NULL COMMENT 'IP地址',
  `is_ok` int(1) NOT NULL COMMENT '是否已处理',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='错误页面记录表';

-- 正在导出表  cms.dsw_errorpage_301 的数据：~0 rows (大约)
DELETE FROM `dsw_errorpage_301`;
/*!40000 ALTER TABLE `dsw_errorpage_301` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_errorpage_301` ENABLE KEYS */;

-- 导出  表 cms.dsw_jiaodiantu 结构
CREATE TABLE IF NOT EXISTS `dsw_jiaodiantu` (
  ...
  `inrow` int(2) NOT NULL DEFAULT '0' COMMENT '排序',
  `addtime` int(10) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='焦点图';

-- 正在导出表  cms.dsw_jiaodiantu 的数据：0 rows
DELETE FROM `dsw_jiaodiantu`;
/*!40000 ALTER TABLE `dsw_jiaodiantu` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_jiaodiantu` ENABLE KEYS */;

-- 导出  表 cms.dsw_navmenu 结构
CREATE TABLE IF NOT EXISTS `dsw_navmenu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='菜单';

-- 正在导出表  cms.dsw_navmenu 的数据：27 rows
DELETE FROM `dsw_navmenu`;
/*!40000 ALTER TABLE `dsw_navmenu` DISABLE KEYS */;
INSERT INTO `dsw_navmenu` (`id`, `inrow`, `adduser`, `addtime`, `enduser`, `endtime`, `menu_name`, `menu_label`, `menu_path`, `menu_img`, `parent_id`, `menu_target`, `menu_type`, `rank`, `ismain`, `isview`, `isoutlink`, `iconfont`) VALUES
	...
	(27, 0, 1, 1634979168, 1, 1634979168, 'errorpage', '错误页面处理', 'index.php?errorpage-master-index', '', 16, '', 'admin', 0, 0, 1, 1, ''),
	(28, 0, 1, 1634979221, 1, 1634979221, 'admin', '超级CMS系统后台', 'index.php?admin-master-index', '', 16, '', 'admin', 0, 0, 1, 1, '');
/*!40000 ALTER TABLE `dsw_navmenu` ENABLE KEYS */;

-- 导出  表 cms.dsw_navmenu_group 结构
CREATE TABLE IF NOT EXISTS `dsw_navmenu_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='菜单分类';

-- 正在导出表  cms.dsw_navmenu_group 的数据：2 rows
DELETE FROM `dsw_navmenu_group`;
/*!40000 ALTER TABLE `dsw_navmenu_group` DISABLE KEYS */;
INSERT INTO `dsw_navmenu_group` (`id`, `inrow`, `group_name`, `group_label`, `issys`) VALUES
	(1, 1, 'admin', '后台菜单', 1),
	(2, 2, 'home', '前台菜单', 1);
/*!40000 ALTER TABLE `dsw_navmenu_group` ENABLE KEYS */;

-- 导出  表 cms.dsw_search 结构
CREATE TABLE IF NOT EXISTS `dsw_search` (
  ...
  `search_time` int(10) NOT NULL DEFAULT '0' COMMENT '搜索时间',
...
-- 正在导出表  cms.dsw_search 的数据：0 rows
DELETE FROM `dsw_search`;
/*!40000 ALTER TABLE `dsw_search` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_search` ENABLE KEYS */;

-- 导出  表 cms.dsw_tags 结构
CREATE TABLE IF NOT EXISTS `dsw_tags` (
  `tag_id` int(11) NOT NULL AUTO_INCREMENT,
  `tag_label` varchar(100) NOT NULL COMMENT '标签名称',
  `tag_article` text COMMENT '文章标签',
  PRIMARY KEY (`tag_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='tag标签';

-- 正在导出表  cms.dsw_tags 的数据：0 rows
DELETE FROM `dsw_tags`;
/*!40000 ALTER TABLE `dsw_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_tags` ENABLE KEYS */;

-- 导出  表 cms.dsw_uploadfile 结构
CREATE TABLE IF NOT EXISTS `dsw_uploadfile` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='上传文件管理';

-- 正在导出表  cms.dsw_uploadfile 的数据：0 rows
DELETE FROM `dsw_uploadfile`;
/*!40000 ALTER TABLE `dsw_uploadfile` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_uploadfile` ENABLE KEYS */;

-- 导出  表 cms.dsw_user 结构
...
-- 正在导出表  cms.dsw_user 的数据：1 rows
DELETE FROM `dsw_user`;
/*!40000 ALTER TABLE `dsw_user` DISABLE KEYS */;
INSERT INTO `dsw_user` (`id`, `inrow`, `adduser`, `addtime`, `enduser`, `endtime`, `username`, `psd`, `nickname`, `issuper`, `isadmin`, `isdel`, `istjr`) VALUES
	(1, 1, 0, 1634978916, 0, 1634978916, 'admin', 'f865b53623b121fd34ee5426c792e5c33af8c227', 'admin', 1, 1, 0, 0);
/*!40000 ALTER TABLE `dsw_user` ENABLE KEYS */;

-- 导出  表 cms.dsw_userlogin 结构
CREATE TABLE IF NOT EXISTS `dsw_userlogin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(50) DEFAULT NULL COMMENT '用户名',
  `addtime` int(10) DEFAULT '0' COMMENT '首次添加时间',
  `login_ip` varchar(50) DEFAULT '空' COMMENT '登陆IP',
  `login_status` int(1) NOT NULL DEFAULT '0' COMMENT '登陆状态：1为成功，0为失败',
  `remark` text COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户登录记录';

-- 正在导出表  cms.dsw_userlogin 的数据：1 rows
DELETE FROM `dsw_userlogin`;
/*!40000 ALTER TABLE `dsw_userlogin` DISABLE KEYS */;
INSERT INTO `dsw_userlogin` (`id`, `username`, `addtime`, `login_ip`, `login_status`, `remark`) VALUES
	(1, 'admin', 1634978949, '39.85.201.221', 1, '');
/*!40000 ALTER TABLE `dsw_userlogin` ENABLE KEYS */;

-- 导出  表 cms.dsw_user_level 结构
...
-- 正在导出表  cms.dsw_user_level 的数据：0 rows
DELETE FROM `dsw_user_level`;
/*!40000 ALTER TABLE `dsw_user_level` DISABLE KEYS */;
/*!40000 ALTER TABLE `dsw_user_level` ENABLE KEYS */;

-- 导出  表 cms.dsw_webconfig 结构
...
-- 正在导出表  cms.dsw_webconfig 的数据：28 rows
DELETE FROM `dsw_webconfig`;
/*!40000 ALTER TABLE `dsw_webconfig` DISABLE KEYS */;
INSERT INTO `dsw_webconfig` (`id`, `inrow`, `adduser`, `addtime`, `enduser`, `endtime`, `varname`, `varlabel`, `appname`, `value`, `status`, `issys`) VALUES
	...
	(2, 0, 0, 0, 0, 0, 'web_name', '网站名称', 'website', 'Bugku awd s2', 1, 1),
	...
	(7, 0, 0, 0, 0, 0, 'web_logo', '网站logo', 'website', '/static/upload/image/20211023/16349790109238.png', 1, 1),
	(8, 0, 0, 0, 0, 0, 'seo_title', 'seo标题', 'website', 'Bugku awd s2', 1, 1),
	(9, 0, 0, 0, 0, 0, 'seo_keywords', 'seo关键词', 'website', 'Bugku awd s2', 1, 1),
	(10, 0, 0, 0, 0, 0, 'seo_description', 'seo描述', 'website', '内容管理系统（以下简称产品）由SEO研究中心为了解决网站优化问题而研发的一套产品，本产品采用面向对象方式自助研发的MVC框架开发，它是一款高效开源的内容管理系统，产品基于PHP+MYSQL架构，可运行在Windows、Linux、MacOSX、Solaris等各种平台上', 1, 1),
	(11, 0, 0, 0, 0, 0, 'web_copyright', '网站底部版权区域', 'website', 'copyright © 2007-2018  版权所有', 1, 1),
	(12, 0, 0, 0, 0, 0, 'web_index', '首页链接地址', 'website', 'index.html', 1, 1),
	(13, 0, 0, 0, 0, 0, 'web_email', '网站email', 'website', '', 1, 1),
	(14, 0, 0, 0, 0, 0, 'web_url', '网站网址', 'website', '/', 1, 1),
	(15, 0, 0, 0, 0, 0, 'web_qq', '网站QQ', 'website', '', 1, 1),
	(16, 0, 0, 0, 0, 0, 'web_phone', '手机号码', 'website', '', 1, 1),
	...
	(23, 0, 0, 0, 0, 0, 'web_worktime', '上班时间', 'website', '', 1, 1),
	(24, 0, 0, 0, 0, 0, 'web_kouhao', '公司口号', 'website', '', 1, 1),
	(25, 0, 0, 0, 0, 0, 'web_aboutus', '关于我们', 'website', '', 1, 1),
	(26, 0, 0, 0, 0, 0, 'web_tel', '电话号码', 'website', '', 1, 1),
	(27, 0, 0, 0, 0, 0, 'home_title', '首页名称', 'website', '首页', 1, 1),
	(28, 0, 0, 0, 0, 0, 'web_erweima', '二维码', 'website', '', 1, 1);
/*!40000 ALTER TABLE `dsw_webconfig` ENABLE KEYS */;
...
INSERT INTO `proxies_priv` (`Host`, `User`, `Proxied_host`, `Proxied_user`, `With_grant`, `Grantor`, `Timestamp`) VALUES
	('localhost', 'root', '', '', 1, '', '2021-11-07 11:55:04'),
	('pvp-753-team-1', 'root', '', '', 1, '', '2021-11-07 11:55:04');
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `Create_tablespace_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`, `plugin`, `authentication_string`) VALUES
	...
	('pvp-753-team-1', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', ''),
	...
	('localhost', 'cms', '*32C23AD935321C7ECF0B37DA5F4455D0AAA58536', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', NULL);
