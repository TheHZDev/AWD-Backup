...
-- 导出 beescms 的数据库结构
CREATE DATABASE IF NOT EXISTS `beescms` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `beescms`;

-- 导出  表 beescms.bees_admin 结构
CREATE TABLE IF NOT EXISTS `bees_admin` (
...
-- 正在导出表  beescms.bees_admin 的数据：1 rows
DELETE FROM `bees_admin`;
/*!40000 ALTER TABLE `bees_admin` DISABLE KEYS */;
INSERT INTO `bees_admin` (`id`, `admin_name`, `admin_password`, `admin_nich`, `admin_purview`, `admin_admin`, `admin_mail`, `admin_tel`, `is_disable`, `admin_ip`, `admin_time`) VALUES
	(9, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 1, NULL, 'admin@qq.com', NULL, 0, NULL, NULL);
/*!40000 ALTER TABLE `bees_admin` ENABLE KEYS */;

-- 导出  表 beescms.bees_admin_group 结构
CREATE TABLE IF NOT EXISTS `bees_admin_group` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_admin_group 的数据：2 rows
DELETE FROM `bees_admin_group`;
/*!40000 ALTER TABLE `bees_admin_group` DISABLE KEYS */;
INSERT INTO `bees_admin_group` (`id`, `admin_group_name`, `admin_group_info`, `admin_group_purview`, `is_disable`) VALUES
...
-- 导出  表 beescms.bees_alone 结构
CREATE TABLE IF NOT EXISTS `bees_alone` (
...
-- 正在导出表  beescms.bees_alone 的数据：1 rows
DELETE FROM `bees_alone`;
/*!40000 ALTER TABLE `bees_alone` DISABLE KEYS */;
INSERT INTO `bees_alone` (`id`, `content`, `pics`) VALUES
...
-- 导出  表 beescms.bees_ask 结构
CREATE TABLE IF NOT EXISTS `bees_ask` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_ask 的数据：0 rows
DELETE FROM `bees_ask`;
/*!40000 ALTER TABLE `bees_ask` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_ask` ENABLE KEYS */;

-- 导出  表 beescms.bees_auto_fields 结构
CREATE TABLE IF NOT EXISTS `bees_auto_fields` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_auto_fields 的数据：14 rows
DELETE FROM `bees_auto_fields`;
/*!40000 ALTER TABLE `bees_auto_fields` DISABLE KEYS */;
INSERT INTO `bees_auto_fields` (`id`, `field_name`, `use_name`, `field_type`, `field_value`, `field_length`, `channel_id`, `field_info`, `is_disable`, `check_value`, `field_order`, `is_del`) VALUES
...
-- 导出  表 beescms.bees_block 结构
CREATE TABLE IF NOT EXISTS `bees_block` (
...
-- 正在导出表  beescms.bees_block 的数据：4 rows
DELETE FROM `bees_block`;
/*!40000 ALTER TABLE `bees_block` DISABLE KEYS */;
INSERT INTO `bees_block` (`id`, `tag`, `content`, `tag_name`, `lang`) VALUES
...
-- 导出  表 beescms.bees_book 结构
CREATE TABLE IF NOT EXISTS `bees_book` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_book 的数据：1 rows
DELETE FROM `bees_book`;
/*!40000 ALTER TABLE `bees_book` DISABLE KEYS */;
INSERT INTO `bees_book` (`id`, `book_name`, `mail`, `book_type`, `pr_id`, `book_title`, `book_content`, `addtime`, `reply`, `verify`, `lang`) VALUES
	(1, '测试名', 'test@163.com', 2, 23, '询问价格', '问下这个产品的价格', '1309053643', '', 1, 'cn');
/*!40000 ALTER TABLE `bees_book` ENABLE KEYS */;

-- 导出  表 beescms.bees_book_info 结构
CREATE TABLE IF NOT EXISTS `bees_book_info` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_book_info 的数据：1 rows
DELETE FROM `bees_book_info`;
/*!40000 ALTER TABLE `bees_book_info` DISABLE KEYS */;
INSERT INTO `bees_book_info` (`id`, `is_book`, `book_pos`, `book_verify`) VALUES
	(1, '1', '2', '0');
/*!40000 ALTER TABLE `bees_book_info` ENABLE KEYS */;

-- 导出  表 beescms.bees_category 结构
CREATE TABLE IF NOT EXISTS `bees_category` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_category 的数据：22 rows
DELETE FROM `bees_category`;
/*!40000 ALTER TABLE `bees_category` DISABLE KEYS */;
INSERT INTO `bees_category` (`id`, `custom_url`, `cate_name`, `cate_mb_is`, `cate_hide`, `cate_channel`, `cate_fold_name`, `cate_order`, `cate_rank`, `cate_tpl`, `cate_tpl_index`, `cate_tpl_list`, `cate_tpl_content`, `cate_title_seo`, `cate_key_seo`, `cate_info_seo`, `lang`, `cate_parent`, `cate_html`, `cate_nav`, `is_content`, `cate_url`, `cate_is_open`, `form_id`, `cate_pic1`, `cate_pic2`, `cate_pic3`, `cate_content`, `temp_id`, `list_num`, `nav_show`) VALUES
	(4, '', '新闻动态', 0, 0, 2, 'xwzx', 1, 0, 0, '', 'list_article.html', 'article_content.html', '', '', '', 'cn', 0, 1, '2', 0, 'http://', 0, 0, '', '', '', '', 2, 20, '0'),
	(5, '', '产品中心', 0, 0, 3, 'cpzx', 2, 0, 0, '', 'list_product.html', 'product_content.html', '', '', '', 'cn', 0, 1, '2', 0, 'http://', 0, 8, '', '', '', '', 3, 20, ''),
	(8, '', '关于我们', 0, 0, 1, 'gywm', 5, 0, 3, '', 'list_alone.html', 'alone_content.html', '', '', '', 'cn', 0, 1, '2', 1, 'http://', 0, 8, '', '', '', '', 0, 20, ''),
	(9, '', '企业新闻', 0, 0, 2, 'qyxw', 1, 0, 0, '', 'list_article.html', 'article_content.html', '', '', '', 'cn', 4, 1, '', 0, 'http://', 0, 8, '', '', '', '', 0, 20, ''),
	(10, '', '最新动态', 0, 0, 2, 'zxdt', 2, 0, 0, '', 'list_article.html', 'article_content.html', '', '', '', 'cn', 4, 1, '', 0, 'http://', 0, 0, '', '', '', '', 0, 20, '0'),
	(11, '', '手提包', 0, 0, 3, 'stb', 1, 0, 0, '', 'list_product.html', 'product_content.html', '', '', '', 'cn', 5, 1, '', 0, 'http://', 0, 8, '', '', '', '', 4, 20, ''),
	(12, '', '产品订购', 0, 0, -9, 'cpdg', 6, 0, 0, '', 'order_content.html', 'order_content.html', '', '', '', 'cn', 8, 1, '2', 0, 'http://', 0, 0, '', '', '', '', 0, 20, '0'),
	(13, '', '公文包', 0, 0, 3, 'gwb', 2, 0, 0, '', 'list_product.html', 'product_content.html', '', '', '', 'cn', 5, 1, '', 0, 'http://', 0, 8, '', '', '', '', 0, 20, ''),
	(14, '', '真皮包', 0, 0, 3, 'zpb', 3, 0, 0, '', 'list_product.html', 'product_content.html', '', '', '', 'cn', 5, 1, '', 0, 'http://', 0, 8, '', '', '', '', 0, 20, ''),
	(15, '', '办公设备', 0, 0, 3, 'bgsb', 4, 0, 0, '', 'list_product.html', 'product_content.html', '', '', '', 'cn', 5, 1, '', 0, 'http://', 0, 8, '', '', '', '', 0, 20, ''),
	(16, '', '数码用品', 0, 0, 3, 'smyp', 5, 0, 0, '', 'list_product.html', 'product_content.html', '', '', '', 'cn', 5, 1, '', 0, 'http://', 0, 8, '', '', '', '', 0, 20, ''),
	(17, '', '喷墨打印机', 0, 0, 3, 'pmdyj', 10, 0, 0, '', 'list_product.html', 'product_content.html', '', '', '', 'cn', 15, 1, '', 0, 'http://', 0, 8, '', '', '', '', 0, 20, ''),
	(18, '', 'News', 0, 0, 2, 'news', 1, 0, 0, '', 'list_article.html', 'article_content.html', '', '', '', 'en', 0, 1, '2', 0, 'http://', 0, 0, '', '', '', '', 0, 20, '0'),
	...
	(26, '', '应用案例', 0, 0, 2, 'yyal', 3, 0, 0, '', 'list_product.html', 'article_content.html', '', '', '', 'cn', 0, 1, '2', 0, 'http://', 0, 0, '', '', '', '', 0, 20, '0'),
	(27, '', '客户留言', 0, 0, -9, 'khly', 5, 0, 0, '', 'order_content_feed.html', 'order_content.html', '', '', '', 'cn', 8, 1, '', 0, 'http://', 0, 0, '', '', '', '', 0, 20, '0');
/*!40000 ALTER TABLE `bees_category` ENABLE KEYS */;

-- 导出  表 beescms.bees_channel 结构
CREATE TABLE IF NOT EXISTS `bees_channel` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_channel 的数据：6 rows
DELETE FROM `bees_channel`;
/*!40000 ALTER TABLE `bees_channel` DISABLE KEYS */;
INSERT INTO `bees_channel` (`id`, `channel_name`, `channel_mark`, `channel_table`, `is_disable`, `is_member`, `channel_mb_grade`, `is_verify`, `is_del`, `channel_order`, `is_alone`, `list_php`, `content_php`) VALUES
	...
	(4, '下载模块', 'down', 'down', 1, 0, 2, 0, 0, 3, 0, 'down/down.php', 'down/show_down.php'),
	(5, '招聘模块', 'job', 'job', 1, 0, 2, 0, 0, 4, 0, 'job/job.php', 'job/show_job.php'),
	(-9, '表单模块', 'mx_form', 'mx_form', 0, 0, 0, 0, 0, 10, 0, 'mx_form/mx_form.php', 'mx_form/show_mx_form.php');
/*!40000 ALTER TABLE `bees_channel` ENABLE KEYS */;

-- 导出  表 beescms.bees_cmsinfo 结构
CREATE TABLE IF NOT EXISTS `bees_cmsinfo` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_cmsinfo 的数据：4 rows
DELETE FROM `bees_cmsinfo`;
/*!40000 ALTER TABLE `bees_cmsinfo` DISABLE KEYS */;
INSERT INTO `bees_cmsinfo` (`id`, `info_tag`, `info_array`, `info_name`, `lang_tag`) VALUES
...
-- 导出  表 beescms.bees_collect 结构
CREATE TABLE IF NOT EXISTS `bees_collect` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_collect 的数据：0 rows
DELETE FROM `bees_collect`;
/*!40000 ALTER TABLE `bees_collect` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_collect` ENABLE KEYS */;

-- 导出  表 beescms.bees_down 结构
CREATE TABLE IF NOT EXISTS `bees_down` (
  `id` mediumint(8) NOT NULL,
...
-- 正在导出表  beescms.bees_down 的数据：0 rows
DELETE FROM `bees_down`;
/*!40000 ALTER TABLE `bees_down` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_down` ENABLE KEYS */;

-- 导出  表 beescms.bees_feedform 结构
CREATE TABLE IF NOT EXISTS `bees_feedform` (
  `id` mediumint(8) NOT NULL,
...
-- 正在导出表  beescms.bees_feedform 的数据：0 rows
DELETE FROM `bees_feedform`;
/*!40000 ALTER TABLE `bees_feedform` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_feedform` ENABLE KEYS */;

-- 导出  表 beescms.bees_flash_ad 结构
CREATE TABLE IF NOT EXISTS `bees_flash_ad` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_flash_ad 的数据：4 rows
DELETE FROM `bees_flash_ad`;
/*!40000 ALTER TABLE `bees_flash_ad` DISABLE KEYS */;
INSERT INTO `bees_flash_ad` (`id`, `pic`, `pic_url`, `pic_text`, `pic_order`, `lang`, `cate_id`) VALUES
...
-- 导出  表 beescms.bees_flash_ad_cate 结构
CREATE TABLE IF NOT EXISTS `bees_flash_ad_cate` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `cate_name` varchar(60) NOT NULL,
...
-- 正在导出表  beescms.bees_flash_ad_cate 的数据：2 rows
DELETE FROM `bees_flash_ad_cate`;
/*!40000 ALTER TABLE `bees_flash_ad_cate` DISABLE KEYS */;
INSERT INTO `bees_flash_ad_cate` (`id`, `cate_name`, `cate_tpl_id`, `is_disable`) VALUES
	(1, '默认', 2, 1),
	(2, '成功案例', 1, 0);
/*!40000 ALTER TABLE `bees_flash_ad_cate` ENABLE KEYS */;

-- 导出  表 beescms.bees_flash_info 结构
CREATE TABLE IF NOT EXISTS `bees_flash_info` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_flash_info 的数据：1 rows
DELETE FROM `bees_flash_info`;
/*!40000 ALTER TABLE `bees_flash_info` DISABLE KEYS */;
INSERT INTO `bees_flash_info` (`id`, `flash_width`, `flash_height`, `flash_style`, `lang`, `cate_id`) VALUES
	(1, '1000', '200', 1, 'cn', 1);
/*!40000 ALTER TABLE `bees_flash_info` ENABLE KEYS */;

-- 导出  表 beescms.bees_form 结构
CREATE TABLE IF NOT EXISTS `bees_form` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_form 的数据：3 rows
DELETE FROM `bees_form`;
/*!40000 ALTER TABLE `bees_form` DISABLE KEYS */;
INSERT INTO `bees_form` (`id`, `form_name`, `form_mark`, `is_disable`) VALUES
	(5, '产品购买', 'prinfo', 0),
	(8, '在线应聘', 'webjob', 0),
	(9, '留言反馈', 'feedform', 0);
/*!40000 ALTER TABLE `bees_form` ENABLE KEYS */;

-- 导出  表 beescms.bees_formfield 结构
CREATE TABLE IF NOT EXISTS `bees_formfield` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `field_name` varchar(60) NOT NULL,
...
-- 正在导出表  beescms.bees_formfield 的数据：24 rows
DELETE FROM `bees_formfield`;
/*!40000 ALTER TABLE `bees_formfield` DISABLE KEYS */;
INSERT INTO `bees_formfield` (`id`, `field_name`, `use_name`, `field_type`, `field_value`, `field_length`, `form_id`, `field_info`, `is_disable`, `form_order`, `is_empty`) VALUES
...
-- 导出  表 beescms.bees_formlist 结构
CREATE TABLE IF NOT EXISTS `bees_formlist` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `form_id` mediumint(8) DEFAULT NULL,
...
-- 正在导出表  beescms.bees_formlist 的数据：0 rows
DELETE FROM `bees_formlist`;
/*!40000 ALTER TABLE `bees_formlist` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_formlist` ENABLE KEYS */;

-- 导出  表 beescms.bees_job 结构
CREATE TABLE IF NOT EXISTS `bees_job` (
  `id` mediumint(8) NOT NULL,
...
-- 正在导出表  beescms.bees_job 的数据：0 rows
DELETE FROM `bees_job`;
/*!40000 ALTER TABLE `bees_job` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_job` ENABLE KEYS */;

-- 导出  表 beescms.bees_keywords 结构
CREATE TABLE IF NOT EXISTS `bees_keywords` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_keywords 的数据：0 rows
DELETE FROM `bees_keywords`;
/*!40000 ALTER TABLE `bees_keywords` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_keywords` ENABLE KEYS */;

-- 导出  表 beescms.bees_lang 结构
CREATE TABLE IF NOT EXISTS `bees_lang` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_lang 的数据：2 rows
DELETE FROM `bees_lang`;
/*!40000 ALTER TABLE `bees_lang` DISABLE KEYS */;
INSERT INTO `bees_lang` (`id`, `lang_name`, `lang_order`, `lang_tag`, `lang_is_use`, `lang_is_open`, `lang_is_url`, `lang_url`, `lang_is_fix`, `lang_main`) VALUES
	(10, 'English', 9, 'en', 1, 0, 0, 'http://', 0, 0),
	(9, '简体中文', 10, 'cn', 1, 0, 0, 'http://', 1, 1);
/*!40000 ALTER TABLE `bees_lang` ENABLE KEYS */;

-- 导出  表 beescms.bees_lang_cate 结构
CREATE TABLE IF NOT EXISTS `bees_lang_cate` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_lang_cate 的数据：8 rows
DELETE FROM `bees_lang_cate`;
/*!40000 ALTER TABLE `bees_lang_cate` DISABLE KEYS */;
INSERT INTO `bees_lang_cate` (`id`, `lang_cate`, `lang_info`, `lang`) VALUES
...
-- 导出  表 beescms.bees_lang_lang 结构
CREATE TABLE IF NOT EXISTS `bees_lang_lang` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `lang_tag` varchar(60) NOT NULL,
...
-- 正在导出表  beescms.bees_lang_lang 的数据：134 rows
DELETE FROM `bees_lang_lang`;
/*!40000 ALTER TABLE `bees_lang_lang` DISABLE KEYS */;
INSERT INTO `bees_lang_lang` (`id`, `lang_tag`, `lang_value`, `lang`) VALUES
	(5, 'pages', '共', 'cn'),
	(6, 'pagesize', '条记录', 'cn'),
	(7, 'page', '当前第', 'cn'),
	(8, 'pagehome', '首页', 'cn'),
...
-- 导出  表 beescms.bees_link 结构
CREATE TABLE IF NOT EXISTS `bees_link` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_link 的数据：4 rows
DELETE FROM `bees_link`;
/*!40000 ALTER TABLE `bees_link` DISABLE KEYS */;
INSERT INTO `bees_link` (`id`, `link_url`, `link_name`, `link_logo`, `link_order`, `link_info`, `link_mail`, `lang`, `addtime`, `link_type`) VALUES
	...
	(7, 'http://www.169host.com', '高速免备案空间', '', 12, '', '', 'cn', '1432800279', 0);
/*!40000 ALTER TABLE `bees_link` ENABLE KEYS */;

-- 导出  表 beescms.bees_maintb 结构
CREATE TABLE IF NOT EXISTS `bees_maintb` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL,
...
-- 正在导出表  beescms.bees_maintb 的数据：29 rows
DELETE FROM `bees_maintb`;
/*!40000 ALTER TABLE `bees_maintb` DISABLE KEYS */;
INSERT INTO `bees_maintb` (`id`, `title`, `filter`, `tbpic`, `keywords`, `info`, `author`, `source`, `hits`, `category`, `channel`, `addtime`, `updatetime`, `top`, `purview`, `is_html`, `verify`, `url`, `lang`, `is_url`, `url_add`, `title_color`, `title_style`, `is_open`, `cache_time`, `custom_url`, `c_order`, `content_key`, `small_title`) VALUES
	(1, 'BEES企业建站系统如何添加公司简介等单页内容', '', 'img/20110625/20110625120321_thumb.gif', '', '在企业网站中会存在一些单页内容，主要通过栏目或是其他链接进入，单页内容直接显示内容，不经过内容列表页或是其它页面，大多数都是独立的一个页面，如关于我们、公司简介等', '未知', '未知', 8, 9, 2, '1308971167', '1308971167', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_1.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(2, 'BEES企业建站系统如何添加联系方式关于我们等片段内容', '', '', '', '一个企业网站中都会存在一些片段内容，如联系方式等，这些片段内容不是一个独立的页面，只是一个或几个页面中的一些内容，\r\n使用BEES企业建站系统添加这些片段内容主要使用标示', '未知', '未知', 380, 9, 2, '1308974794', '1308974794', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_2.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(3, '输出设置说明及其更换模板注意事项', '', '', '', 'BEES网站管理系统中的输出设置功能需要在动态页面访问下才能获取模板中的配置位置。操作流程如下：\r\n1、安装完程序后，动态访问首页或其它页面\r\n该过程程序会自动获取模板中使用', '未知', '未知', 28, 9, 2, '1308974781', '1308974781', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_3.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(4, '如何使用内容模型', '', 'img/20110625/20110625120453_thumb.gif', '', 'BEES企业网站管理系统内置多种内容模型，并且可以自定义内容模型，内容模型分别对应使用的模板。如图：\r\n\r\n可以关闭开启内容模型，添加内容的时候也会显示开启的内容模型\r\n通过右', '未知', '未知', 495, 9, 2, '1308974793', '1308974793', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_4.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(5, '使用BEES企业网站管理系统首页空白没内容的解决', '', 'img/20110625/20110625120512_thumb.gif', '', '解决BEES企业网站管理系统首页空白没有内容的方法：\r\n1、首先要确保网站添加了栏目和内容，每个栏目至少有10篇内容，如果栏目和内容都没有那就没办法了。\r\n2、栏目显示的设置，添', '未知', '未知', 226, 9, 2, '1308974819', '1308974819', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_5.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(6, '如何设置进站语言', '', 'img/20110625/20110625122859_thumb.gif', '', 'BEES企业网站管理系统是多语言系统，在支持多语言的情况下，可以选择一种语言作为进入网站的语言。\r\n如默认语言有简体中文和英文，新装程序进入网站默认是中文。\r\n可以通过后台设', '未知', '未知', 139, 9, 2, '1308974800', '1308974800', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_6.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(7, 'BEES企业网站系统使用教程——管理栏目', '', 'img/20110625/20110625122940_thumb.gif', '', '在BEES企业网站管理系统中添加了栏目后会跳转到栏目管理界面，在这里可以对添加的栏目进行各种操作，界面如下：\r\n\r\n左边为添加的栏目信息，排序和是否在网站导航中显示。\r\n&lsquo', '未知', '未知', 9, 9, 2, '1308974761', '1308974761', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_7.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(8, '语言切换说明', '', 'img/20110625/20110625123018_thumb.gif', '', 'BEES企业网站管理系统是一套多语言系统，每种语言是一个独立的网站，拥有该语言的内容及其网站配置信息。\r\n后台操作的时候要切换到相应的语言对该语言添加内容和配置。\r\n语言切换', '未知', '未知', 152, 9, 2, '1308974802', '1308974802', 0, 0, 0, 0, 'htm/xwzx/qyxw/2011_0625_8.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(9, '如何安装和使用模板', '', 'img/20110625/20110625123057_thumb.gif', '', 'BEES企业网站管理系统的模板放在template目录下，如图：\r\n企业网站管理系统模板目录" />\r\n默认模板有简体中文和英文，如图：\r\n企业网站管理系统默认模板" />\r\n将模板文件放在', '未知', '未知', 374, 9, 2, '1308974802', '1354979538', 0, 0, 0, 0, 'htm/qyxw/2011_0625_9.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(10, '企业应该怎样建设企业网站', '', '', '', '1.企业网站需要灵魂\r\n伴随互联网的飞速普及，及相关建站软件的日新月异，现如今建设一个企业网站已相当容易，即使是对技术一窍不通的小白也能依靠智能软件信手拈来，所以   说，', '未知', '未知', 95, 10, 2, '1308981978', '1308981978', 0, 0, 0, 0, 'htm/xwzx/sybz/2011_0625_10.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(11, '企业网站推广的一些途径和方法', '', '', '', '一、上网站，看文章\r\n当您刚进入这个行业的时候，肯定感到很新奇、很兴奋，感觉这个行业即神秘又充满了魅力，恨不得马上做出一、两个大项目来。但是江礼坤在这里奉劝您，先把这', '未知', '未知', 305, 10, 2, '1308982015', '1308982015', 0, 0, 0, 0, 'htm/xwzx/sybz/2011_0625_11.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(12, '企业网站对公司企业的作用及其价值', '', '', '', '企业网站可以起到如下作用：\r\n宣传企业形象与品牌：企业文化往往是一个企业的灵魂。也是塑造一个企业形象与品牌的根本。通过互联网这个窗口，可以得到更好的传播与推广。\r\n增加', '未知', '未知', 339, 10, 2, '1308981985', '1308981985', 0, 0, 0, 0, 'htm/xwzx/sybz/2011_0625_12.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(13, '如何更新公司企业网站内容', '', '', '', '1、相关行业新闻，这是做为原创内容的资料来源，但必须认真修改资料内容，保证一定的原创性和新鲜感。避免简单复制。\r\n2、公司企业新闻，如果是新企业，不妨多留意公司的事情，', '未知', '未知', 460, 10, 2, '1308982006', '1308982006', 0, 0, 0, 0, 'htm/xwzx/sybz/2011_0625_13.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(14, '企业网站建设中如何做好宣传营销', '', '', '', '　　一、宣传为主，企业网站应有效提升形象\r\n　　如果一个企业没有网站，一定就失去了在互联网上参与竞争的一次机会。很多公司做的网站的伊始目的也仅仅是，通过搜索引擎可以查', '未知', '未知', 41, 10, 2, '1308981960', '1308981960', 0, 0, 0, 0, 'htm/xwzx/sybz/2011_0625_14.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	...
	(18, '跃动情怀系列头层牛皮两用包', '', 'img/20110625/20110625145753523.jpg', '', '产品内容', '未知', '未知', 221, 11, 3, '1308982002', '1308985588', 0, 0, 0, 0, 'htm/cpzx/stb/2011_0625_18.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(19, '经典牛仔系列时尚单肩包', '', 'img/20110625/201106251458052470.jpg', '', '', '未知', '未知', 314, 11, 3, '1308981998', '1308985572', 0, 0, 0, 0, 'htm/cpzx/stb/2011_0625_19.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(20, '高档牛皮男士商务电脑包', '', 'img/20110625/201106251459032990.jpg', '', '', '未知', '未知', 238, 11, 3, '1308985574', '1308985574', 0, 0, 0, 0, 'htm/cpzx/stb/2011_0625_20.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(21, '小资情调系列时尚牛皮两用包', '', 'img/20110625/201106251458118388.JPG', '', '', '未知', '未知', 17, 11, 3, '1308985618', '1308985618', 0, 0, 0, 0, 'htm/cpzx/stb/2011_0625_21.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(22, '98分贝牛皮单肩包', '', 'img/20110625/201106251458316084.jpg', '', '', '未知', '未知', 17, 11, 3, '1308985615', '1308985615', 0, 0, 0, 0, 'htm/cpzx/stb/2011_0625_22.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(23, '可爱圆桶系列头层牛皮斜挎包', '', 'img/20110625/201106251458309992.jpg', '', '产品内容', '未知', '未知', 400, 11, 3, '1308985564', '1395921828', 0, 0, 0, 0, 'htm/stb/2011_0625_23.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '包|产品', ''),
	(34, '应用案例', '', 'img/20121208/201212082353104864.jpg', '', '\r\n	\r\n\r\n	应用案例详细内容\r\n', '未知', '未知', 6, 26, 2, '1396152198', '1396152198', 0, 0, 0, 0, 'htm/yyal/2014_0330_34.html', 'cn', 0, 'http://', '', 0, 0, '30', '', 0, '', '应用案例'),
	(25, 'VMC-1060L Vertical Machining hard-wire', '', 'img/20121208/201212082345475149_thumb.jpeg', '', '\r\n	Type: Hard-wire a vertical machining center\r\n	10600 Model: VMC-1060L\r\n	Brand: Taiwan Yu-Seiki\r\n	Product precision: Positioning Accuracy &plusmn; 0.005/300mm\r\n	Control system: preparation with customer needs \r\n', '未知', '未知', 2, 19, 3, '1354979535', '1354979535', 0, 0, 0, 0, 'htm/product/2012_1208_25.html', 'en', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(26, 'VMC-1580 three-axis vertical machining hard track', '', 'img/20121208/201212082346359518_thumb.jpeg', '', '\r\n	Type: Hard-axis vertical machining center rail\r\n	1580 Model: VMC-1580\r\n	Brand: Taiwan Yu-Seiki\r\n	Product precision: Positioning Accuracy &plusmn; 0.005/300mm\r\n	Control system: preparation with customer needs \r\n', '未知', '未知', 3, 19, 3, '1354979577', '1354979577', 0, 0, 0, 0, 'htm/product/2012_1208_26.html', 'en', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(27, 'TY-45L CNC lathe', '', 'img/20121208/201212082347169606_thumb.jpeg', '', '\r\n	Name: CNC CNC lathe\r\n	Type: Inclined bed rail line\r\n	Model: TY-45L\r\n	Brand: Taiwan Yu-Seiki\r\n	Control system: preparation with customer needs\r\n', '未知', '未知', 2, 19, 3, '1354979578', '1354979578', 0, 0, 0, 0, 'htm/product/2012_1208_27.html', 'en', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(28, 'Two-tail axis automatic lathe tool', '', 'img/20121208/20121208235124_thumb.gif', '', '\r\n	Hardware for the wholesale production:such as electronics,communications,computers,machinery,lighting,(cars,motorcycles)parts ,Stationery,clocks and watches,toys,plastics and other industries axle parts stamping,riveting Nut,nuts and all ...', '未知', '未知', 2, 19, 3, '1354979571', '1354979571', 0, 0, 0, 0, 'htm/product/2012_1208_28.html', 'en', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(29, 'RSF-7 Universal Knife grinder ', '', 'img/20121208/201212082351546777_thumb.jpeg', '', '', '未知', '未知', 1, 19, 3, '1354979547', '1354979547', 0, 0, 0, 0, 'htm/product/2012_1208_29.html', 'en', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(30, 'RSF-3 Universal Knife grinder ', '', 'img/20121208/201212082352344008_thumb.jpeg', '', '', '未知', '未知', 2, 19, 3, '1354979542', '1354979542', 0, 0, 0, 0, 'htm/product/2012_1208_30.html', 'en', 0, 'http://', '', 0, 0, '30', '', 0, '', ''),
	(31, 'Tai Ming Two-tail axis automatic lathe tool', '', 'img/20121208/201212082353104864_thumb.jpeg', '', '\r\n	Taiwan&#39;s quality!!\r\n	Japan shinko tapping new clutch(patent) great torque!\r\n	spindle oil-free device!\r\n\r\n	Hardware for the wholesale production:such as electronics,communications,computers,machinery,lighting,(cars,motorcycles)parts,St...', '未知', '未知', 2, 19, 3, '1354979560', '1354979560', 0, 0, 0, 0, 'htm/product/2012_1208_31.html', 'en', 0, 'http://', '', 0, 0, '30', '', 0, '', '');
/*!40000 ALTER TABLE `bees_maintb` ENABLE KEYS */;

-- 导出  表 beescms.bees_market 结构
CREATE TABLE IF NOT EXISTS `bees_market` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_market 的数据：2 rows
DELETE FROM `bees_market`;
/*!40000 ALTER TABLE `bees_market` DISABLE KEYS */;
INSERT INTO `bees_market` (`id`, `market_name`, `market_type`, `market_num`, `market_order`, `market_is`, `lang`) VALUES
	(1, '空间域名', 1, '2429256177', '1', 1, 'cn'),
	(2, '销售客服', 1, '2429256177', '1', 1, 'en');
/*!40000 ALTER TABLE `bees_market` ENABLE KEYS */;

-- 导出  表 beescms.bees_member 结构
CREATE TABLE IF NOT EXISTS `bees_member` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_member 的数据：0 rows
DELETE FROM `bees_member`;
/*!40000 ALTER TABLE `bees_member` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_member` ENABLE KEYS */;

-- 导出  表 beescms.bees_member_group 结构
CREATE TABLE IF NOT EXISTS `bees_member_group` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_member_group 的数据：2 rows
DELETE FROM `bees_member_group`;
/*!40000 ALTER TABLE `bees_member_group` DISABLE KEYS */;
INSERT INTO `bees_member_group` (`id`, `member_group_name`, `member_group_info`, `is_disable`) VALUES
	(1, '注册会员', '注册完成的所有会员都是这个级别', 0),
	(2, 'VIP会员', '注册会员通过管理后台升级的级别', 0);
/*!40000 ALTER TABLE `bees_member_group` ENABLE KEYS */;

-- 导出  表 beescms.bees_mx_form 结构
CREATE TABLE IF NOT EXISTS `bees_mx_form` (
  `id` mediumint(8) NOT NULL,
  `form_id` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- 正在导出表  beescms.bees_mx_form 的数据：0 rows
DELETE FROM `bees_mx_form`;
/*!40000 ALTER TABLE `bees_mx_form` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_mx_form` ENABLE KEYS */;

-- 导出  表 beescms.bees_prinfo 结构
CREATE TABLE IF NOT EXISTS `bees_prinfo` (
  `id` mediumint(8) NOT NULL,
...
-- 正在导出表  beescms.bees_prinfo 的数据：0 rows
DELETE FROM `bees_prinfo`;
/*!40000 ALTER TABLE `bees_prinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_prinfo` ENABLE KEYS */;

-- 导出  表 beescms.bees_product 结构
...
-- 正在导出表  beescms.bees_product 的数据：13 rows
DELETE FROM `bees_product`;
/*!40000 ALTER TABLE `bees_product` DISABLE KEYS */;
INSERT INTO `bees_product` (`id`, `model`, `pics`, `content`) VALUES
	(18, '', '2,1', '<p>产品内容</p>'),
	(19, '', '4', ''),
	(20, '', '10,', ''),
	(21, '', '6,5,', ''),
...
-- 导出  表 beescms.bees_upfiles 结构
CREATE TABLE IF NOT EXISTS `bees_upfiles` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_upfiles 的数据：0 rows
DELETE FROM `bees_upfiles`;
/*!40000 ALTER TABLE `bees_upfiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `bees_upfiles` ENABLE KEYS */;

-- 导出  表 beescms.bees_uppics 结构
CREATE TABLE IF NOT EXISTS `bees_uppics` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  beescms.bees_uppics 的数据：23 rows
DELETE FROM `bees_uppics`;
/*!40000 ALTER TABLE `bees_uppics` DISABLE KEYS */;
INSERT INTO `bees_uppics` (`id`, `pic_name`, `pic_url`, `pic_ext`, `pic_alt`, `pic_size`, `pic_path`, `pic_time`, `pic_thumb`, `pic_cate`) VALUES
	...
	(12, '201108121414162883', '', 'gif', '', '2393', 'upload/img/20110812/', '1313129656', '', 3),
	(13, '201212082315531698', '', 'gif', '', '21154', 'upload/img/20121208/', '1354979753', 'img/20121208/201212082315531698_thumb.gif', 3),
	(14, '201212082315546094', '', 'gif', '', '38118', 'upload/img/20121208/', '1354979754', 'img/20121208/201212082315546094_thumb.gif', 3),
	(15, '201212082345475149', '', 'jpg', '', '120013', 'upload/img/20121208/', '1354981547', 'img/20121208/201212082345475149_thumb.jpeg', 1),
	(16, '201212082346359518', '', 'jpg', '', '77084', 'upload/img/20121208/', '1354981595', 'img/20121208/201212082346359518_thumb.jpeg', 1),
	(17, '201212082347169606', '', 'jpg', '', '96231', 'upload/img/20121208/', '1354981636', 'img/20121208/201212082347169606_thumb.jpeg', 1),
	(18, '20121208235116515', '', 'jpg', '', '94879', 'upload/img/20121208/', '1354981876', 'img/20121208/20121208235116515_thumb.jpeg', 1),
	(19, '20121208235121391', '', 'gif', '', '', 'upload/img/20121208/', '1354981883', '', 2),
	(20, '201212082351546777', '', 'jpg', '', '18656', 'upload/img/20121208/', '1354981914', 'img/20121208/201212082351546777_thumb.jpeg', 1),
	(21, '201212082352344008', '', 'jpg', '', '47247', 'upload/img/20121208/', '1354981954', 'img/20121208/201212082352344008_thumb.jpeg', 1),
	(22, '201212082353104864', '', 'jpg', '', '95909', 'upload/img/20121208/', '1354981990', 'img/20121208/201212082353104864_thumb.jpeg', 1),
	(23, '201212102144457490', '', 'gif', '', '4133', 'upload/img/20121210/', '1355147085', 'img/20121210/201212102144457490_thumb.gif', 3),
	(24, '201403272032188727', '', 'jpg', '', '65253', 'upload/img/', '1395923538', 'img/201403272032188727_thumb.jpeg', 3);
/*!40000 ALTER TABLE `bees_uppics` ENABLE KEYS */;

-- 导出  表 beescms.bees_uppic_cate 结构
CREATE TABLE IF NOT EXISTS `bees_uppic_cate` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `cate_name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- 正在导出表  beescms.bees_uppic_cate 的数据：3 rows
DELETE FROM `bees_uppic_cate`;
/*!40000 ALTER TABLE `bees_uppic_cate` DISABLE KEYS */;
INSERT INTO `bees_uppic_cate` (`id`, `cate_name`) VALUES
	(1, '产品图片'),
	(2, '下载图片'),
	(3, '其它图片');
/*!40000 ALTER TABLE `bees_uppic_cate` ENABLE KEYS */;

-- 导出  表 beescms.bees_webjob 结构
CREATE TABLE IF NOT EXISTS `bees_webjob` (
  `id` mediumint(8) NOT NULL,
...
-- 正在导出表  beescms.bees_webjob 的数据：0 rows
DELETE FROM `bees_webjob`;
