...
-- 导出  表 cms.jz_article 结构
CREATE TABLE IF NOT EXISTS `jz_article` (
...
-- 正在导出表  cms.jz_article 的数据：22 rows
DELETE FROM `jz_article`;
/*!40000 ALTER TABLE `jz_article` DISABLE KEYS */;
INSERT INTO `jz_article` (`id`, `title`, `tid`, `molds`, `htmlurl`, `keywords`, `description`, `seo_title`, `userid`, `litpic`, `body`, `addtime`, `orders`, `hits`, `isshow`, `comment_num`, `istop`, `ishot`, `istuijian`, `tags`, `member_id`) VALUES
	...
	(25, '极致CMS新闻测试标题', 13, 'article', 'xinwenfenleisi', '极致CMS,演示站', '极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容极致CMS新闻测试简介内容', '极致CMS新闻测试SEO标题', 1, '/static/default/assets/img/desk.jpg', '<p>极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容极致CMS测试文章内容</p><p><img src="/static/default/assets/img/scenery/image6.jpg"/></p>', 1565351871, 2, 8, 1, 0, '0', '0', '1', NULL, 0),
...
/*!40000 ALTER TABLE `jz_article` ENABLE KEYS */;

-- 导出  表 cms.jz_buylog 结构
CREATE TABLE IF NOT EXISTS `jz_buylog` (
...
-- 正在导出表  cms.jz_buylog 的数据：1 rows
DELETE FROM `jz_buylog`;
/*!40000 ALTER TABLE `jz_buylog` DISABLE KEYS */;
INSERT INTO `jz_buylog` (`id`, `userid`, `orderno`, `type`, `buytype`, `msg`, `amount`, `money`, `addtime`) VALUES
	(1, 1, 'No20210529171747', 3, 'jifen', '登录奖励', 1.00, 1.00, 1622279867);
/*!40000 ALTER TABLE `jz_buylog` ENABLE KEYS */;

-- 导出  表 cms.jz_classtype 结构
CREATE TABLE IF NOT EXISTS `jz_classtype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_classtype 的数据：14 rows
DELETE FROM `jz_classtype`;
/*!40000 ALTER TABLE `jz_classtype` DISABLE KEYS */;
INSERT INTO `jz_classtype` (`id`, `classname`, `molds`, `litpic`, `description`, `keywords`, `body`, `orders`, `isshow`, `iscover`, `pid`, `gid`, `htmlurl`, `lists_html`, `details_html`, `lists_num`, `comment_num`, `gourl`, `ishome`) VALUES
	(1, '商品', 'product', NULL, NULL, NULL, NULL, 0, 1, 0, 0, 0, 'shangpin', 'list', 'details', 9, 0, NULL, 1),
	(2, '新闻', 'article', NULL, NULL, NULL, NULL, 0, 1, 0, 0, 0, 'xinwen', 'article-list', 'article-details', 4, 0, NULL, 1),
	(3, '联系', 'article', NULL, NULL, NULL, '<p style="text-align: center;">这是后台录入的内容~</p><p style="text-align: center;">这很简单的吧？赶紧去后台试试吧！</p>', 0, 1, 0, 0, 0, 'lianxi', 'contact-us', NULL, 10, 0, NULL, 1),
	(4, '留言', 'message', NULL, NULL, NULL, NULL, 0, 1, 0, 0, 0, 'msg', 'message', NULL, 10, 0, NULL, 1),
	(5, '关于', 'article', NULL, NULL, NULL, '<p>极致建站系统是一个简单快捷高效的建站CMS，我们的宗旨是追求极致，极力为大众打造一个更好、更快、更方便的建站系统。</p><p>极致建站系统有几大核心优势：</p><p>1、官方手把手指导教学</p><p>2、自由开发，免商业授权</p><p>3、后台自由定制功能展示桌面，方便应对不同客户需求</p><p>4、用户无需自己手动配置伪静态，也支持配置各种格式的自定义链接</p><p>5、对于手机端、Ajax、接口访问数据处理非常友好</p><p>6、对数据输出的调用是完全自由公开的，即你可以在前台输出数据库里面存储的任何数据</p><p>7、自带静态数据缓存，无需更新生成静态页面也能达到静态访问效率</p><p>8、上传图片管理，缓存清理等，方便管理服务器的文件</p><p>9、具备完整的评论点评功能，用户可以在前台配置评论，点评商品</p><p>10、自带一套简单的购物流程</p><p>11、官方提供支付接口，只需简单获得官方授权，即可体验网站支付功能</p><p>12、系统开发自由度相当高，扩展方便</p>', 0, 1, 0, 0, 0, 'guanyu', 'about-us', NULL, 10, 0, NULL, 1),
	(6, '分类一', 'product', NULL, NULL, NULL, NULL, 0, 1, 1, 1, 0, 'fenleiyi', 'list', 'details', 9, 0, NULL, 1),
	(7, '分类二', 'product', NULL, NULL, NULL, NULL, 0, 1, 1, 1, 0, 'fenleier', 'list', 'details', 9, 0, NULL, 1),
	(8, '分类三', 'product', NULL, NULL, NULL, NULL, 0, 1, 1, 1, 0, 'fenleisan', 'list', 'details', 9, 0, NULL, 1),
	(9, '分类四', 'product', NULL, NULL, NULL, NULL, 0, 1, 1, 1, 0, 'fenleisi', 'list', 'details', 9, 0, NULL, 1),
	(10, '新闻分类一', 'article', NULL, NULL, NULL, NULL, 0, 1, 0, 2, 0, 'xinwenfenleiyi', 'article-list', 'article-details', 4, 0, NULL, 1),
	(11, '新闻分类二', 'article', NULL, NULL, NULL, NULL, 0, 1, 0, 2, 0, 'xinwenfenleier', 'article-list', 'article-details', 4, 0, NULL, 1),
	(12, '新闻分类三', 'article', NULL, NULL, NULL, NULL, 0, 1, 0, 2, 0, 'xinwenfenleisan', 'article-list', 'article-details', 4, 0, NULL, 1),
	(13, '新闻分类四', 'article', NULL, NULL, NULL, NULL, 0, 1, 0, 2, 0, 'xinwenfenleisi', 'article-list', 'article-details', 4, 0, NULL, 1),
	(14, '常见问题', 'article', NULL, NULL, NULL, NULL, 0, 1, 0, 0, 0, 'faq', 'faq', 'article-details', 10, 0, NULL, 1);
/*!40000 ALTER TABLE `jz_classtype` ENABLE KEYS */;

-- 导出  表 cms.jz_collect 结构
CREATE TABLE IF NOT EXISTS `jz_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_collect 的数据：3 rows
DELETE FROM `jz_collect`;
/*!40000 ALTER TABLE `jz_collect` DISABLE KEYS */;
INSERT INTO `jz_collect` (`id`, `title`, `description`, `tid`, `litpic`, `w`, `h`, `orders`, `addtime`, `isshow`, `url`) VALUES
	(1, '测试1', '测试', 1, '/static/default/assets/img/scenery/image1.jpg', '0', '0', 0, 1565353707, 1, NULL),
	(2, '测试二', NULL, 1, '/static/default/assets/img/scenery/image4.jpg', '0', '0', 0, 1565353751, 1, NULL),
	(3, '测试三', NULL, 1, '/static/default/assets/img/scenery/image6.jpg', '0', '0', 0, 1565353774, 1, NULL);
/*!40000 ALTER TABLE `jz_collect` ENABLE KEYS */;

-- 导出  表 cms.jz_collect_type 结构
CREATE TABLE IF NOT EXISTS `jz_collect_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_collect_type 的数据：0 rows
DELETE FROM `jz_collect_type`;
/*!40000 ALTER TABLE `jz_collect_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_collect_type` ENABLE KEYS */;

-- 导出  表 cms.jz_comment 结构
CREATE TABLE IF NOT EXISTS `jz_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_comment 的数据：0 rows
DELETE FROM `jz_comment`;
/*!40000 ALTER TABLE `jz_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_comment` ENABLE KEYS */;

-- 导出  表 cms.jz_fields 结构
CREATE TABLE IF NOT EXISTS `jz_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_fields 的数据：18 rows
DELETE FROM `jz_fields`;
/*!40000 ALTER TABLE `jz_fields` DISABLE KEYS */;
INSERT INTO `jz_fields` (`id`, `field`, `molds`, `fieldname`, `tips`, `fieldtype`, `tids`, `fieldlong`, `body`, `orders`, `ismust`, `isshow`, `isadmin`, `issearch`, `islist`, `format`, `vdata`) VALUES
	(1, 'url', 'links', '链接', NULL, 1, NULL, '255', NULL, 0, 1, 1, 1, 0, 1, NULL, NULL),
	(2, 'title', 'links', '链接名称', NULL, 1, NULL, '255', NULL, 0, 1, 1, 1, 1, 1, NULL, NULL),
	(3, 'email', 'message', '联系邮箱', NULL, 1, NULL, '255', NULL, 0, 0, 1, 1, 1, 1, NULL, NULL),
	(4, 'keywords', 'tags', '关键词', '尽量简短，但不能重复', 1, NULL, '50', NULL, 0, 0, 1, 1, 1, 1, NULL, NULL),
	(5, 'newname', 'tags', '替换词', '尽量简短，但不能重复，20字以内，可不填。', 1, NULL, '50', NULL, 0, 0, 1, 1, 1, 1, NULL, NULL),
	(6, 'url', 'tags', '内链', '填写详细链接，带http', 1, NULL, '255', NULL, 0, 0, 1, 1, 1, 1, NULL, NULL),
	(7, 'num', 'tags', '替换次数', '一篇文章内替换的次数，默认-1，全部替换', 4, NULL, '4', NULL, 0, 0, 1, 1, 0, 1, NULL, '-1'),
	(8, 'target', 'tags', '打开方式', NULL, 7, NULL, '50', '新窗口=_blank,本窗口=_self', 0, 0, 1, 1, 0, 1, NULL, '_blank'),
	(9, 'number', 'tags', '标签数', '无需填写，程序自动处理', 4, NULL, '11', NULL, 0, 0, 1, 1, 0, 1, NULL, '0'),
	(10, 'member_id', 'article', '发布用户', '前台会员，无需填写', 13, NULL, '11', '3,username', 0, 0, 1, 0, 0, 0, NULL, '0'),
	(11, 'member_id', 'product', '发布用户', '前台会员，无需填写', 13, NULL, '11', '3,username', 0, 0, 1, 0, 0, 0, NULL, '0'),
	(12, 'member_id', 'links', '发布用户', '前台会员，无需填写', 13, NULL, '11', '3,username', 0, 0, 1, 0, 0, 0, NULL, '0'),
	(13, 'categories', 'product', '类别', '商品类别', 7, ',1,6,7,8,9,2,10,11,12,13,3,4,5,', NULL, 'Phones=1,Laptops=2,PC=3,Tablets=4', 0, 0, 1, 1, 1, 1, NULL, NULL),
	(14, 'brands', 'product', '品牌', NULL, 7, ',1,6,7,8,9,2,10,11,12,13,3,4,5,', NULL, 'Samsung=1,Apple=2,HTC=3', 0, 0, 1, 1, 1, 1, NULL, NULL),
	(15, 'os', 'product', '操作系统', NULL, 7, ',1,6,7,8,9,2,10,11,12,13,3,4,5,', NULL, 'Android=1,iOS=2', 0, 0, 1, 1, 1, 1, NULL, NULL),
	(16, 'display', 'product', '显示屏', NULL, 1, ',1,6,7,8,9,2,10,11,12,13,3,4,5,', '10', NULL, 0, 1, 1, 1, 0, 0, NULL, NULL),
	(17, 'camera', 'product', '像素', NULL, 1, ',1,6,7,8,9,2,10,11,12,13,3,4,5,', '20', NULL, 0, 1, 1, 1, 0, 0, NULL, NULL),
	(18, 'ram', 'product', '运行内存', NULL, 1, ',1,6,7,8,9,2,10,11,12,13,3,4,5,', '20', NULL, 0, 1, 1, 1, 0, 0, NULL, NULL);
/*!40000 ALTER TABLE `jz_fields` ENABLE KEYS */;

-- 导出  表 cms.jz_hook 结构
CREATE TABLE IF NOT EXISTS `jz_hook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_hook 的数据：0 rows
DELETE FROM `jz_hook`;
/*!40000 ALTER TABLE `jz_hook` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_hook` ENABLE KEYS */;

-- 导出  表 cms.jz_layout 结构
CREATE TABLE IF NOT EXISTS `jz_layout` (
...
-- 正在导出表  cms.jz_layout 的数据：4 rows
DELETE FROM `jz_layout`;
/*!40000 ALTER TABLE `jz_layout` DISABLE KEYS */;
INSERT INTO `jz_layout` (`id`, `name`, `top_layout`, `left_layout`, `gid`, `ext`, `sys`, `isdefault`) VALUES
	(1, 'CMS系统默认', '[]', '[{"name":"网站管理","icon":"&amp;#xe699;","nav":["42","9","95","83","147","22"]},{"name":"商品管理","icon":"&amp;#xe698;","nav":["105","129","2","118","123","16","177"]},{"name":"扩展管理","icon":"&amp;#xe6ce;","nav":["76","116","141","142","143","35","61","154","153"]},{"name":"系统设置","icon":"&amp;#xe6ae;","nav":["40","54","49","70","115","114","66"]}]', 0, '系统配置，不可删除！', 1, 1),
	(2, 'CMS客户界面', '[]', '[{"name":"内容管理","icon":"&amp;#xe6fb;","nav":["9"]},{"name":"栏目管理","icon":"&amp;#xe699;","nav":["42"]},{"name":"商品管理","icon":"&amp;#xe6cb;","nav":["105"]},{"name":"订单管理","icon":"&amp;#xe722;","nav":["129"]},{"name":"会员管理","icon":"&amp;#xe6b8;","nav":["2"]},{"name":"网站留言","icon":"&amp;#xe69f;","nav":["22"]},{"name":"友情链接","icon":"&amp;#xe6f7;","nav":["95"]},{"name":"轮播图","icon":"&amp;#xe6a8;","nav":["83"]},{"name":"公众号","icon":"&amp;#xe60e;","nav":["141","142"]},{"name":"系统设置","icon":"&amp;#xe6ae;","nav":["40","35","114","116"]}]', 2, '网站管理员-客户端-按需配置', 0, 0),
	(3, 'Blog界面', '[]', '[{"name":"栏目管理","icon":"&amp;#xe699;","nav":["42"]},{"name":"文章管理","icon":"&amp;#xe6fb;","nav":["9"]},{"name":"会员管理","icon":"&amp;#xe6b8;","nav":["2","118","123"]},{"name":"轮播图","icon":"&amp;#xe6a8;","nav":["83","89"]},{"name":"评论管理","icon":"&amp;#xe69b;","nav":["16"]},{"name":"留言管理","icon":"&amp;#xe69f;","nav":["22"]},{"name":"友情链接","icon":"&amp;#xe6f7;","nav":["95"]},{"name":"系统扩展","icon":"&amp;#xe6ce;","nav":["35","70","76","116"]},{"name":"系统设置","icon":"&amp;#xe6ae;","nav":["40","115","153","154","114"]}]', 3, 'Blog用户界面，可以自定义修改，比较简洁一些', 0, 0),
	(4, '基础建站客户端', '[]', '[{"name":"栏目管理","icon":"&amp;#xe699;","nav":["42"]},{"name":"文章管理","icon":"&amp;#xe6fb;","nav":["9"]},{"name":"商品管理","icon":"&amp;#xe6cb;","nav":["105"]},{"name":"轮播图","icon":"&amp;#xe6a8;","nav":["83","89"]},{"name":"友情链接","icon":"&amp;#xe6f7;","nav":["95"]},{"name":"网站留言","icon":"&amp;#xe69f;","nav":["22"]},{"name":"系统设置","icon":"&amp;#xe6ae;","nav":["40","35","114"]}]', 0, '基础建站-没有会员-没有评论-系统设置里面高级配置需要建站人员自己隐藏！', 0, 0);
/*!40000 ALTER TABLE `jz_layout` ENABLE KEYS */;

-- 导出  表 cms.jz_level 结构
CREATE TABLE IF NOT EXISTS `jz_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_level 的数据：2 rows
DELETE FROM `jz_level`;
/*!40000 ALTER TABLE `jz_level` DISABLE KEYS */;
INSERT INTO `jz_level` (`id`, `name`, `pass`, `tel`, `gid`, `email`, `regtime`, `logintime`, `status`) VALUES
	(1, 'admin', '0acdd3e4a8a2a1f8aa3ac518313dab9d', '13600136000', 1, '123456@qq.com', 1622279810, 1622279821, 1),
	(2, 'xadmin', 'd4c53f13549606cb52e62aa755533a63', NULL, 2, NULL, 1566292722, 1570636445, 1);
/*!40000 ALTER TABLE `jz_level` ENABLE KEYS */;

-- 导出  表 cms.jz_level_group 结构
CREATE TABLE IF NOT EXISTS `jz_level_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
...
-- 正在导出表  cms.jz_links 的数据：0 rows
DELETE FROM `jz_links`;
/*!40000 ALTER TABLE `jz_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_links` ENABLE KEYS */;

-- 导出  表 cms.jz_member 结构
CREATE TABLE IF NOT EXISTS `jz_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_member 的数据：1 rows
DELETE FROM `jz_member`;
/*!40000 ALTER TABLE `jz_member` DISABLE KEYS */;
INSERT INTO `jz_member` (`id`, `username`, `openid`, `pass`, `token`, `sex`, `gid`, `litpic`, `tel`, `jifen`, `likes`, `collection`, `money`, `email`, `address`, `province`, `city`, `regtime`, `logintime`, `isshow`, `signature`, `birthday`, `follow`, `fans`, `ismsg`, `iscomment`, `iscollect`, `islikes`, `isat`, `isrechange`) VALUES
	(1, '13111111111', NULL, 'd8352149f503616de2b7beae8fe4f4c3', NULL, 0, 1, NULL, '13111111111', 1.00, NULL, NULL, 0.00, 'tpuq00g5@bccto.me', NULL, NULL, NULL, 1622279850, 1622279867, 1, NULL, NULL, NULL, 0, 1, 1, 1, 1, 1, 1);
/*!40000 ALTER TABLE `jz_member` ENABLE KEYS */;

-- 导出  表 cms.jz_member_group 结构
CREATE TABLE IF NOT EXISTS `jz_member_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_member_group 的数据：1 rows
DELETE FROM `jz_member_group`;
/*!40000 ALTER TABLE `jz_member_group` DISABLE KEYS */;
INSERT INTO `jz_member_group` (`id`, `name`, `description`, `paction`, `pid`, `isagree`, `iscomment`, `ischeckmsg`, `addtime`, `orders`, `discount`, `discount_type`) VALUES
	(1, '注册会员', '前台会员分组，最低等级分组', ',Message,Comment,User,Order,Home,Common,', 0, 1, 1, 1, 0, 0, 0.00, 0);
/*!40000 ALTER TABLE `jz_member_group` ENABLE KEYS */;

-- 导出  表 cms.jz_message 结构
CREATE TABLE IF NOT EXISTS `jz_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `userid` int(11) NOT NULL DEFAULT '0',
...
-- 正在导出表  cms.jz_message 的数据：0 rows
DELETE FROM `jz_message`;
/*!40000 ALTER TABLE `jz_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_message` ENABLE KEYS */;

-- 导出  表 cms.jz_molds 结构
CREATE TABLE IF NOT EXISTS `jz_molds` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
...
-- 正在导出表  cms.jz_molds 的数据：13 rows
DELETE FROM `jz_molds`;
/*!40000 ALTER TABLE `jz_molds` DISABLE KEYS */;
INSERT INTO `jz_molds` (`id`, `name`, `biaoshi`, `sys`, `isopen`, `isclasstype`) VALUES
	(1, '内容', 'article', 1, 1, 1),
	(2, '栏目', 'classtype', 1, 1, 1),
	(3, '会员', 'member', 1, 1, 1),
	(4, '订单', 'orders', 1, 1, 1),
	(5, '商品', 'product', 1, 1, 1),
	(6, '会员分组', 'member_group', 1, 1, 1),
	(7, '评论', 'comment', 1, 1, 1),
	(8, '留言', 'message', 1, 1, 1),
	(9, '轮播图', 'collect', 1, 1, 1),
	(10, '友情链接', 'links', 0, 1, 0),
	...
	(12, 'TAG', 'tags', 0, 1, 1),
	(13, '单页', 'page', 1, 1, 1);
/*!40000 ALTER TABLE `jz_molds` ENABLE KEYS */;

-- 导出  表 cms.jz_orders 结构
...
-- 正在导出表  cms.jz_orders 的数据：0 rows
DELETE FROM `jz_orders`;
/*!40000 ALTER TABLE `jz_orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_orders` ENABLE KEYS */;

-- 导出  表 cms.jz_pictures 结构
CREATE TABLE IF NOT EXISTS `jz_pictures` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tid` int(11) NOT NULL DEFAULT '0',
  `aid` int(11) NOT NULL DEFAULT '0',
  `molds` varchar(50) DEFAULT NULL,
  ...
  `userid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='图片集';

-- 正在导出表  cms.jz_pictures 的数据：1 rows
DELETE FROM `jz_pictures`;
/*!40000 ALTER TABLE `jz_pictures` DISABLE KEYS */;
INSERT INTO `jz_pictures` (`id`, `tid`, `aid`, `molds`, `path`, `filetype`, `size`, `litpic`, `addtime`, `userid`) VALUES
	(1, 2, 0, 'article', 'Home', NULL, '0.14', '/Public/Home/202105292009.php', 1622279969, 1);
/*!40000 ALTER TABLE `jz_pictures` ENABLE KEYS */;

-- 导出  表 cms.jz_plugins 结构
...
-- 正在导出表  cms.jz_plugins 的数据：0 rows
DELETE FROM `jz_plugins`;
/*!40000 ALTER TABLE `jz_plugins` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_plugins` ENABLE KEYS */;

-- 导出  表 cms.jz_power 结构
CREATE TABLE IF NOT EXISTS `jz_power` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_power 的数据：76 rows
DELETE FROM `jz_power`;
/*!40000 ALTER TABLE `jz_power` DISABLE KEYS */;
INSERT INTO `jz_power` (`id`, `action`, `name`, `pid`, `isagree`) VALUES
	(1, 'Common', '公共权限', 0, 1),
	(2, 'Home', '前台网站', 0, 1),
	(3, 'User', '个人中心', 0, 1),
	(4, 'Login', '会员登录', 0, 1),
	...
	(11, 'Tags', 'TAG标签', 0, 1),
	(12, 'Wechat', '微信模块', 0, 1),
	(13, 'Common/vercode', '验证码生成', 1, 1),
	(14, 'Common/checklogin', '检查是否登录', 1, 1),
	(15, 'Common/multiuploads', '多附件上传', 1, 1),
	(16, 'Common/uploads', '单附件上传', 1, 1),
	(17, 'Common/qrcode', '二维码生成', 1, 1),
	(18, 'Common/get_fields', '获取扩展信息', 1, 1),
	(19, 'Common/jizhi', '链接错误提示', 1, 1),
	(20, 'Common/error', '报错提示', 1, 1),
	(21, 'Home/index', '网站首页', 2, 1),
	(22, 'Home/jizhi', '网站内容', 2, 1),
	(23, 'Home/auto_url', '自定义链接', 2, 1),
	(24, 'Home/jizhi_details', '详情内容', 2, 1),
	(25, 'Home/search', '网站搜索', 2, 1),
	(26, 'Home/searchAll', '网站多模块搜索', 2, 1),
	(27, 'Home/start_cache', '开启网站缓存', 2, 1),
	(28, 'Home/end_cache', '输出缓存', 2, 1),
	(29, 'User/checklogin', '检查是否登录', 3, 1),
	(30, 'User/index', '个人中心首页', 3, 1),
	(31, 'User/userinfo', '会员资料', 3, 1),
	(32, 'User/orders', '订单记录', 3, 1),
	(33, 'User/orderdetails', '订单详情', 3, 1),
	(34, 'User/payment', '订单支付', 3, 1),
	(35, 'User/orderdel', '删除订单', 3, 1),
	(36, 'User/changeimg', '上传头像', 3, 1),
	(37, 'User/comment', '评论列表', 3, 1),
	(38, 'User/commentdel', '删除评论', 3, 1),
	(39, 'User/likesAction', '点赞文章', 3, 1),
	(40, 'User/likes', '点赞列表', 3, 1),
	(41, 'User/likesdel', '取消点赞', 3, 1),
	(42, 'User/collectAction', '收藏文章', 3, 1),
	(43, 'User/collect', '收藏列表', 3, 1),
	(44, 'User/collectdel', '删除收藏', 3, 1),
	(45, 'User/cart', '购物车', 3, 1),
	(46, 'User/addcart', '添加购物车', 3, 1),
	(47, 'User/delcart', '删除购物车', 3, 1),
	(48, 'User/posts', '发布管理', 3, 1),
	(49, 'User/release', '会员发布', 3, 1),
	(50, 'User/del', '删除发布', 3, 1),
	(51, 'User/uploads', '会员上传附件', 3, 1),
	(52, 'User/jizhi', '404提示', 3, 1),
	(53, 'User/follow', '关注用户', 3, 1),
	(54, 'User/nofollow', '取消关注', 3, 1),
	(55, 'User/fans', '粉丝列表', 3, 1),
	(56, 'User/notify', '消息提醒', 3, 1),
	(57, 'User/notifyto', '查看消息', 3, 1),
	(58, 'User/notifydel', '删除消息', 3, 1),
	(59, 'User/active', '公共主页', 3, 1),
	(60, 'User/setmsg', '消息提醒设置', 3, 1),
	(61, 'User/getclass', '获取栏目列表', 2, 1),
	(62, 'User/wallet', '用户钱包', 3, 1),
	(63, 'User/buy', '会员充值', 3, 1),
	(64, 'User/buylist', '充值列表', 3, 1),
	(65, 'User/buydetails', '交易详情', 3, 1),
	(66, 'Login/index', '登录首页', 4, 1),
	(67, 'Login/register', '注册页面', 4, 1),
	(68, 'Login/forget', '忘记密码', 4, 1),
	(69, 'Login/nologin', '未登录页面', 4, 1),
	(70, 'Login/loginout', '退出登录', 4, 1),
	(71, 'Message/index', '发送留言', 5, 1),
	(72, 'Comment/index', '发表评论', 6, 1),
	(73, 'Screen/index', '筛选列表', 7, 1),
	(74, 'Order/create', '创建订单', 8, 1),
	(75, 'Order/pay', '订单支付', 8, 1),
	(76, 'Tags/index', 'TAG标签列表', 11, 1);
/*!40000 ALTER TABLE `jz_power` ENABLE KEYS */;

-- 导出  表 cms.jz_product 结构
...
-- 正在导出表  cms.jz_product 的数据：23 rows
DELETE FROM `jz_product`;
/*!40000 ALTER TABLE `jz_product` DISABLE KEYS */;
INSERT INTO `jz_product` (`id`, `title`, `seo_title`, `tid`, `hits`, `htmlurl`, `keywords`, `description`, `litpic`, `stock_num`, `price`, `pictures`, `isshow`, `comment_num`, `body`, `userid`, `orders`, `addtime`, `istop`, `ishot`, `istuijian`, `tags`, `member_id`, `categories`, `brands`, `os`, `display`, `camera`, `ram`) VALUES
	...
	(10, '极致商品模块测试DEMO', '极致商品模块测试DEMO', 6, 5, 'fenleiyi', '极致商品模块', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec augue nunc, pretium at augue at, convallis pellentesque ipsum. Vestibulum diam risus, sagittis at fringilla at, pulvinar vel risus. Vestibulum dignissim eu nulla eu imperdiet. Morbi mollis tel', '/static/default/assets/img/tech/image2.jpg', 50, 0.01, '/Public/Admin/201908114507.jpg||/Public/Admin/201908114507.jpg||/Public/Admin/201908114507.jpg', 1, 0, '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p><div class="row"><div class="col-md-5"><figure class="figure"><img class="img-fluid figure-img" src="/static/default/assets/img/tech/image3.png"/></figure></div><div class="col-md-7"><h4>Lorem Ipsum</h4><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p></div></div><div class="row"><div class="col-md-7 right"><h4>Lorem Ipsum</h4><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna, dignissim nec auctor in, mattis vitae leo. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p></div><div class="col-md-5"><figure class="figure"><img class="img-fluid figure-img" src="/static/default/assets/img/tech/image3.png"/></figure></div></div>', 1, 0, 1565359153, '0', '0', '0', NULL, 0, '1', '1', '1', '5.2寸', '12MP', '4GB'),
...
/*!40000 ALTER TABLE `jz_product` ENABLE KEYS */;

-- 导出  表 cms.jz_ruler 结构
CREATE TABLE IF NOT EXISTS `jz_ruler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
...
-- 正在导出表  cms.jz_ruler 的数据：178 rows
DELETE FROM `jz_ruler`;
/*!40000 ALTER TABLE `jz_ruler` DISABLE KEYS */;
INSERT INTO `jz_ruler` (`id`, `name`, `fc`, `pid`, `isdesktop`, `sys`) VALUES
	(1, '会员管理', 'Member', 0, 0, 1),
	(2, '会员列表', 'Member/index', 1, 1, 1),
	(3, '添加会员', 'Member/memberadd', 1, 0, 1),
	(4, '修改会员', 'Member/memberedit', 1, 0, 1),
	(5, '删除会员', 'Member/member_del', 1, 0, 1),
	(6, '批量删除', 'Member/deleteAll', 1, 0, 1),
	(7, '修改状态', 'Member/change_status', 1, 0, 1),
	(8, '内容管理', 'Article', 0, 0, 1),
	(9, '内容列表', 'Article/articlelist', 8, 1, 1),
	(10, '添加内容', 'Article/addarticle', 8, 0, 1),
	(11, '修改内容', 'Article/editarticle', 8, 0, 1),
	(12, '删除内容', 'Article/deletearticle', 8, 0, 1),
	(13, '批量删除', 'Article/deleteAll', 8, 0, 1),
	(14, '复制内容', 'Article/copyarticle', 8, 0, 1),
	(15, '评论管理', 'Comment', 0, 0, 1),
	(16, '评论列表', 'Comment/commentlist', 15, 1, 1),
	(17, '添加评论', 'Comment/addcomment', 15, 0, 1),
	(18, '修改评论', 'Comment/editcomment', 15, 0, 1),
	(19, '删除评论', 'Comment/deletecomment', 15, 0, 1),
	(20, '批量删除', 'Comment/deleteAll', 15, 0, 1),
	(21, '留言管理', 'Message', 0, 0, 1),
	(22, '留言列表', 'Message/messagelist', 21, 1, 1),
	(23, '修改留言', 'Message/editmessage', 21, 0, 1),
	(24, '删除留言', 'Message/deletemessage', 21, 0, 1),
	(25, '批量删除', 'Message/deleteAll', 21, 0, 1),
	(26, '字段管理', 'Fields', 0, 0, 1),
	(27, '字段列表', 'Fields/index', 26, 1, 1),
	(28, '新增字段', 'Fields/addFields', 26, 0, 1),
	(29, '修改字段', 'Fields/editFields', 26, 0, 1),
	(30, '删除字段', 'Fields/deleteFields', 26, 0, 1),
	(31, '获取字段列表', 'Fields/get_fields', 26, 0, 1),
	(32, '基本功能', 'Index', 0, 0, 1),
	(33, '系统界面', 'Index/index', 32, 0, 1),
	(34, '后台首页', 'Index/welcome', 32, 1, 1),
	(35, '数据库列表', 'Index/beifen', 32, 1, 1),
	(36, '数据库备份', 'Index/backup', 32, 0, 1),
	(37, '数据库还原', 'Index/huanyuan', 32, 0, 1),
	(38, '数据库删除', 'Index/shanchu', 32, 0, 1),
	(39, '系统设置', 'Sys', 0, 0, 1),
	(40, '基本设置', 'Sys/index', 39, 1, 1),
	(41, '栏目管理', 'Classtype', 0, 0, 1),
	(42, '栏目列表', 'Classtype/index', 41, 1, 1),
	(43, '新增栏目', 'Classtype/addclass', 41, 0, 1),
	(44, '修改栏目', 'Classtype/editclass', 41, 0, 1),
	(45, '删除栏目', 'Classtype/deleteclass', 41, 0, 1),
	(46, '修改排序', 'Classtype/editClassOrders', 41, 0, 1),
	(47, '栏目隐藏', 'Classtype/change_status', 41, 0, 1),
	(48, '管理员管理', 'Admin', 0, 0, 1),
	(49, '角色管理', 'Admin/group', 48, 1, 1),
	(50, '新增角色', 'Admin/groupadd', 48, 0, 1),
	(51, '修改角色', 'Admin/groupedit', 48, 0, 1),
	(52, '删除角色', 'Admin/group_del', 48, 0, 1),
	(53, '角色状态', 'Admin/change_group_status', 48, 0, 1),
	(54, '管理员列表', 'Admin/adminlist', 48, 1, 1),
	(55, '新增管理员', 'Admin/adminadd', 48, 0, 1),
	(56, '修改管理员', 'Admin/adminedit', 48, 0, 1),
	(57, '管理员状态', 'Admin/change_status', 48, 0, 1),
	(58, '删除管理员', 'Admin/admindelete', 48, 0, 1),
	(59, '个人信息', 'Index/details', 32, 1, 1),
	(60, '模块管理', 'Molds', 0, 0, 1),
	(61, '模块列表', 'Molds/index', 60, 1, 1),
	(62, '新增模块', 'Molds/addMolds', 60, 0, 1),
	(63, '修改模块', 'Molds/editMolds', 60, 0, 1),
	(64, '删除模块', 'Molds/deleteMolds', 60, 0, 1),
	(65, '权限管理', 'Rulers', 0, 0, 1),
	(66, '权限列表', 'Rulers/index', 65, 1, 1),
	(67, '新增权限', 'Rulers/addrulers', 65, 0, 1),
	(68, '修改权限', 'Rulers/editrulers', 65, 0, 1),
	(69, '删除权限', 'Rulers/deleterulers', 65, 0, 1),
	(70, '桌面设置', 'Index/desktop', 32, 1, 1),
	(71, '新增桌面', 'Index/desktop_add', 32, 0, 1),
	(72, '修改桌面', 'Index/desktop_edit', 32, 0, 1),
	(73, '删除桌面', 'Index/desktop_del', 32, 0, 1),
	(74, '图标库', 'Index/unicode', 32, 1, 1),
	(75, '插件管理', 'Plugins', 0, 0, 1),
	(76, '插件列表', 'Plugins/index', 75, 1, 1),
	(77, '模块扩展', 'Extmolds', 0, 0, 1),
	(82, '轮播图', 'Collect', 0, 0, 1),
	(83, '轮播图列表', 'Collect/index', 82, 1, 1),
	(84, '新增轮播图', 'Collect/addcollect', 82, 0, 1),
	(85, '修改轮播图', 'Collect/editcollect', 82, 0, 1),
	(86, '删除轮播图', 'Collect/deletecollect', 82, 0, 1),
	(87, '复制轮播图', 'Collect/copycollect', 82, 0, 1),
	(88, '批量删除轮播图', 'Collect/deleteAll', 82, 0, 1),
	(89, '轮播图分类列表', 'Collect/collectType', 82, 1, 1),
	(90, '新增轮播图分类', 'Collect/collectTypeAdd', 82, 0, 1),
	(91, '修改轮播图分类', 'Collect/collectTypeEdit', 82, 0, 1),
	(92, '删除轮播图分类', 'Collect/collectTypeDelete', 82, 0, 1),
	(93, '批量复制', 'Article/copyAll', 8, 0, 1),
	(94, '批量修改栏目', 'Article/changeType', 8, 0, 1),
	(95, '友情链接列表', 'Extmolds/index/molds/links', 77, 1, 0),
	(96, '新增友情链接', 'Extmolds/addmolds/molds/links', 77, 0, 0),
	(97, '修改友情链接', 'Extmolds/editmolds/molds/links', 77, 0, 0),
	(98, '复制友情链接', 'Extmolds/copymolds/molds/links', 77, 0, 0),
	(99, '删除友情链接', 'Extmolds/deletemolds/molds/links', 77, 0, 0),
	(100, '批量删除友情链接', 'Extmolds/deleteAll/molds/links', 77, 0, 0),
	(101, '通用模块', 'Common', 0, 0, 1),
	(102, '上传文件', 'Common/uploads', 101, 0, 1),
	(103, '更新cookie', 'Index/update_session_maxlifetime', 32, 0, 1),
	(104, '商品管理', 'Product', 0, 0, 1),
	(105, '商品列表', 'Product/productlist', 104, 1, 1),
	(106, '新增商品', 'Product/addproduct', 104, 0, 1),
	(107, '修改商品', 'Product/editproduct', 104, 0, 1),
	(108, '删除商品', 'Product/deleteproduct', 104, 0, 1),
	(109, '复制商品', 'Product/copyproduct', 104, 0, 1),
	(110, '批量删除', 'Product/deleteAll', 104, 0, 1),
	(111, '批量复制', 'Product/copyAll', 104, 0, 1),
	(112, '修改栏目', 'Product/changeType', 104, 0, 1),
	(113, '修改排序', 'Product/editProductOrders', 104, 0, 1),
	(114, '清理缓存', 'Index/cleanCache', 32, 1, 1),
	(115, '登录日志', 'Sys/loginlog', 39, 1, 1),
	(116, '图库管理', 'Sys/pictures', 39, 1, 1),
	(117, '修改排序', 'Extmolds/editOrders', 77, 0, 1),
	(118, '会员分组', 'Member/membergroup', 1, 1, 1),
	(119, '新增分组', 'Member/groupadd', 1, 0, 1),
	(120, '修改分组', 'Member/groupedit', 1, 0, 1),
	(121, '更改分组状态', 'Member/change_group_status', 1, 0, 1),
	(122, '删除分组', 'Member/group_del', 1, 0, 1),
	(123, '会员权限', 'Member/power', 1, 1, 1),
	(124, '添加权限', 'Member/addrulers', 1, 0, 1),
	(125, '修改权限', 'Member/editrulers', 1, 0, 1),
	(126, '删除权限', 'Member/deleterulers', 1, 0, 1),
	(127, '修改分组排序', 'Member/editOrders', 1, 0, 1),
	(128, '订单管理', 'Order', 0, 0, 1),
	(129, '订单列表', 'Order/index', 128, 1, 1),
	(130, '订单详情', 'Order/details', 128, 0, 1),
	(131, '批量删除', 'Order/deleteAll', 128, 0, 1),
	(132, '上传支付证书', 'Sys/uploadcert', 39, 0, 1),
	(133, '更改状态', 'Plugins/change_status', 75, 0, 1),
	(134, '安装卸载', 'Plugins/action_do', 75, 0, 1),
	(135, '复制转移文件', 'Plugins/file2dir', 75, 0, 1),
	(136, '移动文件夹', 'Plugins/recurse_copy', 75, 0, 1),
	(137, '删除图库图片', 'Sys/deletePic', 39, 0, 1),
	(138, '批量删除图库', 'Sys/deletePicAll', 39, 0, 1),
	(139, '安装说明', 'Plugins/desc', 75, 0, 1),
	(140, '微信公众号', 'Wechat', 0, 0, 1),
	(141, '公众号菜单', 'Wechat/wxcaidan', 140, 1, 1),
	(142, '公众号素材', 'Wechat/sucai', 140, 1, 1),
	(143, '模板制作手册', 'Index/showlabel', 32, 1, 1),
	(144, '获取首字母拼音', 'Classtype/get_pinyin', 41, 0, 1),
	(145, '批量新增栏目', 'Classtype/addmany', 41, 0, 1),
	(146, '自定义配置删除', 'Sys/custom_del', 39, 0, 1),
	(147, 'TAG列表', 'Extmolds/index/molds/tags', 77, 1, 0),
	(148, '新增TAG', 'Extmolds/addmolds/molds/tags', 77, 0, 0),
	(149, '修改TAG', 'Extmolds/editmolds/molds/tags', 77, 0, 0),
	(150, '复制TAG', 'Extmolds/copymolds/molds/tags', 77, 0, 0),
	(151, '删除TAG', 'Extmolds/deletemolds/molds/tags', 77, 0, 0),
	(152, '批量删除TAG', 'Extmolds/deleteAll/molds/tags', 77, 0, 0),
	(153, '网站地图', 'Index/sitemap', 32, 1, 1),
	(154, '生成静态文件', 'Index/tohtml', 32, 1, 1),
	(155, '更新栏目HTML', 'Index/html_classtype', 32, 0, 1),
	(156, '更新模块HTML', 'Index/html_molds', 32, 0, 1),
	(157, '批量修改推荐属性', 'Article/changeAttribute', 8, 0, 1),
	(158, '批量修改推荐属性', 'Product/changeAttribute', 104, 0, 1),
	(159, '批量修改友情链接栏目', 'Extmolds/changeType/molds/links', 77, 0, 0),
	(160, '批量修改TAG栏目', 'Extmolds/changeType/molds/tags', 77, 0, 0),
	(161, '批量复制友情链接', 'Extmolds/copyAll/molds/links', 77, 0, 0),
	(162, '批量复制TAG', 'Extmolds/copyAll/molds/tags', 77, 0, 0),
	(163, '批量修改友情链接排序', 'Extmolds/editOrders/molds/links', 77, 0, 0),
	(164, '批量修改TAG排序', 'Extmolds/editOrders/molds/tags', 77, 0, 0),
	(165, '删除订单', 'Order/deleteorder', 128, 0, 1),
	(166, '批量删除', 'Admin/deleteAll', 48, 0, 1),
	(167, '高级设置', 'Sys/high-level', 39, 0, 1),
	(168, '邮箱订单', 'Sys/email-order', 39, 0, 1),
	(169, '支付配置', 'Sys/payconfig', 39, 0, 1),
	(170, '公众号配置', 'Sys/wechatbind', 39, 0, 1),
	(171, '批量审核', 'Article/checkAll', 8, 0, 1),
	(172, '批量审核', 'Product/checkAll', 104, 0, 1),
	(173, '批量审核', 'Message/checkAll', 21, 0, 1),
	(174, '批量审核', 'Comment/checkAll', 15, 0, 1),
	(175, '批量审核友情链接', 'Extmolds/checkAll/molds/links', 77, 0, 0),
	(176, '批量审核TAG', 'Extmolds/checkAll/molds/tags', 77, 0, 0),
	(177, '充值列表', 'Order/czlist', 128, 1, 1),
	(178, '手动充值', 'Order/chongzhi', 128, 0, 1),
	(179, '删除记录', 'Order/delbuylog', 128, 0, 1),
	(180, '批量删除记录', 'Order/delAllbuylog', 128, 0, 1),
	(181, '积分配置', 'Sys/jifenset', 39, 0, 1),
	(182, '插件更新', 'Plugins/update', 75, 0, 1);
/*!40000 ALTER TABLE `jz_ruler` ENABLE KEYS */;

-- 导出  表 cms.jz_sysconfig 结构
CREATE TABLE IF NOT EXISTS `jz_sysconfig` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_sysconfig 的数据：96 rows
DELETE FROM `jz_sysconfig`;
/*!40000 ALTER TABLE `jz_sysconfig` DISABLE KEYS */;
INSERT INTO `jz_sysconfig` (`id`, `field`, `title`, `tip`, `type`, `data`) VALUES
	(1, 'web_version', '系统版号', NULL, 0, '1.6.4'),
	(2, 'web_name', '网站SEO名称', NULL, 0, 'CMS建站系统'),
	(3, 'web_keyword', '网站SEO关键词', NULL, 0, '极致CMS'),
	(4, 'web_desc', '网站SEO描述', NULL, 0, '极致CMS'),
	(5, 'web_js', '统计代码', NULL, 0, NULL),
	(6, 'web_copyright', '底部版权', NULL, 0, '@2019-2099'),
	(7, 'web_beian', '备案号', NULL, 0, '冀ICP备18036869号'),
	(8, 'web_tel', '公司电话', NULL, 0, '0316-2222616'),
	(9, 'web_tel_400', '400电话', NULL, 0, '400-0000-000'),
	(10, 'web_qq', '公司QQ', NULL, 0, '12345678'),
	(11, 'web_email', '公司邮箱', NULL, 0, '123456@qq.com'),
	(12, 'web_address', '公司地址', NULL, 0, '河北省廊坊市广阳区凯创大厦第1幢2单元1606号'),
	(13, 'pc_template', 'PC端模板', NULL, 0, 'default'),
	(14, 'wap_template', 'WAP端模板', NULL, 0, 'wap'),
	(15, 'weixin_template', '微信端模板', NULL, 0, NULL),
	(16, 'iswap', '是否开启WAP端', NULL, 0, '0'),
	(17, 'isopenhomeupload', '是否开启前台上传', NULL, 0, '1'),
	(18, 'isopenhomepower', '是否开启前台权限', NULL, 0, '0'),
	(19, 'cache_time', '缓存时间', NULL, 0, '0'),
	(20, 'fileSize', '限制上传文件大小', NULL, 0, '0'),
	(21, 'fileType', '允许上传文件类型', NULL, 0, 'pdf|jpg|jpeg|png|zip|rar|gzip|doc|docx'),
	(22, 'ueditor_config', 'UEditor编辑器导航条配置', NULL, 0, '&#039;undo&#039;, &#039;redo&#039;, &#039;|&#039;,\n&#039;paragraph&#039;,\n&#039;bold&#039;, &#039;italic&#039;, &#039;blockquote&#039;, &#039;insertparagraph&#039;, \n&#039;justifyleft&#039;, &#039;justifycenter&#039;, &#039;justifyright&#039;,&#039;justifyjustify&#039;,&#039;|&#039;,\n&#039;indent&#039;, &#039;insertorderedlist&#039;, &#039;insertunorderedlist&#039;,&#039;|&#039;, \n&#039;insertimage&#039;, &#039;insertframe&#039;,\n&#039;link&#039;,\n&#039;inserttable&#039;, &#039;deletetable&#039;, &#039;insertparagraphbeforetable&#039;, &#039;insertrow&#039;, &#039;deleterow&#039;, &#039;insertcol&#039;, &#039;deletecol&#039;,\n&#039;mergecells&#039;, &#039;mergeright&#039;, &#039;mergedown&#039;, &#039;splittocells&#039;, &#039;splittorows&#039;, &#039;splittocols&#039;, &#039;|&#039;,\n&#039;drafts&#039;, &#039;|&#039;,,&#039;source&#039;,&#039;fullscreen&#039;,'),
	(23, 'search_table', '允许前台搜索的表', NULL, 0, 'article|product'),
	(24, 'imagequlity', '上传图片压缩比例', NULL, 0, '75'),
	(25, 'ispngcompress', 'PNG是否压缩', NULL, 0, '0'),
	(26, 'email_server', '邮件服务器', NULL, 0, 'smtp.163.com'),
	(27, 'email_port', '收发端口', NULL, 0, '465'),
	(28, 'shou_email', '收件人Email地址', NULL, 0, '2581047041@qq.com'),
	(29, 'send_email', '发件人Email地址', NULL, 0, 'ttuuffuu@163.com'),
	(30, 'send_pass', '发件人Email秘钥', NULL, 0, 'tu123456'),
	(31, 'send_name', '发件人昵称', NULL, 0, '极致建站系统'),
	(32, 'tj_msg', '客户订单通知', NULL, 0, '尊敬的{xxx}，我们已经收到您的订单！请留意您的电子邮件以获得最新消息，谢谢您！'),
	(33, 'send_msg', '订单出货通知', NULL, 0, '尊敬的{xxx}，我们已确认了您的订单，请于3日内汇款，逾期恕不保留，不便请见谅。汇款完成后，烦请告知客服人员您的交易账号后五位，即完成下单手续，谢谢您。'),
	(34, 'yunfei', '订单运费', NULL, 0, '0.00'),
	(35, 'paytype', '支付方式', '0关闭支付，1极致支付，2自主平台支付', 0, '0'),
	(36, 'jizhi_pay_url', '极致平台接口', NULL, 0, NULL),
	(37, 'jizhi_mchid', '极致平台商户', NULL, 0, NULL),
	(38, 'jizhi_appid', '极致平台应用appid', NULL, 0, NULL),
	(39, 'jizhi_key', '极致平台应用秘钥', NULL, 0, NULL),
	(40, 'alipay_partner', '自主平台支付宝合作者', NULL, 0, NULL),
	(41, 'alipay_key', '自主平台支付宝key', NULL, 0, NULL),
	(42, 'alipay_private_key', '自主平台支付宝私钥', NULL, 0, NULL),
	(43, 'alipay_public_key', '自主平台支付宝公钥', NULL, 0, NULL),
	(44, 'wx_mchid', '自主平台微信商户mchid', '支付相关', 0, NULL),
	(45, 'wx_key', '自主平台微信商户key', '支付相关', 0, NULL),
	(46, 'wx_appid', '自主平台微信公众号appid', '支付相关', 0, NULL),
	(47, 'wx_appsecret', '自主平台公众号appsecret', '支付相关', 0, NULL),
	(48, 'wx_client_cert', '自主平台微信apiclient_cert', '支付相关', 0, NULL),
	(49, 'wx_client_key', '自主平台微信apiclient_key', '支付相关', 0, NULL),
	(50, 'wx_login_appid', '公众号appid', '用户登录相关，如果跟支付的一样，那就再填写一遍', 0, NULL),
	(51, 'wx_login_appsecret', '公众号appsecret', '用户登录相关，如果跟支付的一样，那就再填写一遍', 0, NULL),
	(52, 'wx_login_token', '公众号token', '用户登录相关，如果跟支付的一样，那就再填写一遍', 0, NULL),
	(53, 'huanying', '公众号关注欢迎语', '公众号关注时发送的第一句推送', 0, '欢迎关注公众号~'),
	(54, 'wx_token', '自主平台微信token', '支付相关', 0, NULL),
	(55, 'jz_55', '测试ABC', NULL, 1, NULL),
	(56, 'admintpl', '后台模板风格', '默认tpl,原始风格default', 0, 'tpl'),
	(58, 'isopenwebsite', '是否绑定多域名', '开启绑定多域名后，需要到插件中配置', 0, '1'),
	(59, 'domain', '网站网址', '全局网址,最后不带/（斜杠）', 0, NULL),
	(60, 'isrelative', '基本信息下扩展', '新增字段是否显示在【基本信息】底部，默认在【扩展信息】下', 0, '0'),
	(61, 'overtime', '订单超时', '按小时计算，超过该小时订单过期，仅限于开启支付后，0代表不限制', 0, '4'),
	(62, 'islevelurl', '开启层级URL', '默认关闭层级URL，开启后URL会按照父类层级展现', 0, '0'),
	(63, 'iscachepage', '缓存完整页面', '前台完整页面缓存，结合缓存时间，可以提高访问速度', 0, '1'),
	(64, 'isautohtml', '自动生成静态HTML', '前台访问网站页面，将自动生成静态HTML，下次访问直接进入静态HTML页面', 0, '0'),
	(65, 'pc_html', 'PC静态文件目录', '电脑端静态HTML存放目录，默认根目录[ / ]', 0, '/'),
	(66, 'mobile_html', 'WAP静态文件目录', '手机端静态HTML存放目录，默认[ m ]，PC和WAP静态目录不能相同，否则文件会混乱', 0, 'm'),
	(67, 'autocheckmessage', '是否留言自动审核', '开启后，留言自动审核（显示）', 0, '0'),
	(68, 'autocheckcomment', '是否评论自动审核', '开启后评论自动审核（显示）', 0, '0'),
	(69, 'mingan', '网站敏感词过滤', '将敏感词放到里面，用“,”分隔，用{xxx}代替通配内容', 0, '最,最佳,最具,最爱,最赚,最优,最优秀,最大,最大程度,最高,最高级,最高端,最奢侈,最低,最低级,最低价,最底,最便宜,史上最低价,最流行,最受欢迎,最时尚,最聚拢,最符合,最舒适,最先,最先进,最先进科学,最后,最新,最新技术,最新科学,第一,中国第一,全网第一,销量第一,排名第一,唯一,第一品牌,NO.1,TOP1,独一无二,全国第一,遗留,一天,仅此一次,仅此一款,最后一波,全国{xxx}大品牌之一,销冠,国家级,国际级,世界级,千万级,百万级,星级,5A,甲级,超甲级,顶级,顶尖,尖端,顶级享受,高级,极品,极佳,绝佳,绝对,终极,极致,致极,极具,完美,绝佳,极佳,至,至尊,至臻,臻品,臻致,臻席,压轴,问鼎,空前,绝后,绝版,无双,非此莫属,巅峰,前所未有,无人能及,顶级,鼎级,鼎冠,定鼎,完美,翘楚之作,不可再生,不可复制,绝无仅有,寸土寸金,淋漓尽致,无与伦比,唯一,卓越,卓著,稀缺,前无古人后无来者,绝版,珍稀,臻稀,稀少,绝无仅有,绝不在有,稀世珍宝,千金难求,世所罕见,不可多得,空前绝后,寥寥无几,屈指可数,独家,独创,独据,开发者,缔造者,创始者,发明者,首个,首选,独家,首发,首席,首府,首选,首屈一指,全国首家,国家领导人,国门,国宅,首次,填补国内空白,国际品质,黄金旺铺,黄金价值,黄金地段,金钱,金融汇币图片,外国货币,金牌,名牌,王牌,领先上市,巨星,著名,掌门人,至尊,冠军,王之王,王者楼王,墅王,皇家,世界领先,遥遥领先,领导者,领袖,引领,创领,领航,耀领,史无前例,前无古人,永久,万能,百分之百,特供,专供,专家推荐,国家{xxx}领导人推荐'),
	(70, 'iswatermark', '是否开启水印', '开启水印需要上传水印图片', 0, '0'),
	(71, 'watermark_file', '水印图片', '水印图片在250px以内', 0, NULL),
	(72, 'watermark_t', '水印位置', '参考键盘九宫格1-9', 0, '9'),
	(73, 'watermark_tm', '水印透明度', '透明度越大，越难看清楚水印', 0, '0'),
	(74, 'money_exchange', '钱包兑换率', '站内钱包与RMB的兑换率，即1元=多少金币', 0, '1'),
	(75, 'jifen_exchange', '积分兑换率', '站内积分与RMB的兑换率，即1元=多少积分', 0, '100'),
	(76, 'isopenjifen', '积分支付', '开启积分支付后，商品可以用积分支付', 0, '1'),
	(77, 'isopenqianbao', '钱包支付', '开启钱包支付后，商品可以用钱包支付', 0, '1'),
	(78, 'isopenweixin', '微信支付', '开启微信支付后，商品可以用微信支付', 0, '1'),
	(79, 'isopenzfb', '支付宝支付', '开启支付宝支付后，商品可以用支付宝支付', 0, '1'),
	(80, 'login_award', '每次登录奖励', '每天登录奖励积分数，最小为0，每天登录只奖励一次', 0, '1'),
	(81, 'login_award_open', '登录奖励', '开启登录奖励后，登录后就会获得积分奖励', 0, '1'),
	(82, 'release_award_open', '发布奖励', '开启后，发布内容会奖励积分', 0, '1'),
	(83, 'release_award', '每次发布奖励', '每次发布内容奖励积分数', 0, '1'),
	(84, 'release_max_award', '每天发布最高奖励', '每天奖励不超过积分上限，设置0则无上限', 0, '0'),
	(85, 'collect_award_open', '收藏奖励', '开启后，发布内容被收藏会奖励积分', 0, '1'),
	(86, 'collect_award', '每次收藏奖励', '每次发布内容被收藏奖励积分数', 0, '1'),
	(87, 'collect_max_award', '每天收藏最高奖励', '每天奖励不超过积分上限，设置0则无上限', 0, '0'),
	(88, 'likes_award_open', '点赞奖励', '开启后，发布内容被点赞会奖励积分', 0, '1'),
	(89, 'likes_award', '每次点赞奖励', '每次发布内容被点赞奖励积分数', 0, '1'),
	(90, 'likes_max_award', '每天点赞最高奖励', '每天奖励不超过积分上限，设置0则无上限', 0, '0'),
	(91, 'comment_award_open', '评论奖励', '开启后，发布内容被评论会奖励积分', 0, '1'),
	(92, 'comment_award', '每次评论奖励', '每次发布内容被评论奖励积分数', 0, '1'),
	(93, 'comment_max_award', '每天评论最高奖励', '每天奖励不超过积分上限，设置0则无上限', 0, '0'),
	(94, 'follow_award_open', '关注奖励', '开启后，用户被粉丝关注会奖励积分', 0, '1'),
	(95, 'follow_award', '每次关注奖励', '每次被关注奖励积分数', 0, '1'),
	(96, 'follow_max_award', '每天关注最高奖励', '每天关注奖励不超过积分上限，设置0则无上限', 0, '0'),
	(97, 'isopenemail', '发送邮件', '是否开启邮件发送', 0, '1');
/*!40000 ALTER TABLE `jz_sysconfig` ENABLE KEYS */;

-- 导出  表 cms.jz_tags 结构
CREATE TABLE IF NOT EXISTS `jz_tags` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.jz_tags 的数据：0 rows
DELETE FROM `jz_tags`;
/*!40000 ALTER TABLE `jz_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_tags` ENABLE KEYS */;
...
-- 正在导出表  cms.jz_task 的数据：0 rows
DELETE FROM `jz_task`;
/*!40000 ALTER TABLE `jz_task` DISABLE KEYS */;
/*!40000 ALTER TABLE `jz_task` ENABLE KEYS */;
...
INSERT INTO `proxies_priv` (`Host`, `User`, `Proxied_host`, `Proxied_user`, `With_grant`, `Grantor`, `Timestamp`) VALUES
	('localhost', 'root', '', '', 1, '', '2021-08-29 11:55:04'),
	('pvp-510-team-1', 'root', '', '', 1, '', '2021-08-29 11:55:04');
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `Create_tablespace_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`, `plugin`, `authentication_string`) VALUES
	...
	('pvp-510-team-1', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', ''),
	...
	('localhost', 'cms', '*E2400B0581660820352891CADB6678CCF8698F48', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', NULL);
