...
-- 导出  表 cms.lf_action 结构
CREATE TABLE IF NOT EXISTS `lf_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统行为表';

-- 正在导出表  cms.lf_action 的数据：55 rows
DELETE FROM `lf_action`;
/*!40000 ALTER TABLE `lf_action` DISABLE KEYS */;
INSERT INTO `lf_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
	(1, 'admin_login', '管理员登陆', '管理员登陆', '', '管理员[user|get_member_name]登录了后台', 1, 1, 1433910200),
	(2, 'admin_logout', '管理员退出', '管理员退出', '', '管理员[user|get_member_name]退出了后台', 1, 1, 1380173180),
	(3, 'update_config', '更新配置', '更新配置', 'table:member|field:score|condition:uid={$self}|rule:score+1', '', 1, 1, 1383285646),
	(4, 'update_sys', '更新系统', '更新系统', '', '系统升级至版本：[model]', 1, 1, 1433913086),
	(5, 'delete_log', '清空日志', '清空日志', '', '保留从[time|time_format]起一周日志数据其余全部清除', 1, 1, 1433913944),
	(6, 'add_admin', '新增管理员', '新增管理员', '', '新增管理员：[record|get_member_name]', 1, 1, 1433914139),
	(7, 'update_admin', '更新管理员', '更新管理员', '', '更新管理员：[record|get_member_name]', 1, 1, 1383295057),
	(8, 'delete_admin', '删除管理员', '删除管理员', '', '删除管理员记录编号[record]', 1, 1, 1433915933),
	(9, 'add_player', '新增播放器', '新增播放器', '', '新增播放器记录编号[record]', 1, 1, 1383296301),
	(10, 'update_player', '更新播放器', '更新播放器', '', '更新播放器记录编号[record]', 1, 1, 1383296392),
	(11, 'delete_player', '删除播放器', '删除播放器', '', '删除播放器记录编号[record]', 1, 1, 1383296765),
	(12, 'add_player', '新增播放器', '新增播放器', '', '新增播放器记录编号[record]', 1, 1, 1383296301),
	(13, 'delete_player', '删除播放器', '删除播放器', '', '删除播放器记录编号[record]', 1, 1, 1383296301),
	(14, 'update_player', '更新播放器', '更新播放器', '', '更新播放器记录编号[record]', 1, 1, 0),
	(15, 'backup_data', '备份数据库表', '备份数据库表', '', '备份数据库表[record]', 1, 1, 0),
	(16, 'optimize_data', '优化数据库表', '优化数据库表', '', '优化数据库表[record]', 1, 1, 0),
	(17, 'repair_data', '修复数据库表', '修复数据库表', '', '修复数据库表[record]', 1, 1, 0),
	(18, 'restore_data', '还原数据库备份', '还原数据库备份', '', '还原数据库备份[record]', 1, 1, 0),
	(19, 'delete_data', '删除备份数据库', '删除备份数据库', '', '删除备份数据库[record]', 1, 1, 0),
	(20, 'add_link', '新增友情链接', '新增友情链接', '', '新增友情链接记录编号[record]', 1, 1, 0),
	(21, 'update_link', '更新友情链接', '更新友情链接', '', '更新友情链接记录编号[record]', 1, 1, 0),
	(22, 'delete_link', '删除友情链接', '删除友情链接', '', '删除友情链接记录编号[record]', 1, 1, 0),
	(23, 'add_ad', '新增广告', '新增广告', '', '新增广告记录编号[record]', 1, 1, 0),
	(24, 'update_ad', '更新广告', '更新广告', '', '更新广告记录编号[record]', 1, 1, 0),
	(25, 'delete_ad', '删除广告', '删除广告', '', '删除广告记录编号[record]', 1, 1, 0),
	(26, 'add_category', '新增分类', '新增分类', '', '新增分类记录编号[record]', 1, 1, 0),
	(27, 'update_category', '更新分类', '更新分类', '', '更新分类记录编号[record]', 1, 1, 0),
	(28, 'del_category', '删除分类', '删除分类', '', '删除分类记录编号[record]', 1, 1, 0),
	(29, 'move_category', '移动分类', '移动分类', '', '移动分类记录编号[record]', 1, 1, 0),
	(30, 'merge_category', '合并分类', '合并分类', '', '合并分类记录编号[record]', 1, 1, 0),
	(31, 'add_movie', '新增影片', '新增影片', '', '新增影片编号[record]', 1, 1, 0),
	(32, 'update_movie', '更新影片', '更新影片', '', '更新影片记录编号[record]', 1, 1, 0),
	(33, 'del_movie', '删除影片', '删除影片', '', '删除影片编号[record]', 1, 1, 0),
	(34, 'add_news', '新增文章', '新增文章', '', '新增文章编号[record]', 1, 1, 0),
	(35, 'update_news', '更新文章', '更新文章', '', '更新文章编号[record]', 1, 1, 0),
	(36, 'del_news', '删除文章', '删除文章', '', '删除影片编号[record]', 1, 1, 0),
	(37, 'add_user', '新增用户', '新增用户', '', '新增用户编号[record]', 1, 1, 0),
	(38, 'update_user', '更新用户', '更新用户', '', '更新用户编号[record]', 1, 1, 0),
	(39, 'del_user', '删除用户', '删除用户', '', '删除用户编号[record]', 1, 1, 0),
	(40, 'add_prize', '新增奖品', '新增奖品', '', '新增奖品编号[record]', 1, 1, 0),
	(41, 'update_prize', '更新奖品', '更新奖品', '', '更新奖品编号[record]', 1, 1, 0),
	(42, 'del_prize', '删除奖品', '删除奖品', '', '删除奖品编号[record]', 1, 1, 0),
	(43, 'cancel_prize', '取消兑奖', '取消交易', '', '取消交易编号[record]', 1, 1, 0),
	(44, 'delivery_prize', '兑奖发货', '兑奖发货', '', '兑奖发货编号[record]', 1, 1, 0),
	(45, 'update_tpl', '编辑模板', '编辑模板', '', '编辑模板文件[record]', 1, 1, 0),
	(46, 'config_tpl', '设置模板', '设置模板', '', '设置模板[record]', 1, 1, 0),
	(47, 'users_sign', '用户签到', '用户签到', '', '签到用户[user|get_user_name] 签到时间[time] 签到积分[record]', 2, 1, 1435454214),
	(48, 'users_rlink', '用户推广', '用户推广', '', '推广用户[user|get_user_name] 推广时间[time] 推广积分[record]', 2, 1, 0),
	(49, 'users_play', '看片积分', '看片积分', '', '积分用户[user|get_user_name] 积分时间[time] 积分[record]', 2, 1, 0),
	(50, 'del_message', '清除消息', '清除消息', '', '清除已看消息', 1, 1, 0),
	(51, 'add_message', '发送消息', '发送消息', NULL, '发送消息类型[record]', 1, 1, 0),
	(52, 'users_addtime', '增加vip时间', '增加vip时间', '', '增加用户[record|get_user_name]-vip时间', 1, 1, 0),
	(53, 'add_shop', '添加商品', '添加商品', NULL, '新增商品编号[record]', 1, 1, 0),
	(54, 'update_shop', '更新商品', '更新商品', NULL, '更新商品编号[record]', 1, 1, 0),
	(55, 'delete_shop', '删除商品', '删除商品', NULL, '删除商品编号[record]', 1, 1, 0);
/*!40000 ALTER TABLE `lf_action` ENABLE KEYS */;

-- 导出  表 cms.lf_action_log 结构
CREATE TABLE IF NOT EXISTS `lf_action_log` (
...
-- 正在导出表  cms.lf_action_log 的数据：6 rows
DELETE FROM `lf_action_log`;
/*!40000 ALTER TABLE `lf_action_log` DISABLE KEYS */;
INSERT INTO `lf_action_log` (`id`, `type`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
	(1, 1, 1, 1, 1886336821, 'member', '1', '管理员admin登录了后台', 1, 1636188268),
	(2, 1, 6, 1, 1886336821, 'member', '15', '新增管理员：administrator', 1, 1636188601),
	(3, 1, 6, 1, 1886336821, 'member', '16', '新增管理员：harry', 1, 1636188617),
	(4, 1, 21, 1, 1886336821, 'link', '1', '更新友情链接记录编号1', 1, 1636188659),
	(5, 1, 31, 1, 1886336821, 'movie', '1', '新增影片编号1', 1, 1636188807),
	(6, 1, 32, 1, 1886336821, 'movie', '27844', '更新影片记录编号27844', 1, 1636189346);
/*!40000 ALTER TABLE `lf_action_log` ENABLE KEYS */;

-- 导出  表 cms.lf_ad 结构
CREATE TABLE IF NOT EXISTS `lf_ad` (
...
-- 正在导出表  cms.lf_ad 的数据：5 rows
DELETE FROM `lf_ad`;
/*!40000 ALTER TABLE `lf_ad` DISABLE KEYS */;
INSERT INTO `lf_ad` (`id`, `title`, `url`, `status`) VALUES
	(1, '377x100', 'index_377x100', 1),
	(2, '779x100', 'index_779x100', 1),
	(3, '1180x100', 'type_1180x100', 1),
	(4, '840x100', 'movie_840x100', 1),
	(5, '295x100', 'player_295x100', 1);
/*!40000 ALTER TABLE `lf_ad` ENABLE KEYS */;

-- 导出  表 cms.lf_addons 结构
CREATE TABLE IF NOT EXISTS `lf_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- 正在导出表  cms.lf_addons 的数据：0 rows
DELETE FROM `lf_addons`;
/*!40000 ALTER TABLE `lf_addons` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_addons` ENABLE KEYS */;
...
-- 正在导出表  cms.lf_card 的数据：0 rows
DELETE FROM `lf_card`;
/*!40000 ALTER TABLE `lf_card` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_card` ENABLE KEYS */;

-- 导出  表 cms.lf_category 结构
...
-- 正在导出表  cms.lf_category 的数据：19 rows
DELETE FROM `lf_category`;
/*!40000 ALTER TABLE `lf_category` DISABLE KEYS */;
INSERT INTO `lf_category` (`id`, `name`, `title`, `icon`, `pid`, `type`, `sort`, `display`, `meta_title`, `keywords`, `description`, `template_index`, `template_detail`, `template_play`, `template_type`, `link`, `extend`, `create_time`, `update_time`, `status`, `record`, `private`, `navno`, `appno`) VALUES
	(2, 'dianshiju', '电视剧', 'icons-tvshow', 0, 1, 1, 1, '', '', '', 'type.html', 'movie.html', 'player.html', 'lists.html', '0', '', 1379475028, 1419759684, 1, 1, 0, 1, 1),
	(3, 'xiju', '喜剧', NULL, 4, 1, 2, 1, '', '', '', 'lists.html', '', '', '', '0', '', 1379475028, 1502247304, 1, 1, 0, 1, 1),
	(4, 'film', '电影', 'icons-movie', 0, 1, 0, 1, '', '', '', 'type.html', 'movie.html', 'player.html', 'lists.html', '0', '', 1379474947, 1432516372, 1, 1, 0, 1, 1),
	(43, 'aiqing', '爱情', NULL, 4, 1, 6, 1, '', '', '', 'lists.html', '', '', '', '', '', 1419759483, 1502247319, 1, 1, 0, 1, 1),
	(44, 'dongzuo', '动作', NULL, 4, 1, 1, 1, '', '', '', 'lists.html', '', '', '', '', '', 1419759519, 1502247301, 1, 1, 0, 1, 1),
	(46, 'kehuan', '科幻', NULL, 4, 1, 3, 1, '', '', '', 'lists.html', '', '', '', '', '', 1419759609, 1502247307, 1, 1, 0, 1, 1),
	(49, 'gtgz', '国产剧', NULL, 2, 1, 1, 1, '', '', '', 'lists.html', '', '', '', '', '', 1419759738, 1487929937, 1, 1, 0, 1, 1),
	(51, 'tvbjc', '港台剧', NULL, 2, 1, 2, 1, '', '', '', 'lists.html', '', '', '', '', '', 1419759787, 1487929946, 1, 1, 0, 1, 1),
	(53, 'myrj', '欧美剧', NULL, 2, 1, 4, 1, '', '', '', 'lists.html', '', '', '', '', '', 1419759869, 1487929959, 1, 1, 0, 1, 1),
	(54, 'rhzq', '日韩剧', NULL, 2, 1, 3, 1, '', '', '', 'lists.html', '', '', '', '', '', 1419759900, 1487929952, 1, 1, 0, 1, 1),
	(55, 'dongman', '动漫', 'icons-dongman', 0, 1, 2, 1, '', '', '', 'lists.html', 'movie.html', 'player.html', 'lists.html', '', '', 1419759920, 1419759934, 1, 1, 0, 1, 1),
	(56, 'zhongyi', '综艺', 'icons-zongyi', 0, 1, 3, 1, '', '', '', 'lists.html', 'movie.html', 'player.html', 'lists.html', '', '', 1419759963, 1419759963, 1, 1, 0, 1, 1),
	(59, 'inform', '资讯', NULL, 0, 2, 6, 1, '', '', '', 'newslists.html', 'news.html', '', '', '', '', 1419760039, 1488099914, 1, 1, 0, 1, 0),
	(64, 'kongbu', '恐怖', '', 4, 1, 4, 1, '', '', '', 'lists.html', '', '', '', '', '', 1487929488, 1502247309, 1, 1, 0, 1, 1),
	(66, 'juqing', '剧情', NULL, 4, 1, 5, 1, '', '', '', 'lists.html', '', '', '', '', '', 1487929737, 1502247312, 1, 1, 0, 1, 1),
	(67, 'zhanzheng', '战争', NULL, 4, 1, 7, 1, '', '', '', 'lists.html', '', '', '', '', '', 1487929764, 1502247324, 1, 1, 0, 1, 1),
	(78, 'lunli', '伦理', '', 4, 1, 8, 1, '', '', '', 'lists.html', '', '', '', '', '', 1487930424, 1502247326, 1, 1, 0, 1, 1),
	(101, 'notice', '公告', NULL, 0, 2, 7, 1, '', '', '', 'newslists.html', 'news.html', '', '', '', '', 1488079861, 1488079882, 1, 1, 0, 0, 0),
	(102, 'help', '帮助', NULL, 0, 2, 8, 1, '', '', '', 'newslists.html', 'news.html', '', '', '', '', 1488079914, 1488079914, 1, 1, 0, 0, 0);
/*!40000 ALTER TABLE `lf_category` ENABLE KEYS */;

-- 导出  表 cms.lf_comment 结构
...
-- 正在导出表  cms.lf_comment 的数据：0 rows
DELETE FROM `lf_comment`;
/*!40000 ALTER TABLE `lf_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_comment` ENABLE KEYS */;

-- 导出  表 cms.lf_config 结构
...
-- 正在导出表  cms.lf_config 的数据：66 rows
DELETE FROM `lf_config`;
/*!40000 ALTER TABLE `lf_config` DISABLE KEYS */;
INSERT INTO `lf_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `value`, `sort`, `display`) VALUES
	(1, 'WEB_SITE_TITLE', 1, '网站标题', 1, '', '', 1378898976, 1379235274, 'awd-s2-10', 4, 1),
	(2, 'WEB_SITE_DESCRIPTION', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 'awd-s2-10', 5, 1),
	(3, 'WEB_SITE_KEYWORD', 2, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 'awd-s2-10', 6, 1),
	(4, 'WEB_SITE_CLOSE', 4, '关闭站点', 1, '0:关闭\r\n1:开启', '站点关闭后前台将不能访问，后台可以正常访问', 1378898976, 1379235296, '1', 0, 1),
	(10, 'WEB_SITE_ICP', 1, '网站备案号', 1, '', '设置在网站底部显示的备案号，如“沪ICP备12007941号-2', 1378900335, 1379235859, '', 7, 1),
	(11, 'DOCUMENT_POSITION', 3, '文档推荐位', 2, '', '文档推荐位，推荐到多个位置KEY值相加即可', 1379053380, 1379235329, '1:列表页推荐\r\n2:频道页推荐\r\n4:首页推荐', 3, 0),
	(20, 'CONFIG_GROUP_LIST', 3, '配置分组', 4, '', '配置分组', 1379228036, 1384418383, '1:基本\r\n2:内容\r\n3:用户\r\n4:系统\r\n5:UCenter\r\n6:邮件', 4, 0),
	(25, 'LIST_ROWS', 0, '后台每页记录数', 2, '', '', 1379503896, 1380427745, '20', 10, 1),
	(26, 'USER_ALLOW_REGISTER', 4, '是否允许用户注册', 3, '0:关闭注册\r\n1:允许注册', '', 1379504487, 1379504580, '1', 0, 1),
	(28, 'DATA_BACKUP_PATH', 1, '数据库备份根路径', 4, '', '路径必须以 / 结尾', 1381482411, 1381482411, './Data/', 8, 1),
	(29, 'DATA_BACKUP_PART_SIZE', 0, '数据库备份卷大小', 4, '', '该值用于限制压缩后的分卷最大长度。单位：B；建议设置20M', 1381482488, 1381729564, '20971520', 9, 1),
...
-- 正在导出表  cms.lf_exchange 的数据：0 rows
DELETE FROM `lf_exchange`;
/*!40000 ALTER TABLE `lf_exchange` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_exchange` ENABLE KEYS */;

-- 导出  表 cms.lf_favorites 结构
CREATE TABLE IF NOT EXISTS `lf_favorites` (
...
-- 正在导出表  cms.lf_favorites 的数据：0 rows
DELETE FROM `lf_favorites`;
/*!40000 ALTER TABLE `lf_favorites` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_favorites` ENABLE KEYS */;
...
-- 正在导出表  cms.lf_link 的数据：1 rows
DELETE FROM `lf_link`;
/*!40000 ALTER TABLE `lf_link` DISABLE KEYS */;
INSERT INTO `lf_link` (`id`, `title`, `url`, `sort`, `status`) VALUES
	(1, 'bugku', 'ctf.bugku.com', 1, 1);
/*!40000 ALTER TABLE `lf_link` ENABLE KEYS */;

-- 导出  表 cms.lf_member 结构
CREATE TABLE IF NOT EXISTS `lf_member` (
...
-- 正在导出表  cms.lf_member 的数据：3 rows
DELETE FROM `lf_member`;
/*!40000 ALTER TABLE `lf_member` DISABLE KEYS */;
INSERT INTO `lf_member` (`id`, `username`, `password`, `login`, `last_login_ip`, `last_login_time`, `status`) VALUES
	(1, 'admin', '8d7a5dfbcaefdefd96ff9ae489067769', 1, 1886336821, 1636188268, 1),
	(15, 'administrator', 'd8f8780201f1c26e9362112761057e80', 0, 0, 0, 1),
	(16, 'harry', 'd8f8780201f1c26e9362112761057e80', 0, 0, 0, 1);
/*!40000 ALTER TABLE `lf_member` ENABLE KEYS */;

-- 导出  表 cms.lf_menu 结构
CREATE TABLE IF NOT EXISTS `lf_menu` (
...
-- 正在导出表  cms.lf_menu 的数据：77 rows
DELETE FROM `lf_menu`;
/*!40000 ALTER TABLE `lf_menu` DISABLE KEYS */;
INSERT INTO `lf_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `icon`) VALUES
	(1, '系统信息', 2, 0, 'Index/index', 0, '', '系统', 'icon-home'),
	(2, '系统', 0, 2, 'Config/group', 0, '', '', 'icon-cog'),
	(3, '内容', 0, 3, 'Movie/index', 0, '', '', 'icon-book'),
	(4, '用户', 0, 5, 'Users/index', 0, '', '', 'icon-user'),
	(5, '模板', 0, 6, 'Template/index', 0, '', '', 'icon-file'),
	(6, '采集', 0, 7, 'Collect/index', 0, '', '', 'icon-magnet'),
	(7, '扩展', 0, 8, 'Addons/index', 0, '', '', 'icon-puzzle-piece'),
	(8, '系统设置', 2, 0, 'Config/group', 0, '', '系统', ''),
	(9, '管理员管理', 2, 1, 'Member/index', 0, '', '管理员', ''),
	(10, '管理员添加', 2, 0, 'Member/add', 0, '', '管理员', ''),
	(11, '播放器添加', 2, 0, 'Player/add', 0, '', '播放器', ''),
	(12, '播放器管理', 2, 0, 'Player/index', 0, '', '播放器', ''),
	(13, '日志管理', 2, 0, 'Action/index', 0, '', '系统', ''),
	(14, '备份数据库', 2, 0, 'Database/index?type=export', 0, '', '数据库', ''),
	(15, '还原数据库', 2, 0, 'Database/index?type=import', 0, '', '数据库', ''),
	(16, '修改管理员密码', 2, 0, 'Member/edit', 1, '', '管理员', ''),
	(17, '修改播放器', 2, 0, 'Player/edit', 1, '', '播放器', ''),
	(18, '分类管理', 3, 1, 'Category/index', 0, '', '分类', ''),
	(19, '分类添加', 3, 0, 'Category/add', 0, '', '分类', ''),
	(20, '分类修改', 3, 0, 'Category/edit', 1, '', '分类', ''),
	(21, '分类合并', 3, 0, 'Category/operate', 1, '', '分类', ''),
	(22, '影片管理', 3, 3, 'Movie/index', 0, '', '影片', ''),
	(23, '影片添加', 3, 2, 'Movie/add', 0, '', '影片', ''),
	(24, '影片修改', 3, 0, 'Movie/edit', 1, '', '影片', ''),
	(25, '一键采集', 6, 0, 'Collect/index', 0, '', '采集', ''),
	(26, '绑定播放器', 6, 0, 'Collect/listplay', 0, '', '采集', ''),
	(27, '采集列表', 6, 0, 'Collect/lists', 1, '', '采集', ''),
	(28, '友情链接管理', 2, 2, 'Link/index', 0, '', '链接', ''),
	(29, '友情链接添加', 2, 0, 'Link/add', 0, '', '链接', ''),
	(30, '修改友情链接', 2, 0, 'Link/edit', 1, '', '链接', ''),
	(33, '下载远程图片', 6, 0, 'Collect/downpic', 0, '', '采集', ''),
	(34, '模板管理', 5, 0, 'Template/index', 0, '', '模板', ''),
	(35, '添加文章', 3, 6, 'News/add', 0, '', '文章', ''),
	(36, '文章管理', 3, 7, 'News/index', 0, '', '文章', ''),
	(37, '文章修改', 3, 0, 'News/edit', 1, '', '文章', ''),
	(38, '广告添加', 2, 0, 'Ad/add', 0, '', '广告', ''),
	(39, '广告管理', 2, 0, 'Ad/index', 0, '', '广告', ''),
	(40, '广告修改', 2, 0, 'Ad/edit', 1, '', '广告', ''),
	(41, '插件管理', 7, 0, 'Addons/index', 1, '', '插件', ''),
	(42, '在线升级', 2, 0, 'Update/index', 0, '', '系统', NULL),
	(43, '插件设置', 7, 0, 'Addons/config', 1, '', '插件', ''),
	(44, '插件添加', 7, 0, 'Addons/create', 1, '', '插件', ''),
	(45, '模板编辑', 5, 0, 'Template/edit', 1, '', '模板', ''),
	(47, '模板设置', 5, 1, 'Template/config', 0, '', '模板', ''),
	(48, '清除缓存', 2, 0, 'Index/cache', 1, '', '缓存', ''),
	(49, '用户管理', 4, 1, 'Users/index', 0, '', '用户管理', ''),
	(50, '用户添加', 4, 0, 'Users/add', 0, '', '用户管理', ''),
	(51, '奖品添加', 4, 0, 'Prize/add', 0, '', '奖品管理', ''),
	(52, '奖品管理', 4, 1, 'Prize/index', 0, '', '奖品管理', ''),
	(53, '兑奖管理', 4, 2, 'Prize/exchange', 0, '', '奖品管理', ''),
	(54, '用户修改', 4, 0, 'Users/edit', 1, '', '用户管理', ''),
	(55, '奖品修改', 4, 0, 'Prize/edit', 1, '', '奖品管理', ''),
	(56, '消息管理', 4, 0, 'Message/index', 0, '', '消息管理', NULL),
	(57, '评论管理', 3, 4, 'Comment/index', 0, '', '影片', NULL),
	(58, '充值', 0, 7, 'Card/index', 0, '', '', 'icon-money'),
	(59, '充值卡管理', 58, 2, 'Card/index', 0, '', '充值卡', NULL),
	(60, '生成充值卡', 58, 2, 'Card/add', 1, '', '充值卡', NULL),
	(64, '幻灯管理', 3, 5, 'Slider/index', 0, '', '幻灯', NULL),
	(65, '幻灯添加', 3, 4, 'Slider/add', 0, '', '幻灯', NULL),
	(66, '幻灯修改', 3, 0, 'Slider/edit', 1, '', '幻灯', NULL),
	(68, '采集联盟添加', 6, 0, 'Collect/add', 1, '', '采集', NULL),
	(69, '采集联盟修改', 6, 0, 'Collect/edit', 1, '', '采集', NULL),
	(70, '清空数据', 7, 0, 'Tool/remove', 0, '', '工具', NULL),
	(71, '日志', 2, 0, 'Action/action', 1, '', '系统', NULL),
	(72, '数据替换', 7, 0, 'Tool/replace', 0, '', '工具', NULL),
	(73, '随机数据', 7, 0, 'Tool/random', 0, '', '工具', NULL),
	(74, '路由管理', 2, 1, 'Route/index', 1, '', '路由', NULL),
	(75, '路由添加', 2, 0, 'Route/add', 1, '', '路由', NULL),
	(76, '路由修改', 2, 0, 'Route/edit', 1, '', '路由', NULL),
	(77, '插件管理', 7, 0, 'Addons/index', 0, '', '插件', NULL),
	(78, '商品管理', 58, 1, 'Shop/index', 0, '', '商品', NULL),
	(79, '商品修改', 58, 0, 'Shop/edit', 1, '', '商品', NULL),
	(80, '商品添加', 58, 0, 'Shop/add', 0, '', '商品', NULL),
	(81, '充值记录', 58, 0, 'Pay/log', 0, '', '充值记录', NULL),
	(82, '系统升级', 2, 0, 'Update/lists', 1, '', '系统', NULL),
	(83, '模板市场', 5, 0, 'Template/market', 0, '', '模板', NULL),
	(84, '插件市场', 7, 0, 'Addons/market', 0, '', '插件', NULL);
/*!40000 ALTER TABLE `lf_menu` ENABLE KEYS */;

-- 导出  表 cms.lf_message 结构
...
-- 正在导出表  cms.lf_message 的数据：0 rows
DELETE FROM `lf_message`;
/*!40000 ALTER TABLE `lf_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_message` ENABLE KEYS */;

-- 导出  表 cms.lf_movie 结构
CREATE TABLE IF NOT EXISTS `lf_movie` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=27845 DEFAULT CHARSET=utf8 COMMENT='影片表';

-- 正在导出表  cms.lf_movie 的数据：1 rows
DELETE FROM `lf_movie`;
/*!40000 ALTER TABLE `lf_movie` DISABLE KEYS */;
INSERT INTO `lf_movie` (`id`, `category`, `title`, `actors`, `area`, `language`, `year`, `cover_id`, `content`, `display`, `position`, `up`, `down`, `also_known_as`, `hits`, `rating`, `rating_count`, `directors`, `serialize`, `update_time`, `create_time`, `status`, `reurl`, `pinyin`, `favorites_count`, `tj_tag`, `collect_updata`) VALUES
	(27844, 44, '素人ガチナンパ ～押しに弱い学生さんに報酬あげるから素股してと誘ってみました～ 井森まな 2', '蒼井そら', '日韩', '日语', '2017', 0, '&lt;p&gt;test&lt;/p&gt;', 1, 0, 0, 0, '', 3, 0.0, 0, '', '', 1636189346, 1636128000, 1, NULL, '0', 0, 0, NULL);
/*!40000 ALTER TABLE `lf_movie` ENABLE KEYS */;

-- 导出  表 cms.lf_movie_url 结构
CREATE TABLE IF NOT EXISTS `lf_movie_url` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='影片地址表';

-- 正在导出表  cms.lf_movie_url 的数据：1 rows
DELETE FROM `lf_movie_url`;
/*!40000 ALTER TABLE `lf_movie_url` DISABLE KEYS */;
INSERT INTO `lf_movie_url` (`id`, `movie_url`, `movie_player_id`, `movie_id`) VALUES
	(1, '', 4, 27844);
/*!40000 ALTER TABLE `lf_movie_url` ENABLE KEYS */;
...
-- 正在导出表  cms.lf_news 的数据：0 rows
DELETE FROM `lf_news`;
/*!40000 ALTER TABLE `lf_news` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_news` ENABLE KEYS */;

-- 导出  表 cms.lf_pay_log 结构
CREATE TABLE IF NOT EXISTS `lf_pay_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `type` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '类型',
  ...
  `pay_name` varchar(40) DEFAULT NULL COMMENT '支付类型',
  `prepay_id` varchar(64) DEFAULT NULL COMMENT '返回订单',
  `state` tinyint(3) NOT NULL DEFAULT '0' COMMENT '支付状态 0:未支付1:已支付',
  `price` double(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '金额',
  `pay_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '支付时间',
  `sid` int(11) DEFAULT NULL COMMENT '商品id',
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='充值记录';

-- 正在导出表  cms.lf_pay_log 的数据：0 rows
DELETE FROM `lf_pay_log`;
/*!40000 ALTER TABLE `lf_pay_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_pay_log` ENABLE KEYS */;

-- 导出  表 cms.lf_picture 结构
CREATE TABLE IF NOT EXISTS `lf_picture` (
...
-- 正在导出表  cms.lf_picture 的数据：0 rows
DELETE FROM `lf_picture`;
/*!40000 ALTER TABLE `lf_picture` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_picture` ENABLE KEYS */;

-- 导出  表 cms.lf_player 结构
...
-- 正在导出表  cms.lf_player_log 的数据：0 rows
DELETE FROM `lf_player_log`;
/*!40000 ALTER TABLE `lf_player_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_player_log` ENABLE KEYS */;

-- 导出  表 cms.lf_prize 结构
CREATE TABLE IF NOT EXISTS `lf_prize` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` char(80) NOT NULL DEFAULT '' COMMENT '名称',
...
-- 正在导出表  cms.lf_prize 的数据：0 rows
DELETE FROM `lf_prize`;
/*!40000 ALTER TABLE `lf_prize` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_prize` ENABLE KEYS */;

-- 导出  表 cms.lf_route 结构
CREATE TABLE IF NOT EXISTS `lf_route` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '配置ID',
...
-- 正在导出表  cms.lf_route 的数据：0 rows
DELETE FROM `lf_route`;
/*!40000 ALTER TABLE `lf_route` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_route` ENABLE KEYS */;

-- 导出  表 cms.lf_shop 结构
CREATE TABLE IF NOT EXISTS `lf_shop` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` char(100) DEFAULT NULL,
  `price` double(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '金额',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '日志备注',
  `vip_time` int(11) unsigned DEFAULT '0',
  `status` tinyint(2) NOT NULL DEFAULT '1',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品';

-- 正在导出表  cms.lf_shop 的数据：0 rows
DELETE FROM `lf_shop`;
/*!40000 ALTER TABLE `lf_shop` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_shop` ENABLE KEYS */;

-- 导出  表 cms.lf_slider 结构
CREATE TABLE IF NOT EXISTS `lf_slider` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` char(80) NOT NULL DEFAULT '',
...
-- 正在导出表  cms.lf_slider 的数据：0 rows
DELETE FROM `lf_slider`;
/*!40000 ALTER TABLE `lf_slider` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_slider` ENABLE KEYS */;

-- 导出  表 cms.lf_users 结构
...
-- 正在导出表  cms.lf_users 的数据：0 rows
DELETE FROM `lf_users`;
/*!40000 ALTER TABLE `lf_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_users` ENABLE KEYS */;

-- 导出  表 cms.lf_users_follow 结构
CREATE TABLE IF NOT EXISTS `lf_users_follow` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 正在导出表  cms.lf_users_follow 的数据：0 rows
DELETE FROM `lf_users_follow`;
/*!40000 ALTER TABLE `lf_users_follow` DISABLE KEYS */;
/*!40000 ALTER TABLE `lf_users_follow` ENABLE KEYS */;
...
INSERT INTO `proxies_priv` (`Host`, `User`, `Proxied_host`, `Proxied_user`, `With_grant`, `Grantor`, `Timestamp`) VALUES
	('localhost', 'root', '', '', 1, '', '2021-11-28 02:55:03'),
	('pvp-819-team-1', 'root', '', '', 1, '', '2021-11-28 02:55:03');
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `Create_tablespace_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`, `plugin`, `authentication_string`) VALUES
	...
	('pvp-819-team-1', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', ''),
	...
	('localhost', 'cms', '*ECC8907111C782B0C9B66E5E88E3139B587C1E16', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', NULL);
