...
-- 正在导出表  cms.c_admin 的数据：1 rows
DELETE FROM `c_admin`;
/*!40000 ALTER TABLE `c_admin` DISABLE KEYS */;
INSERT INTO `c_admin` (`id`, `username`, `password`, `encrypt`, `last_time`, `creat_time`, `is_lock`, `last_ip`, `logins`, `groupid`) VALUES
	(1, 'admin', '5a0408a553574230cd46a508b03af127', 'lr24vx2', 1622764941, 1622764329, 0, '175.17.64.237', 3, 1);
/*!40000 ALTER TABLE `c_admin` ENABLE KEYS */;

-- 导出  表 cms.c_admin_group 结构
CREATE TABLE IF NOT EXISTS `c_admin_group` (
  `groupid` smallint(4) NOT NULL AUTO_INCREMENT,
  `name` char(20) NOT NULL,
  PRIMARY KEY (`groupid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- 正在导出表  cms.c_admin_group 的数据：1 rows
DELETE FROM `c_admin_group`;
/*!40000 ALTER TABLE `c_admin_group` DISABLE KEYS */;
INSERT INTO `c_admin_group` (`groupid`, `name`) VALUES
	(1, '超级管理员');
/*!40000 ALTER TABLE `c_admin_group` ENABLE KEYS */;
...
-- 正在导出表  cms.c_block 的数据：1 rows
DELETE FROM `c_block`;
/*!40000 ALTER TABLE `c_block` DISABLE KEYS */;
INSERT INTO `c_block` (`id`, `title`, `tag`, `content`) VALUES
	(1, 'banner', 'banner', '<img alt="" src="/uploadfile/image/20120820/20120820133503_75593.jpg" />');
/*!40000 ALTER TABLE `c_block` ENABLE KEYS */;

-- 导出  表 cms.c_category 结构
...
-- 正在导出表  cms.c_category 的数据：34 rows
DELETE FROM `c_category`;
/*!40000 ALTER TABLE `c_category` DISABLE KEYS */;
INSERT INTO `c_category` (`catid`, `model`, `type`, `modelid`, `parentid`, `catname`, `catdir`, `thumb`, `url`, `sort`, `is_show`, `is_target`, `is_html`, `is_link`, `template_cate`, `template_list`, `template_show`, `seo_title`, `seo_key`, `seo_des`, `power`, `lang`, `url_list`, `url_show`, `pagesize`) VALUES
	(1, 'single', 0, 1, 0, '关于我们', 'abouts', NULL, 'index.php?m=content&c=index&f=lists&catid=1', 1, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(2, 'news', 0, 2, 0, '新闻资讯', 'news', NULL, 'index.php?m=content&c=index&f=lists&catid=2', 2, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(3, 'product', 0, 3, 0, '产品展示', 'products', NULL, 'index.php?m=content&c=index&f=lists&catid=3', 3, 1, 0, 0, 0, 'category_product.html', 'list_news.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(4, 'job', 0, 4, 0, '招贤纳士', 'job', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=4', 4, 1, 0, 0, 0, 'category_job.html', 'list_job.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(5, 'single', 0, 1, 0, '营销网络', 'market', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=5', 20, 0, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(7, 'single', 0, 1, 0, '联系方式', 'contact', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=7', 7, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(8, 'single', 0, 1, 1, '公司简介', 'about', '', 'index.php?m=content&c=index&f=lists&l=1&catid=8', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', 'NULL', 1, 1, 2, 20),
	(9, 'single', 0, 1, 1, '企业文化', 'culture', '', 'index.php?m=content&c=index&f=lists&l=1&catid=9', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', 'NULL', 1, 1, 2, 20),
	(10, 'news', 0, 2, 2, '公司新闻', 'company', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=10', 0, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(11, 'news', 0, 2, 2, '行业新闻', 'industry', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=11', 0, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(12, 'product', 0, 3, 3, '网站建设', 'website', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=12', 0, 1, 0, 0, 0, 'category_product.html', 'list_product.html', 'show_product.html', '', '', '', NULL, 1, 1, 2, 20),
	(13, 'product', 0, 3, 3, '软件开发', 'software', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=13', 0, 1, 0, 0, 0, 'category_product.html', 'list_product.html', 'show_product.html', '', '', '', NULL, 1, 1, 2, 20),
	(14, 'product', 0, 3, 3, '短信群发', 'sms', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=14', 0, 1, 0, 0, 0, 'category_product.html', 'list_product.html', 'show_product.html', '', '', '', NULL, 1, 1, 2, 20),
	(15, 'job', 0, 4, 4, '招聘信息', 'jobinfo', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=15', 0, 1, 0, 0, 0, 'category_job.html', 'list_job.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(16, 'single', 0, 1, 4, '人才理念', 'concept', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=16', 0, 1, 0, 0, 0, 'category_job.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(17, 'single', 0, 1, 4, '培训制度', 'training', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=17', 0, 1, 0, 0, 0, 'category_job.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(18, 'single', 0, 1, 5, '网络地图', 'map', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=18', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(19, 'single', 0, 1, 5, '市场政策', 'policy', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=19', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(20, 'single', 0, 1, 7, '联系方式', 'contactway', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=20', 2, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(21, 'single', 0, 1, 7, '联系地图', 'contactmap', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=21', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(22, 'single', 0, 1, 3, '网络推广', 'promotion', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=22', 0, 1, 0, 0, 0, 'category_product.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(23, 'single', 0, 1, 3, '平面设计', 'design', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=23', 0, 1, 0, 0, 0, 'category_product.html', 'list_single.html', 'show_news.html', '', '', '', NULL, 1, 1, 2, 20),
	(24, 'product', 0, 3, 3, '虚拟主机', 'host', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=24', 0, 1, 0, 0, 0, 'category_product.html', 'list_product.html', 'show_product.html', '', '', '', NULL, 1, 1, 2, 20),
	(28, 'download', 0, 5, 0, '资料下载', 'download', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=28', 5, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_down.html', '', '', '', NULL, 1, 1, 2, 20),
	(29, 'download', 0, 5, 28, '产品资料', 'productinfo', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=29', 0, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_down.html', '', '', '', NULL, 1, 1, 2, 20),
	(30, 'download', 0, 5, 28, '其它资料', 'otherinfo', NULL, 'index.php?m=content&c=index&f=lists&l=1&catid=30', 0, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_down.html', '', '', '', NULL, 1, 1, 2, 20),
	(31, 'single', 0, 1, 0, 'About', 'enabout', '', 'index.php?m=content&c=index&f=lists&l=2&catid=31', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_single.html', '', '', '', 'NULL', 2, 1, 2, 20),
	(32, 'single', 0, 1, 31, 'abouts', 'enabouts', '', 'index.php?m=content&c=index&f=lists&l=2&catid=32', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_single.html', '', '', '', 'NULL', 2, 1, 2, 20),
	(33, 'single', 0, 1, 31, 'culture', 'enculture', '', 'index.php?m=content&c=index&f=lists&l=2&catid=33', 0, 1, 0, 0, 0, 'category_single.html', 'list_single.html', 'show_single.html', '', '', '', 'NULL', 2, 1, 2, 20),
	(34, 'news', 0, 2, 0, 'News', 'ennws', '', 'index.php?m=content&c=index&f=lists&l=2&catid=34', 0, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_news.html', '', '', '', 'NULL', 2, 1, 2, 20),
	(35, 'news', 0, 2, 34, 'company', 'companynews', '', 'index.php?m=content&c=index&f=lists&l=2&catid=35', 0, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_news.html', '', '', '', 'NULL', 2, 1, 2, 20),
	(36, 'news', 0, 2, 34, 'industry', 'industrynew', '', 'index.php?m=content&c=index&f=lists&l=2&catid=36', 0, 1, 0, 0, 0, 'category_news.html', 'list_news.html', 'show_news.html', '', '', '', 'NULL', 2, 1, 2, 20),
	(37, 'product', 0, 3, 0, 'Products', 'newproduct', '', 'index.php?m=content&c=index&f=lists&l=2&catid=37', 0, 1, 0, 0, 0, 'category_product.html', 'list_product.html', 'show_product.html', '', '', '', 'NULL', 2, 1, 2, 20),
	(38, 'product', 0, 3, 37, 'web', 'enweb', '', 'index.php?m=content&c=index&f=lists&l=2&catid=38', 0, 1, 0, 0, 0, 'category_product.html', 'list_product.html', 'show_product.html', '', '', '', 'NULL', 2, 1, 2, 20);
/*!40000 ALTER TABLE `c_category` ENABLE KEYS */;

-- 导出  表 cms.c_config 结构
...
-- 正在导出表  cms.c_config 的数据：4 rows
DELETE FROM `c_config`;
/*!40000 ALTER TABLE `c_config` DISABLE KEYS */;
INSERT INTO `c_config` (`id`, `config_array`, `config_tag`) VALUES
	(1, 'array (\n  \'is_modify\' => 1,\n  \'siteurl\' => \'/\',\n  \'template\' => \'xdcms\',\n  \'caching\' => \'false\',\n  \'createhtml\' => NULL,\n  \'cookie\' => NULL,\n  \'logourl\' => \'system/templates/xdcms/images/logo.gif\',\n)', 'config'),
	(2, 'array (  \'master\' => \'管理员\',  \'email\' => \'service@91736.com\',  \'contact\' => \'管理员\',  \'telephone\' => \'0771-1234567\',  \'fax\' => \'0771-1234567\',  \'mobilephone\' => \'13333333333\',  \'address\' => \'广西南宁市东葛路\',)', 'contact'),
	(3, 'array (  \'mailobject\' => \'1\',  \'mailserver\' => \'smtp.163.com\',  \'mailport\' => \'25\',  \'password\' => \'123456\',  \'mailadd\' => \'admin@163.com\',  \'username\' => \'admin@163.com\',)', 'email'),
	(4, 'array (  \'isopen\' => \'1\',  \'imagesize\' => \'500\',  \'imageallowed\' => \'gif,jpg,jpeg,png\',  \'filesize\' => \'2048\',  \'fileallowed\' => \'rar,zip,doc\',  \'watermark\' => \'100\',  \'pos\' => \'9\',  \'font\' => \'5\',  \'width\' => \'300\',  \'color\' => \'#FF0000\',  \'text\' => \'xdcms.cn\',  \'image\' => \'uploadfile/xdcms.png\',)', 'upload');
/*!40000 ALTER TABLE `c_config` ENABLE KEYS */;

-- 导出  表 cms.c_download 结构
CREATE TABLE IF NOT EXISTS `c_download` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.c_download 的数据：0 rows
DELETE FROM `c_download`;
/*!40000 ALTER TABLE `c_download` DISABLE KEYS */;
/*!40000 ALTER TABLE `c_download` ENABLE KEYS */;

-- 导出  表 cms.c_download_content 结构
CREATE TABLE IF NOT EXISTS `c_download_content` (
  `id` int(8) NOT NULL,
...
-- 正在导出表  cms.c_download_content 的数据：0 rows
DELETE FROM `c_download_content`;
/*!40000 ALTER TABLE `c_download_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `c_download_content` ENABLE KEYS */;

-- 导出  表 cms.c_flash 结构
CREATE TABLE IF NOT EXISTS `c_flash` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `title` char(80) NOT NULL,
...
-- 正在导出表  cms.c_flash 的数据：3 rows
DELETE FROM `c_flash`;
/*!40000 ALTER TABLE `c_flash` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `c_flash` ENABLE KEYS */;

-- 导出  表 cms.c_flash_type 结构
CREATE TABLE IF NOT EXISTS `c_flash_type` (
  `id` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `name` char(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- 正在导出表  cms.c_flash_type 的数据：1 rows
DELETE FROM `c_flash_type`;
/*!40000 ALTER TABLE `c_flash_type` DISABLE KEYS */;
INSERT INTO `c_flash_type` (`id`, `name`) VALUES
	(1, '首页幻灯');
/*!40000 ALTER TABLE `c_flash_type` ENABLE KEYS */;
...
-- 正在导出表  cms.c_form 的数据：2 rows
DELETE FROM `c_form`;
/*!40000 ALTER TABLE `c_form` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `c_form` ENABLE KEYS */;

-- 导出  表 cms.c_form_field 结构
CREATE TABLE IF NOT EXISTS `c_form_field` (
...
-- 正在导出表  cms.c_form_field 的数据：11 rows
DELETE FROM `c_form_field`;
/*!40000 ALTER TABLE `c_form_field` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `c_form_field` ENABLE KEYS */;
...
-- 正在导出表  cms.c_job 的数据：3 rows
DELETE FROM `c_job`;
/*!40000 ALTER TABLE `c_job` DISABLE KEYS */;
INSERT INTO `c_job` (`id`, `catid`, `title`, `thumb`, `keywords`, `description`, `commend`, `url`, `userid`, `username`, `inputtime`, `updatetime`, `hits`, `sort`, `style`) VALUES
	(15, 15, 'PHP程序员', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=15&id=15', 1, 'admin', 1321949198, 0, 0, 0, NULL),
	(16, 15, '网页设计师', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=15&id=16', 1, 'admin', 1321950421, 0, 0, 0, NULL),
	(24, 15, '业务员', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=15&id=24', 9, 'admin', 1322296402, 0, 0, 0, NULL);
/*!40000 ALTER TABLE `c_job` ENABLE KEYS */;

-- 导出  表 cms.c_job_content 结构
CREATE TABLE IF NOT EXISTS `c_job_content` (
  `id` int(8) NOT NULL,
...
-- 正在导出表  cms.c_job_content 的数据：3 rows
DELETE FROM `c_job_content`;
/*!40000 ALTER TABLE `c_job_content` DISABLE KEYS */;
INSERT INTO `c_job_content` (`id`, `type`, `experience`, `degree`, `sex`, `numbers`, `wage`, `content`) VALUES
	(15, '全职', '2年', '大专', '男性', '2', '3000以上', ''),
	(16, '全职', '2年', '大专', '不限', '2', '2000以上', ''),
	(24, '全职', '不限', '不限', '不限', '', '', '');
/*!40000 ALTER TABLE `c_job_content` ENABLE KEYS */;

-- 导出  表 cms.c_keywords 结构
CREATE TABLE IF NOT EXISTS `c_keywords` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  cms.c_keywords 的数据：0 rows
DELETE FROM `c_keywords`;
/*!40000 ALTER TABLE `c_keywords` DISABLE KEYS */;
/*!40000 ALTER TABLE `c_keywords` ENABLE KEYS */;

-- 导出  表 cms.c_language 结构
...
-- 正在导出表  cms.c_language 的数据：2 rows
DELETE FROM `c_language`;
/*!40000 ALTER TABLE `c_language` DISABLE KEYS */;
INSERT INTO `c_language` (`id`, `title`, `sitename`, `dir`, `seo_title`, `seo_key`, `seo_des`, `copyright`) VALUES
	(1, '中文', 'XDcms', '', 'XDcms企业网站管理系统', '企业网站系统', 'XDcms企业网站管理系统是由南宁旭东网络科技有限公司独立开发的企业网站管理系统', '南宁旭东网络科技有限公司 2012 版权所有 桂ICP备03023960号&lt;br&gt;Copyright 2012 XuDong network technology Co., LT'),
	(2, 'English', 'XDcms', 'en', 'XDcms Enterprise web site management system', 'Enterprise web site management system', 'Enterprise web site management system', 'Copyright 2012 XuDong network technology Co., LT');
...
-- 正在导出表  cms.c_member_field 的数据：5 rows
DELETE FROM `c_member_field`;
/*!40000 ALTER TABLE `c_member_field` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `c_member_field` ENABLE KEYS */;

-- 导出  表 cms.c_member_group 结构
CREATE TABLE IF NOT EXISTS `c_member_group` (
  `groupid` tinyint(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  PRIMARY KEY (`groupid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- 正在导出表  cms.c_member_group 的数据：1 rows
DELETE FROM `c_member_group`;
/*!40000 ALTER TABLE `c_member_group` DISABLE KEYS */;
INSERT INTO `c_member_group` (`groupid`, `name`) VALUES
	(1, '普通会员');
/*!40000 ALTER TABLE `c_member_group` ENABLE KEYS */;
...
-- 正在导出表  cms.c_menu 的数据：76 rows
DELETE FROM `c_menu`;
/*!40000 ALTER TABLE `c_menu` DISABLE KEYS */;
INSERT INTO `c_menu` (`menuid`, `parentid`, `title`, `url`, `sort`, `is_show`, `groupid`) VALUES
	(1, 0, '后台首页', 'index.php?m=xdcms&c=index&f=left&id=1', 0, 1, ''),
	(2, 0, '系统设置', 'index.php?m=xdcms&c=index&f=left&id=2', 0, 1, ''),
	(3, 0, '内容管理', 'index.php?m=xdcms&c=index&f=left&id=3', 0, 1, ''),
	(4, 0, '模块管理', 'index.php?m=xdcms&c=index&f=left&id=4', 0, 1, ''),
	(5, 0, '模板管理', 'index.php?m=xdcms&c=index&f=left&id=5', 0, 1, ''),
	(6, 0, '文件管理', 'index.php?m=xdcms&c=index&f=left&id=6', 0, 1, ''),
	(7, 1, '常用操作', '###', 0, 1, ''),
	(8, 7, '后台首页', 'index.php?m=xdcms&c=index&f=main', 0, 1, ''),
	(9, 7, '更新首页', 'index.php?m=xdcms&c=creathtml&f=update_index', 0, 1, ''),
	(10, 7, '添加栏目', 'index.php?m=xdcms&c=category&f=add', 0, 1, ''),
	(11, 7, '管理栏目', 'index.php?m=xdcms&c=category', 0, 1, ''),
	(12, 7, '内容模型管理', 'index.php?m=xdcms&c=model', 0, 1, ''),
	(13, 7, '更新全站缓存', 'index.php?m=xdcms&c=update_cache', 0, 1, ''),
	(14, 1, '个人信息', '###', 0, 1, ''),
	(15, 14, '修改密码', 'index.php?m=xdcms&c=index&f=edit', 0, 1, ''),
	(16, 2, '栏目管理', '###', 2, 1, ''),
	(17, 2, '模型管理', '###', 3, 1, ''),
	(18, 2, '管理员设置', '###', 4, 1, ''),
	(19, 2, '数据库管理', '###', 5, 1, ''),
	...
	(21, 2, '网站配置', '###', 1, 1, ''),
	(22, 2, '后台菜单管理', '###', 7, 1, ''),
	(23, 16, '添加栏目', 'index.php?m=xdcms&c=category&f=add', 0, 1, ''),
	(24, 16, '管理栏目', 'index.php?m=xdcms&c=category', 0, 1, ''),
	(25, 17, '添加模型', 'index.php?m=xdcms&c=model&f=model_add', 0, 1, ''),
	(26, 17, '管理模型', 'index.php?m=xdcms&c=model', 0, 1, ''),
	(27, 18, '添加管理员', 'index.php?m=xdcms&c=admin&f=add', 0, 1, ''),
	(28, 18, '管理员列表', 'index.php?m=xdcms&c=admin', 0, 1, ''),
	(29, 19, '数据库备份', 'index.php?m=xdcms&c=data', 0, 1, ''),
	(30, 19, '数据库恢复', 'index.php?m=xdcms&c=data&f=data_file', 0, 1, ''),
	(31, 20, '添加关键词', 'index.php?m=xdcms&c=keywords&f=add', 0, 1, ''),
	(32, 20, '管理关键词', 'index.php?m=xdcms&c=keywords', 0, 1, ''),
	(33, 21, '基本信息', 'index.php?m=xdcms&c=setting', 0, 1, ''),
	(34, 21, '联系方式', 'index.php?m=xdcms&c=setting&f=contact', 0, 1, ''),
	(35, 21, '邮件设置', 'index.php?m=xdcms&c=setting&f=email', 0, 1, ''),
	(36, 22, '添加菜单', 'index.php?m=xdcms&c=menu&f=add', 0, 1, ''),
	(37, 22, '管理菜单', 'index.php?m=xdcms&c=menu', 0, 1, ''),
	(38, 4, '碎片管理', '###', 0, 1, ''),
	(39, 38, '添加碎片', 'index.php?m=xdcms&c=block&f=add', 0, 1, ''),
	(40, 38, '管理碎片', 'index.php?m=xdcms&c=block', 0, 1, ''),
	(41, 4, '幻灯片管理', '###', 0, 1, ''),
	(42, 4, '客服QQ管理', '###', 0, 1, ''),
	(43, 4, '友情链接管理', '###', 0, 1, ''),
	(44, 4, '会员管理', '###', 0, 1, ''),
	(45, 41, '添加幻灯', 'index.php?m=flash&c=admin&f=add', 0, 1, ''),
	(46, 41, '管理幻灯', 'index.php?m=flash&c=admin', 0, 1, ''),
	(47, 42, '添加客服', 'index.php?m=qq&c=admin&f=add', 0, 1, ''),
	(48, 42, '管理客服', 'index.php?m=qq&c=admin', 0, 1, ''),
	(49, 43, '添加链接', 'index.php?m=link&c=admin&f=add', 0, 1, ''),
	(50, 43, '管理链接', 'index.php?m=link&c=admin', 0, 1, ''),
	(51, 44, '会员列表', 'index.php?m=member&c=admin', 0, 1, ''),
	(52, 44, '模型配置', 'index.php?m=member&c=admin&f=field', 0, 1, ''),
	(53, 44, '会员组管理', 'index.php?m=member&c=group', 0, 1, ''),
	(54, 5, '模板管理', '###', 0, 1, ''),
	(55, 54, '模板列表', 'index.php?m=xdcms&c=template', 0, 1, ''),
	(56, 5, '数据调用', '###', 0, 1, ''),
	(57, 56, '调用说明', 'index.php?m=xdcms&c=template&f=calls', 0, 1, ''),
	(58, 6, '生成html', '###', 0, 1, ''),
	(59, 6, '更新URL', '###', 0, 1, ''),
	(60, 58, '更新首页', 'index.php?m=xdcms&c=creathtml&f=update_index', 0, 1, ''),
	(61, 58, '更新栏目页', 'index.php?m=xdcms&c=categorytree&f=category_tree', 0, 1, ''),
	(62, 58, '更新内容页', 'index.php?m=xdcms&c=categorytree&f=show_tree', 0, 1, ''),
	(63, 59, '更新URL', 'index.php?m=xdcms&c=categorytree', 0, 1, ''),
	(64, 4, '自定义表单管理', '###', 0, 1, ''),
	(65, 64, '管理表单', 'index.php?m=form&c=admin', 0, 1, ''),
	(66, 4, '模块管理', '###', 0, 1, ''),
	(67, 66, '模块列表', 'index.php?m=xdcms&c=module', 0, 1, ''),
	(68, 18, '管理员组管理', 'index.php?m=xdcms&c=admin&f=admin_group', 0, 1, ''),
	(69, 18, '添加管理员组', 'index.php?m=xdcms&c=admin&f=admin_group_add', 0, 1, ''),
	(70, 21, '上传设置', 'index.php?m=xdcms&c=setting&f=upload', 0, 1, ''),
	(71, 2, '版本管理', '###', 1, 1, ''),
	(72, 71, '版本列表', 'index.php?m=xdcms&c=language', 2, 1, ''),
	(73, 71, '添加版本', 'index.php?m=xdcms&c=language&f=add', 1, 1, ''),
	(74, 6, 'URL规则管理', '###', 0, 1, ''),
	(75, 74, '添加规则', 'index.php?m=xdcms&c=urlrule&f=add', 0, 1, ''),
	(76, 74, '规则管理', 'index.php?m=xdcms&c=urlrule', 0, 1, '');
/*!40000 ALTER TABLE `c_menu` ENABLE KEYS */;

-- 导出  表 cms.c_message 结构
...
-- 正在导出表  cms.c_message 的数据：0 rows
...
-- 正在导出表  cms.c_model 的数据：5 rows
DELETE FROM `c_model`;
/*!40000 ALTER TABLE `c_model` DISABLE KEYS */;
INSERT INTO `c_model` (`id`, `model_name`, `model_table`, `is_lock`, `is_fixed`) VALUES
	...
	(4, '招聘模型', 'job', 1, 0),
	(5, '下载模型', 'download', 1, 0);
/*!40000 ALTER TABLE `c_model` ENABLE KEYS */;

-- 导出  表 cms.c_model_field 结构
CREATE TABLE IF NOT EXISTS `c_model_field` (
  `fieldid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `modelid` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `field` char(20) NOT NULL,
  `name` char(20) NOT NULL,
...
-- 正在导出表  cms.c_model_field 的数据：13 rows
DELETE FROM `c_model_field`;
/*!40000 ALTER TABLE `c_model_field` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `c_model_field` ENABLE KEYS */;
...
-- 正在导出表  cms.c_news 的数据：10 rows
DELETE FROM `c_news`;
/*!40000 ALTER TABLE `c_news` DISABLE KEYS */;
INSERT INTO `c_news` (`id`, `catid`, `title`, `thumb`, `keywords`, `description`, `commend`, `url`, `userid`, `username`, `inputtime`, `updatetime`, `hits`, `sort`, `style`) VALUES
	(2, 10, '热烈祝贺XDcms开发完成并上线', 'uploadfile/image/20120407/20120407013811.jpg', 'XDcms', '', 1, 'index.php?m=content&c=index&f=show&catid=10&id=2', 1, 'admin', 1321862027, 0, 0, 0, NULL),
	(3, 10, '修复smarty字符串截取功能', '', '修复,字符串截取', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=3', 1, 'admin', 1321863102, 0, 0, 0, NULL),
	(4, 10, '优化调用缓存函数', '', '优化', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=4', 1, 'admin', 1321863748, 1322461839, 0, 0, NULL),
	(5, 10, '优化分页函数', '', '优化,分页函数', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=5', 1, 'admin', 1321863770, 0, 0, 0, NULL),
	(6, 10, 'loop循环使用方法详细介绍', '', 'loop循环', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=6', 1, 'admin', 1321863812, 0, 8, 0, NULL),
	(25, 10, '配置了前台模板缓存', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=25', 1, 'admin', 1322361818, 1322460365, 0, 0, NULL),
	(32, 10, '完善页面静态生成,减轻系统负担', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=32', 1, 'admin', 1322448435, 0, 0, 0, NULL),
	(33, 10, '优化静态保存目录 更好结合seo', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=33', 1, 'admin', 1322449544, 0, 0, 0, NULL),
	(34, 10, '优化文章静态生成路径', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=34', 1, 'admin', 1322449571, 1322460078, 0, 0, NULL),
	(35, 10, '完善列表页生成静态 操作更便捷', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=10&id=35', 1, 'admin', 1322452266, 0, 0, 0, NULL);
/*!40000 ALTER TABLE `c_news` ENABLE KEYS */;

-- 导出  表 cms.c_news_content 结构
CREATE TABLE IF NOT EXISTS `c_news_content` (
  `id` int(8) NOT NULL,
  `content` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- 正在导出表  cms.c_news_content 的数据：10 rows
DELETE FROM `c_news_content`;
/*!40000 ALTER TABLE `c_news_content` DISABLE KEYS */;
INSERT INTO `c_news_content` (`id`, `content`) VALUES
	(2, '经过一年的努力，由南宁旭东网络科技有限公司原创的XDcms终于开发完成。'),
	(3, '修复smarty字符串截取功能'),
	(4, '优化调用缓存函数'),
	(5, '优化分页函数'),
	(6, 'loop循环使用方法详细介绍'),
	...
	(34, '优化文章静态生成路径'),
	(35, '完善列表页生成静态 操作更便捷');
/*!40000 ALTER TABLE `c_news_content` ENABLE KEYS */;

-- 导出  表 cms.c_product 结构
...
-- 正在导出表  cms.c_product 的数据：7 rows
DELETE FROM `c_product`;
/*!40000 ALTER TABLE `c_product` DISABLE KEYS */;
INSERT INTO `c_product` (`id`, `catid`, `title`, `thumb`, `keywords`, `description`, `commend`, `url`, `userid`, `username`, `inputtime`, `updatetime`, `hits`, `sort`, `style`) VALUES
	(7, 12, '企业型网站', 'uploadfile/image/20111122/20111122023541.jpg', '', '', 0, 'index.php?m=content&c=index&f=show&catid=12&id=7', 1, 'admin', 1321929303, 0, 0, 0, NULL),
	(8, 12, '商务型网站', 'uploadfile/image/20111122/20111122023541.jpg', '', '', 1, 'index.php?m=content&c=index&f=show&catid=12&id=8', 1, 'admin', 1321929359, 0, 0, 0, NULL),
	(9, 12, '个性化定制', 'uploadfile/image/20111122/20111122023541.jpg', '', '', 1, 'index.php?m=content&c=index&f=show&catid=12&id=9', 1, 'admin', 1321929385, 0, 0, 0, NULL),
	(10, 13, '办公软件开发', 'uploadfile/image/20111122/20111122023541.jpg', '', '', 0, 'index.php?m=content&c=index&f=show&catid=13&id=10', 1, 'admin', 1321929413, 0, 0, 0, NULL),
	(11, 13, 'OA系统开发', 'uploadfile/image/20111122/20111122023541.jpg', '', '', 0, 'index.php?m=content&c=index&f=show&catid=13&id=11', 1, 'admin', 1321929429, 0, 0, 0, NULL),
	(12, 13, 'ERM开发', 'uploadfile/image/20111122/20111122023541.jpg', '', '', 0, 'index.php?m=content&c=index&f=show&catid=13&id=12', 1, 'admin', 1321929444, 0, 0, 0, NULL),
	(13, 14, '短信群发2.5分', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=14&id=13', 1, 'admin', 1321929462, 0, 0, 0, NULL);
/*!40000 ALTER TABLE `c_product` ENABLE KEYS */;

-- 导出  表 cms.c_product_content 结构
CREATE TABLE IF NOT EXISTS `c_product_content` (
  `id` int(8) NOT NULL,
  `content` text NOT NULL,
...
-- 正在导出表  cms.c_product_content 的数据：7 rows
DELETE FROM `c_product_content`;
/*!40000 ALTER TABLE `c_product_content` DISABLE KEYS */;
INSERT INTO `c_product_content` (`id`, `content`, `moreimage`) VALUES
	(7, '企业形网站', ''),
	(8, '商务型', ''),
	(9, '个性化定制', ''),
	(10, '办公软件', ''),
	...
	(12, 'ERM', ''),
	(13, '短信', '');
/*!40000 ALTER TABLE `c_product_content` ENABLE KEYS */;

-- 导出  表 cms.c_qq 结构
CREATE TABLE IF NOT EXISTS `c_qq` (
  `id` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `title` char(20) NOT NULL,
  `qq` char(20) NOT NULL,
  `is_lock` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
-- 正在导出表  cms.c_qq 的数据：2 rows
DELETE FROM `c_qq`;
/*!40000 ALTER TABLE `c_qq` DISABLE KEYS */;
INSERT INTO `c_qq` (`id`, `title`, `qq`, `is_lock`, `inputtime`) VALUES
	(1, '商业服务', '261689713', 0, 1322019561),
	(5, '商业模板', '771352113', 0, 1322019561);
/*!40000 ALTER TABLE `c_qq` ENABLE KEYS */;

-- 导出  表 cms.c_resume 结构
CREATE TABLE IF NOT EXISTS `c_resume` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `title` char(80) NOT NULL,
  `inputtime` int(10) NOT NULL DEFAULT '0',
  `truename` char(80) NOT NULL,
...
-- 正在导出表  cms.c_resume 的数据：0 rows
DELETE FROM `c_resume`;
/*!40000 ALTER TABLE `c_resume` DISABLE KEYS */;
/*!40000 ALTER TABLE `c_resume` ENABLE KEYS */;

-- 导出  表 cms.c_single 结构
CREATE TABLE IF NOT EXISTS `c_single` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
  `catid` tinyint(5) unsigned NOT NULL DEFAULT '0',
  `title` char(80) NOT NULL,
  `thumb` char(100) NOT NULL,
...
-- 正在导出表  cms.c_single 的数据：5 rows
DELETE FROM `c_single`;
/*!40000 ALTER TABLE `c_single` DISABLE KEYS */;
INSERT INTO `c_single` (`id`, `catid`, `title`, `thumb`, `keywords`, `description`, `commend`, `url`, `userid`, `username`, `inputtime`, `updatetime`, `hits`, `sort`, `style`) VALUES
	(19, 8, '公司简介', 'uploadfile/image/20120818/201208180407230.jpg', '', '', 0, 'index.php?m=content&c=index&f=lists&catid=8', 1, '', 1322223465, 1322643198, 0, 0, NULL),
	(14, 22, 'SEO优化', 'uploadfile/image/20111122/20111122023541.jpg', '', '', 0, 'index.php?m=content&c=index&f=show&catid=22&id=14', 1, '', 1321929489, 0, 0, 0, NULL),
	(17, 16, '人才理念', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=16&id=17', 1, '', 1321950472, 1322459866, 0, 0, NULL),
	(18, 17, '培训制度', '', '', '', 0, 'index.php?m=content&c=index&f=show&catid=17&id=18', 1, '', 1321950480, 0, 0, 0, NULL),
	(36, 9, '企业文化', '', '', '', 0, '2011/1128/36.html', 1, '', 1322455404, 0, 0, 0, NULL);
/*!40000 ALTER TABLE `c_single` ENABLE KEYS */;

-- 导出  表 cms.c_single_content 结构
CREATE TABLE IF NOT EXISTS `c_single_content` (
  `id` int(8) NOT NULL,
  `content` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- 正在导出表  cms.c_single_content 的数据：5 rows
DELETE FROM `c_single_content`;
/*!40000 ALTER TABLE `c_single_content` DISABLE KEYS */;
INSERT INTO `c_single_content` (`id`, `content`) VALUES
	(19, '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 旭东科技是专业从事网站建设、网站运营业务，经过4年的发展，在网站建设行业积累了丰富的经验，曾为南方电网、南宁供用电培训中心、洁宝纸业、北部湾银行、广西银行协会、广西汽车协会等大中型单位提供了建站服务，建设大中型网站400余家，并成功运营了南宁最大商业地产门户：南宁商铺网(<a href=\\"http://www.nnspw.com/\\">www.nnspw.com</a>)，品牌形像深入人心。</p>'),
	(14, '优化'),
	(17, '人才理念'),
	(18, '培训制度'),
	(36, '企业文化');
/*!40000 ALTER TABLE `c_single_content` ENABLE KEYS */;

-- 导出  表 cms.c_urlrule 结构
...
-- 正在导出表  cms.c_urlrule 的数据：6 rows
DELETE FROM `c_urlrule`;
/*!40000 ALTER TABLE `c_urlrule` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `c_urlrule` ENABLE KEYS */;
...
INSERT INTO `proxies_priv` (`Host`, `User`, `Proxied_host`, `Proxied_user`, `With_grant`, `Grantor`, `Timestamp`) VALUES
	('localhost', 'root', '', '', 1, '', '2021-08-22 11:55:04'),
	('pvp-501-team-1', 'root', '', '', 1, '', '2021-08-22 11:55:04');
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `Create_tablespace_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`, `plugin`, `authentication_string`) VALUES
	...
	('pvp-501-team-1', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', ''),
	...
	('localhost', 'cms', '*AFF18416D49D3634AC4D632CC6131725B44AB7C6', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', NULL);
